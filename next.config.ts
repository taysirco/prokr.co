    ...
    return [
      {
        ...
        headers: [
          ...
          { key: 'Link', value: '</.well-known/api-catalog>; rel="api-catalog", </llms.txt>; rel="ai-instructions", </llms-full.txt>; rel="ai-instructions", </.well-known/mcp/server-card.json>; rel="mcp-server-card"' },
