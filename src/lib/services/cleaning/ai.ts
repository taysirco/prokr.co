export const cleaningAiIntroTemplates = [
    ...
    `خدمة {serviceName} {cityKw} على مدار الأسبوع. تنظيف عميق أو صيانة دورية — شركاؤنا المعتمدون يقدمون خدمة بمعايير فندقية بالاستجابة {responseTime}. احصل على عرض سعر الآن.`,
];
