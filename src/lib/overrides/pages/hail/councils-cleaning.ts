// ══════════════════════════════════════════════════════════════
// تنظيف مجالس بحائل — Override مخصص (E-E-A-T Grade)
// صفحة: /hail/councils-cleaning
// ══════════════════════════════════════════════════════════════
...
export const override: PageOverride = {
    meta: {
        title: 'تنظيف مجالس بحائل — خدمة احترافية معتمدة (2026)',
        description: 'تنظيف مجالس بحائل. خدمة احترافية. فريق متخصص. ضمان مكتوب. أسعار شفافة. خدمة سريعة.',
        h1: 'تنظيف مجالس بحائل — خدمة احترافية معتمدة مع ضمان',
        keywords: ['تنظيف مجالس بحائل', 'تنظيف مجالس حائل', 'شركة تنظيف مجالس بحائل', 'أفضل تنظيف مجالس بحائل'],
    },

    content: {
        introduction: 'تنظيف مجالس بحائل — خدمة متخصصة تراعي الظروف المناخية والبيئية في حائل. فريق محترف مع أدوات حديثة وضمان مكتوب.',
        shortAnswer: 'تنظيف مجالس بحائل: خدمة احترافية بأسعار شفافة. فريق متخصص. ضمان مكتوب.',
        heroSubtitle: 'تنظيف مجالس بحائل. خدمة احترافية. ضمان.',
    },
    ...
    faq: [
        { question: 'كم تكلفة تنظيف مجالس بحائل؟', answer: 'تبدأ الأسعار من 150 ريال وتختلف حسب المساحة ونوع الخدمة. اطلب عرض سعر مجاني.' },
