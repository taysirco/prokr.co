// ══════════════════════════════════════════════════════════════
// كشف تسربات المياه بحائل — Override مخصص (E-E-A-T Grade)
// صفحة: /hail/water-leak-detection
// ══════════════════════════════════════════════════════════════
...
export const override: PageOverride = {
    meta: {
        title: 'كشف تسربات المياه بحائل — خدمة احترافية معتمدة (2026)',
        description: 'كشف تسربات المياه بحائل. خدمة احترافية. فريق متخصص. ضمان مكتوب. أسعار شفافة. خدمة سريعة.',
        h1: 'كشف تسربات المياه بحائل — خدمة احترافية معتمدة مع ضمان',
        keywords: ['كشف تسربات المياه بحائل', 'كشف تسربات المياه حائل', 'شركة كشف تسربات المياه بحائل', 'أفضل كشف تسربات المياه بحائل'],
    },

    content: {
        introduction: 'كشف تسربات المياه بحائل — خدمة متخصصة تراعي الظروف المناخية والبيئية في حائل. فريق محترف مع أدوات حديثة وضمان مكتوب.',
        shortAnswer: 'كشف تسربات المياه بحائل: خدمة احترافية بأسعار شفافة. فريق متخصص. ضمان مكتوب.',
        heroSubtitle: 'كشف تسربات المياه بحائل. خدمة احترافية. ضمان.',
    },
    ...
    faq: [
        { question: 'كم تكلفة كشف تسربات المياه بحائل؟', answer: 'تبدأ الأسعار من 150 ريال وتختلف حسب المساحة ونوع الخدمة. اطلب عرض سعر مجاني.' },
