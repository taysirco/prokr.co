// ══════════════════════════════════════════════════════════════
// دباب نقل بحائل — Override مخصص (E-E-A-T Grade)
// صفحة: /hail/dabab
// ══════════════════════════════════════════════════════════════
...
export const override: PageOverride = {
    meta: {
        title: 'دباب نقل بحائل — خدمة احترافية معتمدة (2026)',
        description: 'دباب نقل بحائل. خدمة احترافية. فريق متخصص. ضمان مكتوب. أسعار شفافة. خدمة سريعة.',
        h1: 'دباب نقل بحائل — خدمة احترافية معتمدة مع ضمان',
        keywords: ['دباب نقل بحائل', 'دباب نقل حائل', 'شركة دباب نقل بحائل', 'أفضل دباب نقل بحائل'],
    },

    content: {
        introduction: 'دباب نقل بحائل — خدمة متخصصة تراعي الظروف المناخية والبيئية في حائل. فريق محترف مع أدوات حديثة وضمان مكتوب.',
        shortAnswer: 'دباب نقل بحائل: خدمة احترافية بأسعار شفافة. فريق متخصص. ضمان مكتوب.',
        heroSubtitle: 'دباب نقل بحائل. خدمة احترافية. ضمان.',
    },
    ...
    faq: [
        { question: 'كم تكلفة دباب نقل بحائل؟', answer: 'تبدأ الأسعار من 150 ريال وتختلف حسب المساحة ونوع الخدمة. اطلب عرض سعر مجاني.' },
