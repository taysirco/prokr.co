// ══════════════════════════════════════════════════════════════
// نقل عفش بحائل — Override مخصص (E-E-A-T Grade)
// صفحة: /hail/furniture-moving
// ══════════════════════════════════════════════════════════════
...
export const override: PageOverride = {
    meta: {
        title: 'نقل عفش بحائل — خدمة احترافية معتمدة (2026)',
        description: 'نقل عفش بحائل. خدمة احترافية. فريق متخصص. ضمان مكتوب. أسعار شفافة. خدمة سريعة.',
        h1: 'نقل عفش بحائل — خدمة احترافية معتمدة مع ضمان',
        keywords: ['نقل عفش بحائل', 'نقل عفش حائل', 'شركة نقل عفش بحائل', 'أفضل نقل عفش بحائل'],
    },

    content: {
        introduction: 'نقل عفش بحائل — خدمة متخصصة تراعي الظروف المناخية والبيئية في حائل. فريق محترف مع أدوات حديثة وضمان مكتوب.',
        shortAnswer: 'نقل عفش بحائل: خدمة احترافية بأسعار شفافة. فريق متخصص. ضمان مكتوب.',
        heroSubtitle: 'نقل عفش بحائل. خدمة احترافية. ضمان.',
    },
    ...
    faq: [
        { question: 'كم تكلفة نقل عفش بحائل؟', answer: 'تبدأ الأسعار من 150 ريال وتختلف حسب المساحة ونوع الخدمة. اطلب عرض سعر مجاني.' },
    ...
    relatedServices: [
        { slug: 'hail-furniture-storage', context: 'تخزين عفش بحائل', priority: 1 },
