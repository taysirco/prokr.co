// ══════════════════════════════════════════════════════════════
// مكافحة صراصير بحائل — Override مخصص (E-E-A-T Grade)
// صفحة: /hail/cockroach-control
// ══════════════════════════════════════════════════════════════
...
export const override: PageOverride = {
    meta: {
        title: 'مكافحة صراصير بحائل — خدمة احترافية معتمدة (2026)',
        description: 'مكافحة صراصير بحائل. خدمة احترافية. فريق متخصص. ضمان مكتوب. أسعار شفافة. خدمة سريعة.',
        h1: 'مكافحة صراصير بحائل — خدمة احترافية معتمدة مع ضمان',
        keywords: ['مكافحة صراصير بحائل', 'مكافحة صراصير حائل', 'شركة مكافحة صراصير بحائل', 'أفضل مكافحة صراصير بحائل'],
    },

    content: {
        introduction: 'مكافحة صراصير بحائل — خدمة متخصصة تراعي الظروف المناخية والبيئية في حائل. فريق محترف مع أدوات حديثة وضمان مكتوب.',
        shortAnswer: 'مكافحة صراصير بحائل: خدمة احترافية بأسعار شفافة. فريق متخصص. ضمان مكتوب.',
        heroSubtitle: 'مكافحة صراصير بحائل. خدمة احترافية. ضمان.',
    },
    ...
    faq: [
        { question: 'كم تكلفة مكافحة صراصير بحائل؟', answer: 'تبدأ الأسعار من 150 ريال وتختلف حسب المساحة ونوع الخدمة. اطلب عرض سعر مجاني.' },
