// ══════════════════════════════════════════════════════════════
// تعقيم بحائل — Override مخصص (E-E-A-T Grade)
// صفحة: /hail/sanitization
// ══════════════════════════════════════════════════════════════
...
export const override: PageOverride = {
    meta: {
        title: 'تعقيم بحائل — خدمة احترافية معتمدة (2026)',
        description: 'تعقيم بحائل. خدمة احترافية. فريق متخصص. ضمان مكتوب. أسعار شفافة. خدمة سريعة.',
        h1: 'تعقيم بحائل — خدمة احترافية معتمدة مع ضمان',
        keywords: ['تعقيم بحائل', 'تعقيم حائل', 'شركة تعقيم بحائل', 'أفضل تعقيم بحائل'],
    },

    content: {
        introduction: 'تعقيم بحائل — خدمة متخصصة تراعي الظروف المناخية والبيئية في حائل. فريق محترف مع أدوات حديثة وضمان مكتوب.',
        shortAnswer: 'تعقيم بحائل: خدمة احترافية بأسعار شفافة. فريق متخصص. ضمان مكتوب.',
        heroSubtitle: 'تعقيم بحائل. خدمة احترافية. ضمان.',
    },
    ...
    faq: [
        { question: 'كم تكلفة تعقيم بحائل؟', answer: 'تبدأ الأسعار من 150 ريال وتختلف حسب المساحة ونوع الخدمة. اطلب عرض سعر مجاني.' },
