// ══════════════════════════════════════════════════════════════
// تنظيف سجاد بحائل — Override مخصص (E-E-A-T Grade)
// صفحة: /hail/carpet-cleaning
// ══════════════════════════════════════════════════════════════
...
export const override: PageOverride = {
    meta: {
        title: 'تنظيف سجاد بحائل — خدمة احترافية معتمدة (2026)',
        description: 'تنظيف سجاد بحائل. خدمة احترافية. فريق متخصص. ضمان مكتوب. أسعار شفافة. خدمة سريعة.',
        h1: 'تنظيف سجاد بحائل — خدمة احترافية معتمدة مع ضمان',
        keywords: ['تنظيف سجاد بحائل', 'تنظيف سجاد حائل', 'شركة تنظيف سجاد بحائل', 'أفضل تنظيف سجاد بحائل'],
    },

    content: {
        introduction: 'تنظيف سجاد بحائل — خدمة متخصصة تراعي الظروف المناخية والبيئية في حائل. فريق محترف مع أدوات حديثة وضمان مكتوب.',
        shortAnswer: 'تنظيف سجاد بحائل: خدمة احترافية بأسعار شفافة. فريق متخصص. ضمان مكتوب.',
        heroSubtitle: 'تنظيف سجاد بحائل. خدمة احترافية. ضمان.',
    },
    ...
    faq: [
        { question: 'كم تكلفة تنظيف سجاد بحائل؟', answer: 'تبدأ الأسعار من 150 ريال وتختلف حسب المساحة ونوع الخدمة. اطلب عرض سعر مجاني.' },
