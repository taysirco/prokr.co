...
export const override: PageOverride = {
    ...
    commonConcerns: [
        { concern: 'مغسلة بـ 15 ريال أرخص.', solution: '15 ريال × 100+ خدش/غسلة × 100 غسلة = 10,000 خدش/سنة. بعد سنتين: Paint Correction 300-800 ريال أو إعادة طلاء 5,000-15,000 ريال. الأرخص = الأغلى.' },
        { concern: 'شمع بـ 100 ريال بدلاً من Ceramic بـ 1,500.', solution: 'شمع: يتشقق أول شتاء (0°م) = 3-4 مرات/سنة × 100 = 400 ريال/سنة + يتشقق دائماً. Ceramic: 1,500 × 3 سنوات = 500 ريال/سنة + لا يتشقق. Ceramic أرخص بالسنة.' },
    ],
    consumerEducation: [
