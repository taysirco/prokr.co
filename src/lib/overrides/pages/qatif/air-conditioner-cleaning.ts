// ══════════════════════════════════════════════════════════════
// تنظيف مكيفات بالقطيف — Override مخصص (E-E-A-T Grade)
// صفحة: /qatif/air-conditioner-cleaning
// ══════════════════════════════════════════════════════════════
...
export const override: PageOverride = {
    meta: {
        title: 'تنظيف مكيفات بالقطيف — خدمة احترافية معتمدة (2026)',
        description: 'تنظيف مكيفات بالقطيف. خدمة احترافية. فريق متخصص. ضمان مكتوب. أسعار شفافة. خدمة سريعة.',
        h1: 'تنظيف مكيفات بالقطيف — خدمة احترافية معتمدة مع ضمان',
        keywords: ['تنظيف مكيفات بالقطيف', 'تنظيف مكيفات القطيف', 'شركة تنظيف مكيفات بالقطيف', 'أفضل تنظيف مكيفات بالقطيف'],
    },

    content: {
        introduction: 'تنظيف مكيفات بالقطيف — خدمة متخصصة تراعي الظروف المناخية والبيئية في القطيف. فريق محترف مع أدوات حديثة وضمان مكتوب.',
        shortAnswer: 'تنظيف مكيفات بالقطيف: خدمة احترافية بأسعار شفافة. فريق متخصص. ضمان مكتوب.',
        heroSubtitle: 'تنظيف مكيفات بالقطيف. خدمة احترافية. ضمان.',
    },
    ...
    faq: [
        { question: 'كم تكلفة تنظيف مكيفات بالقطيف؟', answer: 'تبدأ الأسعار من 150 ريال وتختلف حسب المساحة ونوع الخدمة. اطلب عرض سعر مجاني.' },
