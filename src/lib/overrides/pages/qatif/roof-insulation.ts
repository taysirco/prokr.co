// ══════════════════════════════════════════════════════════════
// عزل أسطح بالقطيف — Override مخصص (E-E-A-T Grade)
// صفحة: /qatif/roof-insulation
// ══════════════════════════════════════════════════════════════
...
export const override: PageOverride = {
    meta: {
        title: 'عزل أسطح بالقطيف — خدمة احترافية معتمدة (2026)',
        description: 'عزل أسطح بالقطيف. خدمة احترافية. فريق متخصص. ضمان مكتوب. أسعار شفافة. خدمة سريعة.',
        h1: 'عزل أسطح بالقطيف — خدمة احترافية معتمدة مع ضمان',
        keywords: ['عزل أسطح بالقطيف', 'عزل أسطح القطيف', 'شركة عزل أسطح بالقطيف', 'أفضل عزل أسطح بالقطيف'],
    },

    content: {
        introduction: 'عزل أسطح بالقطيف — خدمة متخصصة تراعي الظروف المناخية والبيئية في القطيف. فريق محترف مع أدوات حديثة وضمان مكتوب.',
        shortAnswer: 'عزل أسطح بالقطيف: خدمة احترافية بأسعار شفافة. فريق متخصص. ضمان مكتوب.',
        heroSubtitle: 'عزل أسطح بالقطيف. خدمة احترافية. ضمان.',
    },
    ...
    faq: [
        { question: 'كم تكلفة عزل أسطح بالقطيف؟', answer: 'تبدأ الأسعار من 150 ريال وتختلف حسب المساحة ونوع الخدمة. اطلب عرض سعر مجاني.' },
