...
export const override: PageOverride = {
    ...
    hiddenObjections: [
        { fear: 'كل هذا غالي.', solution: 'خزان عادي يُستبدل كل 5 سنوات = 3-4 مرات في 20 سنة = أغلى إجمالياً. بحري مرة واحدة = أرخص.' },
        { fear: 'مظلة SS316 مكلفة.', solution: 'FRP (فايبرقلاس) بديل أرخص ولا يصدأ. المهم: لا ألمنيوم ولا حديد.' },
    ],
    counterNarratives: [
