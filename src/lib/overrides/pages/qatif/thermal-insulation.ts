...
export const override: PageOverride = {
    ...
    hiddenObjections: [
        { fear: 'ETICS بحري أغلى 30-40% من عادي.', solution: 'العادي ينفصل خلال 2-3 سنوات = إعادة كل مرة. البحري 10-15 سنة. أرخص 3-5× إجمالياً.' },
        { fear: 'PVC نوافذ أغلى.', solution: 'ألمنيوم يُستبدل كل 5-8 سنوات = أغلى على المدى الطويل. PVC مرة واحدة.' },
    ],
    counterNarratives: [
