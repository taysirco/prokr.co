...
export const override: PageOverride = {
    ...
    content: {
        introduction: 'واجهات القطيف تواجه تحديات ساحلية-واحية. الأول — NaCl إبهات: رذاذ ملحي يُبهت الزجاج. Squeegee + RO. الثاني — طين لزج: PM10 طيني يلتصق (لا ينتشر كـ SiO₂). فرك + RO. الثالث — Biofilm واحي: 80-95% + عيون = Biofilm + طحالب على الواجهات. Anti-Biofilm. الرابع — Sealant: NaCl يُسرّع تآكل. Marine Sealant.',
