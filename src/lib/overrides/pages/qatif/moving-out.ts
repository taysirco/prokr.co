// ══════════════════════════════════════════════════════════════
// نقل عفش خروج بالقطيف — Override مخصص (E-E-A-T Grade)
// صفحة: /qatif/moving-out
// ══════════════════════════════════════════════════════════════
...
export const override: PageOverride = {
    meta: {
        title: 'نقل عفش خروج بالقطيف — خدمة احترافية معتمدة (2026)',
        description: 'نقل عفش خروج بالقطيف. خدمة احترافية. فريق متخصص. ضمان مكتوب. أسعار شفافة. خدمة سريعة.',
        h1: 'نقل عفش خروج بالقطيف — خدمة احترافية معتمدة مع ضمان',
        keywords: ['نقل عفش خروج بالقطيف', 'نقل عفش خروج القطيف', 'شركة نقل عفش خروج بالقطيف', 'أفضل نقل عفش خروج بالقطيف'],
    },

    content: {
        introduction: 'نقل عفش خروج بالقطيف — خدمة متخصصة تراعي الظروف المناخية والبيئية في القطيف. فريق محترف مع أدوات حديثة وضمان مكتوب.',
        shortAnswer: 'نقل عفش خروج بالقطيف: خدمة احترافية بأسعار شفافة. فريق متخصص. ضمان مكتوب.',
        heroSubtitle: 'نقل عفش خروج بالقطيف. خدمة احترافية. ضمان.',
    },
    ...
    faq: [
        { question: 'كم تكلفة نقل عفش خروج بالقطيف؟', answer: 'تبدأ الأسعار من 150 ريال وتختلف حسب المساحة ونوع الخدمة. اطلب عرض سعر مجاني.' },
