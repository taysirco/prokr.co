// ══════════════════════════════════════════════════════════════
// جلي رخام بالقطيف — Override مخصص (E-E-A-T Grade)
// صفحة: /qatif/marble-polishing
// ══════════════════════════════════════════════════════════════
...
export const override: PageOverride = {
    meta: {
        title: 'جلي رخام بالقطيف — خدمة احترافية معتمدة (2026)',
        description: 'جلي رخام بالقطيف. خدمة احترافية. فريق متخصص. ضمان مكتوب. أسعار شفافة. خدمة سريعة.',
        h1: 'جلي رخام بالقطيف — خدمة احترافية معتمدة مع ضمان',
        keywords: ['جلي رخام بالقطيف', 'جلي رخام القطيف', 'شركة جلي رخام بالقطيف', 'أفضل جلي رخام بالقطيف'],
    },

    content: {
        introduction: 'جلي رخام بالقطيف — خدمة متخصصة تراعي الظروف المناخية والبيئية في القطيف. فريق محترف مع أدوات حديثة وضمان مكتوب.',
        shortAnswer: 'جلي رخام بالقطيف: خدمة احترافية بأسعار شفافة. فريق متخصص. ضمان مكتوب.',
        heroSubtitle: 'جلي رخام بالقطيف. خدمة احترافية. ضمان.',
    },
    ...
    faq: [
        { question: 'كم تكلفة جلي رخام بالقطيف؟', answer: 'تبدأ الأسعار من 150 ريال وتختلف حسب المساحة ونوع الخدمة. اطلب عرض سعر مجاني.' },
