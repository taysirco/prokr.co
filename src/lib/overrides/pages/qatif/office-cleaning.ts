// ══════════════════════════════════════════════════════════════
// تنظيف مكاتب بالقطيف — Override مخصص (E-E-A-T Grade)
// صفحة: /qatif/office-cleaning
// ══════════════════════════════════════════════════════════════
...
export const override: PageOverride = {
    meta: {
        title: 'تنظيف مكاتب بالقطيف — خدمة احترافية معتمدة (2026)',
        description: 'تنظيف مكاتب بالقطيف. خدمة احترافية. فريق متخصص. ضمان مكتوب. أسعار شفافة. خدمة سريعة.',
        h1: 'تنظيف مكاتب بالقطيف — خدمة احترافية معتمدة مع ضمان',
        keywords: ['تنظيف مكاتب بالقطيف', 'تنظيف مكاتب القطيف', 'شركة تنظيف مكاتب بالقطيف', 'أفضل تنظيف مكاتب بالقطيف'],
    },

    content: {
        introduction: 'تنظيف مكاتب بالقطيف — خدمة متخصصة تراعي الظروف المناخية والبيئية في القطيف. فريق محترف مع أدوات حديثة وضمان مكتوب.',
        shortAnswer: 'تنظيف مكاتب بالقطيف: خدمة احترافية بأسعار شفافة. فريق متخصص. ضمان مكتوب.',
        heroSubtitle: 'تنظيف مكاتب بالقطيف. خدمة احترافية. ضمان.',
    },
    ...
    faq: [
        { question: 'كم تكلفة تنظيف مكاتب بالقطيف؟', answer: 'تبدأ الأسعار من 150 ريال وتختلف حسب المساحة ونوع الخدمة. اطلب عرض سعر مجاني.' },
