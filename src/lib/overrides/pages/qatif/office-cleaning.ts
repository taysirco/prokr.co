...
export const override: PageOverride = {
    ...
    content: {
        introduction: 'المكتب في القطيف = ساحلي-واحي. الأول — NaCl أجهزة: NaCl يترسب على إلكترونيات = Galvanic. RO + Anti-Static. الثاني — 80-95% عفن واحي مكتبي: عفن مكيف + خلف أثاث مكتب = Sick Building. Anti-Fungal. الثالث — طلع نخيل: غبار طلع يدخل المكاتب = حساسية مهنية. HEPA. الرابع — طين: PM10 طيني على الأسطح.',
