// ══════════════════════════════════════════════════════════════
// تعقيم بالقطيف — Override مخصص (E-E-A-T Grade)
// صفحة: /qatif/sanitization
// ══════════════════════════════════════════════════════════════
...
export const override: PageOverride = {
    meta: {
        title: 'تعقيم بالقطيف — خدمة احترافية معتمدة (2026)',
        description: 'تعقيم بالقطيف. خدمة احترافية. فريق متخصص. ضمان مكتوب. أسعار شفافة. خدمة سريعة.',
        h1: 'تعقيم بالقطيف — خدمة احترافية معتمدة مع ضمان',
        keywords: ['تعقيم بالقطيف', 'تعقيم القطيف', 'شركة تعقيم بالقطيف', 'أفضل تعقيم بالقطيف'],
    },

    content: {
        introduction: 'تعقيم بالقطيف — خدمة متخصصة تراعي الظروف المناخية والبيئية في القطيف. فريق محترف مع أدوات حديثة وضمان مكتوب.',
        shortAnswer: 'تعقيم بالقطيف: خدمة احترافية بأسعار شفافة. فريق متخصص. ضمان مكتوب.',
        heroSubtitle: 'تعقيم بالقطيف. خدمة احترافية. ضمان.',
    },
    ...
    faq: [
        { question: 'كم تكلفة تعقيم بالقطيف؟', answer: 'تبدأ الأسعار من 150 ريال وتختلف حسب المساحة ونوع الخدمة. اطلب عرض سعر مجاني.' },
