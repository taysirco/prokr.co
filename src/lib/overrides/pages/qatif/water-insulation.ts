// ══════════════════════════════════════════════════════════════
// عزل مائي بالقطيف — Override مخصص (E-E-A-T Grade)
// صفحة: /qatif/water-insulation
// ══════════════════════════════════════════════════════════════
...
export const override: PageOverride = {
    meta: {
        title: 'عزل مائي بالقطيف — خدمة احترافية معتمدة (2026)',
        description: 'عزل مائي بالقطيف. خدمة احترافية. فريق متخصص. ضمان مكتوب. أسعار شفافة. خدمة سريعة.',
        h1: 'عزل مائي بالقطيف — خدمة احترافية معتمدة مع ضمان',
        keywords: ['عزل مائي بالقطيف', 'عزل مائي القطيف', 'شركة عزل مائي بالقطيف', 'أفضل عزل مائي بالقطيف'],
    },

    content: {
        introduction: 'عزل مائي بالقطيف — خدمة متخصصة تراعي الظروف المناخية والبيئية في القطيف. فريق محترف مع أدوات حديثة وضمان مكتوب.',
        shortAnswer: 'عزل مائي بالقطيف: خدمة احترافية بأسعار شفافة. فريق متخصص. ضمان مكتوب.',
        heroSubtitle: 'عزل مائي بالقطيف. خدمة احترافية. ضمان.',
    },
    ...
    faq: [
        { question: 'كم تكلفة عزل مائي بالقطيف؟', answer: 'تبدأ الأسعار من 150 ريال وتختلف حسب المساحة ونوع الخدمة. اطلب عرض سعر مجاني.' },
