// ══════════════════════════════════════════════════════════════
// عزل فوم بالظهران — Override مخصص (E-E-A-T Grade)
// صفحة: /dhahran/foam-insulation
// ══════════════════════════════════════════════════════════════
...
export const override: PageOverride = {
    meta: {
        title: 'عزل فوم بالظهران — خدمة احترافية معتمدة (2026)',
        description: 'عزل فوم بالظهران. خدمة احترافية. فريق متخصص. ضمان مكتوب. أسعار شفافة. خدمة سريعة.',
        h1: 'عزل فوم بالظهران — خدمة احترافية معتمدة مع ضمان',
        keywords: ['عزل فوم بالظهران', 'عزل فوم الظهران', 'شركة عزل فوم بالظهران', 'أفضل عزل فوم بالظهران'],
    },

    content: {
        introduction: 'عزل فوم بالظهران — خدمة متخصصة تراعي الظروف المناخية والبيئية في الظهران. فريق محترف مع أدوات حديثة وضمان مكتوب.',
        shortAnswer: 'عزل فوم بالظهران: خدمة احترافية بأسعار شفافة. فريق متخصص. ضمان مكتوب.',
        heroSubtitle: 'عزل فوم بالظهران. خدمة احترافية. ضمان.',
    },
    ...
    faq: [
        { question: 'كم تكلفة عزل فوم بالظهران؟', answer: 'تبدأ الأسعار من 150 ريال وتختلف حسب المساحة ونوع الخدمة. اطلب عرض سعر مجاني.' },
