...
export const override: PageOverride = {
    ...
    commonConcerns: [
        { concern: '35 كجم أقل من الخبر — هل يكفي؟', solution: '35 مُصمم لـ 80%. زيادة الكثافة بدون حاجة = تكلفة بدون فائدة.' },
        { concern: 'النظام أرخص = أقل جودة؟', solution: 'أقل تكلفة لأن الظروف أقل قسوة. نفس الجودة الهندسية.' },
    ],
    consumerEducation: [
