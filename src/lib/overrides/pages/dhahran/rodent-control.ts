// ══════════════════════════════════════════════════════════════
// مكافحة فئران بالظهران — Override مخصص (E-E-A-T Grade)
// صفحة: /dhahran/rodent-control
// ══════════════════════════════════════════════════════════════
...
export const override: PageOverride = {
    meta: {
        title: 'مكافحة فئران بالظهران — خدمة احترافية معتمدة (2026)',
        description: 'مكافحة فئران بالظهران. خدمة احترافية. فريق متخصص. ضمان مكتوب. أسعار شفافة. خدمة سريعة.',
        h1: 'مكافحة فئران بالظهران — خدمة احترافية معتمدة مع ضمان',
        keywords: ['مكافحة فئران بالظهران', 'مكافحة فئران الظهران', 'شركة مكافحة فئران بالظهران', 'أفضل مكافحة فئران بالظهران'],
    },

    content: {
        introduction: 'مكافحة فئران بالظهران — خدمة متخصصة تراعي الظروف المناخية والبيئية في الظهران. فريق محترف مع أدوات حديثة وضمان مكتوب.',
        shortAnswer: 'مكافحة فئران بالظهران: خدمة احترافية بأسعار شفافة. فريق متخصص. ضمان مكتوب.',
        heroSubtitle: 'مكافحة فئران بالظهران. خدمة احترافية. ضمان.',
    },
    ...
    faq: [
        { question: 'كم تكلفة مكافحة فئران بالظهران؟', answer: 'تبدأ الأسعار من 150 ريال وتختلف حسب المساحة ونوع الخدمة. اطلب عرض سعر مجاني.' },
