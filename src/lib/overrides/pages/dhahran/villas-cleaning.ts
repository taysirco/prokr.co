// ══════════════════════════════════════════════════════════════
// تنظيف فلل بالظهران — Override مخصص (E-E-A-T Grade)
// صفحة: /dhahran/villas-cleaning
// ══════════════════════════════════════════════════════════════
...
export const override: PageOverride = {
    meta: {
        title: 'تنظيف فلل بالظهران — خدمة احترافية معتمدة (2026)',
        description: 'تنظيف فلل بالظهران. خدمة احترافية. فريق متخصص. ضمان مكتوب. أسعار شفافة. خدمة سريعة.',
        h1: 'تنظيف فلل بالظهران — خدمة احترافية معتمدة مع ضمان',
        keywords: ['تنظيف فلل بالظهران', 'تنظيف فلل الظهران', 'شركة تنظيف فلل بالظهران', 'أفضل تنظيف فلل بالظهران'],
    },

    content: {
        introduction: 'تنظيف فلل بالظهران — خدمة متخصصة تراعي الظروف المناخية والبيئية في الظهران. فريق محترف مع أدوات حديثة وضمان مكتوب.',
        shortAnswer: 'تنظيف فلل بالظهران: خدمة احترافية بأسعار شفافة. فريق متخصص. ضمان مكتوب.',
        heroSubtitle: 'تنظيف فلل بالظهران. خدمة احترافية. ضمان.',
    },
    ...
    faq: [
        { question: 'كم تكلفة تنظيف فلل بالظهران؟', answer: 'تبدأ الأسعار من 150 ريال وتختلف حسب المساحة ونوع الخدمة. اطلب عرض سعر مجاني.' },
