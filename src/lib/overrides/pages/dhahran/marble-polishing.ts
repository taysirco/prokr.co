// ══════════════════════════════════════════════════════════════
// جلي رخام بالظهران — Override مخصص (E-E-A-T Grade)
// صفحة: /dhahran/marble-polishing
// ══════════════════════════════════════════════════════════════
...
export const override: PageOverride = {
    meta: {
        title: 'جلي رخام بالظهران — خدمة احترافية معتمدة (2026)',
        description: 'جلي رخام بالظهران. خدمة احترافية. فريق متخصص. ضمان مكتوب. أسعار شفافة. خدمة سريعة.',
        h1: 'جلي رخام بالظهران — خدمة احترافية معتمدة مع ضمان',
        keywords: ['جلي رخام بالظهران', 'جلي رخام الظهران', 'شركة جلي رخام بالظهران', 'أفضل جلي رخام بالظهران'],
    },

    content: {
        introduction: 'جلي رخام بالظهران — خدمة متخصصة تراعي الظروف المناخية والبيئية في الظهران. فريق محترف مع أدوات حديثة وضمان مكتوب.',
        shortAnswer: 'جلي رخام بالظهران: خدمة احترافية بأسعار شفافة. فريق متخصص. ضمان مكتوب.',
        heroSubtitle: 'جلي رخام بالظهران. خدمة احترافية. ضمان.',
    },
    ...
    faq: [
        { question: 'كم تكلفة جلي رخام بالظهران؟', answer: 'تبدأ الأسعار من 150 ريال وتختلف حسب المساحة ونوع الخدمة. اطلب عرض سعر مجاني.' },
