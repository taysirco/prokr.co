// ══════════════════════════════════════════════════════════════
// تنظيف مسابح بالظهران — Override مخصص (E-E-A-T Grade)
// صفحة: /dhahran/swimming-pool-cleaning
// ══════════════════════════════════════════════════════════════
...
export const override: PageOverride = {
    meta: {
        title: 'تنظيف مسابح بالظهران — خدمة احترافية معتمدة (2026)',
        description: 'تنظيف مسابح بالظهران. خدمة احترافية. فريق متخصص. ضمان مكتوب. أسعار شفافة. خدمة سريعة.',
        h1: 'تنظيف مسابح بالظهران — خدمة احترافية معتمدة مع ضمان',
        keywords: ['تنظيف مسابح بالظهران', 'تنظيف مسابح الظهران', 'شركة تنظيف مسابح بالظهران', 'أفضل تنظيف مسابح بالظهران'],
    },

    content: {
        introduction: 'تنظيف مسابح بالظهران — خدمة متخصصة تراعي الظروف المناخية والبيئية في الظهران. فريق محترف مع أدوات حديثة وضمان مكتوب.',
        shortAnswer: 'تنظيف مسابح بالظهران: خدمة احترافية بأسعار شفافة. فريق متخصص. ضمان مكتوب.',
        heroSubtitle: 'تنظيف مسابح بالظهران. خدمة احترافية. ضمان.',
    },
    ...
    faq: [
        { question: 'كم تكلفة تنظيف مسابح بالظهران؟', answer: 'تبدأ الأسعار من 150 ريال وتختلف حسب المساحة ونوع الخدمة. اطلب عرض سعر مجاني.' },
