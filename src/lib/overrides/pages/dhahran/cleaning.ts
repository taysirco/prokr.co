...
export const override: PageOverride = {
    ...
    commonConcerns: [
        { concern: 'منظف عادي.', solution: 'يُنظف — لا يحمي من مزدوج. NaCl يعود + SiO₂ يتراكم + عفن ينمو.' },
        { concern: 'مثل الخبر.', solution: 'الخبر = NaCl. الظهران = NaCl+SiO₂. SiO₂ = خدش إضافي. مختلف.' },
    ],
    consumerEducation: [
