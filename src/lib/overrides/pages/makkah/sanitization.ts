...
export const override: PageOverride = {
    meta: {
        title: 'تعقيم بمكة المكرمة — خدمة احترافية معتمدة (2026)',
        description: 'تعقيم بمكة المكرمة. خدمة احترافية. فريق متخصص. ضمان مكتوب. أسعار شفافة. خدمة سريعة.',
        h1: 'تعقيم بمكة المكرمة — خدمة احترافية معتمدة مع ضمان',
        keywords: ['تعقيم بمكة المكرمة', 'تعقيم مكة المكرمة', 'شركة تعقيم بمكة المكرمة', 'أفضل تعقيم بمكة المكرمة'],
    },

    content: {
        introduction: 'تعقيم بمكة المكرمة — خدمة متخصصة تراعي الظروف المناخية والبيئية في مكة المكرمة. فريق محترف مع أدوات حديثة وضمان مكتوب.',
        shortAnswer: 'تعقيم بمكة المكرمة: خدمة احترافية بأسعار شفافة. فريق متخصص. ضمان مكتوب.',
        heroSubtitle: 'تعقيم بمكة المكرمة. خدمة احترافية. ضمان.',
    },
    ...
    faq: [
        { question: 'كم تكلفة تعقيم بمكة المكرمة؟', answer: 'تبدأ الأسعار من 150 ريال وتختلف حسب المساحة ونوع الخدمة. اطلب عرض سعر مجاني.' },
