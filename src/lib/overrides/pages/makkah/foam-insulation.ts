...
export const override: PageOverride = {
    meta: {
        title: 'عزل فوم بمكة المكرمة — خدمة احترافية معتمدة (2026)',
        description: 'عزل فوم بمكة المكرمة. خدمة احترافية. فريق متخصص. ضمان مكتوب. أسعار شفافة. خدمة سريعة.',
        h1: 'عزل فوم بمكة المكرمة — خدمة احترافية معتمدة مع ضمان',
        keywords: ['عزل فوم بمكة المكرمة', 'عزل فوم مكة المكرمة', 'شركة عزل فوم بمكة المكرمة', 'أفضل عزل فوم بمكة المكرمة'],
    },

    content: {
        introduction: 'عزل فوم بمكة المكرمة — خدمة متخصصة تراعي الظروف المناخية والبيئية في مكة المكرمة. فريق محترف مع أدوات حديثة وضمان مكتوب.',
        shortAnswer: 'عزل فوم بمكة المكرمة: خدمة احترافية بأسعار شفافة. فريق متخصص. ضمان مكتوب.',
        heroSubtitle: 'عزل فوم بمكة المكرمة. خدمة احترافية. ضمان.',
    },
    ...
    faq: [
        { question: 'كم تكلفة عزل فوم بمكة المكرمة؟', answer: 'تبدأ الأسعار من 150 ريال وتختلف حسب المساحة ونوع الخدمة. اطلب عرض سعر مجاني.' },
