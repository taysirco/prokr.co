// ══════════════════════════════════════════════════════════════
// جلي رخام بمكة المكرمة — Override مخصص (E-E-A-T Grade)
...
export const override: PageOverride = {
    meta: {
        title: 'جلي رخام بمكة المكرمة — خدمة احترافية معتمدة (2026)',
        description: 'جلي رخام بمكة المكرمة. خدمة احترافية. فريق متخصص. ضمان مكتوب. أسعار شفافة. خدمة سريعة.',
        h1: 'جلي رخام بمكة المكرمة — خدمة احترافية معتمدة مع ضمان',
        keywords: ['جلي رخام بمكة المكرمة', 'جلي رخام مكة المكرمة', 'شركة جلي رخام بمكة المكرمة', 'أفضل جلي رخام بمكة المكرمة'],
    },

    content: {
        introduction: 'جلي رخام بمكة المكرمة — خدمة متخصصة تراعي الظروف المناخية والبيئية في مكة المكرمة. فريق محترف مع أدوات حديثة وضمان مكتوب.',
        shortAnswer: 'جلي رخام بمكة المكرمة: خدمة احترافية بأسعار شفافة. فريق متخصص. ضمان مكتوب.',
        heroSubtitle: 'جلي رخام بمكة المكرمة. خدمة احترافية. ضمان.',
    },
    ...
    faq: [
        { question: 'كم تكلفة جلي رخام بمكة المكرمة؟', answer: 'تبدأ الأسعار من 150 ريال وتختلف حسب المساحة ونوع الخدمة. اطلب عرض سعر مجاني.' },
