...
export const override: PageOverride = {
    meta: {
        title: 'تسليك مجاري بمكة المكرمة — خدمة احترافية معتمدة (2026)',
        description: 'تسليك مجاري بمكة المكرمة. خدمة احترافية. فريق متخصص. ضمان مكتوب. أسعار شفافة. خدمة سريعة.',
        h1: 'تسليك مجاري بمكة المكرمة — خدمة احترافية معتمدة مع ضمان',
        keywords: ['تسليك مجاري بمكة المكرمة', 'تسليك مجاري مكة المكرمة', 'شركة تسليك مجاري بمكة المكرمة', 'أفضل تسليك مجاري بمكة المكرمة'],
    },

    content: {
        introduction: 'تسليك مجاري بمكة المكرمة — خدمة متخصصة تراعي الظروف المناخية والبيئية في مكة المكرمة. فريق محترف مع أدوات حديثة وضمان مكتوب.',
        shortAnswer: 'تسليك مجاري بمكة المكرمة: خدمة احترافية بأسعار شفافة. فريق متخصص. ضمان مكتوب.',
        heroSubtitle: 'تسليك مجاري بمكة المكرمة. خدمة احترافية. ضمان.',
    },
    ...
    faq: [
        { question: 'كم تكلفة تسليك مجاري بمكة المكرمة؟', answer: 'تبدأ الأسعار من 150 ريال وتختلف حسب المساحة ونوع الخدمة. اطلب عرض سعر مجاني.' },
