...
export const override: PageOverride = {
    meta: {
        title: 'عزل حراري بمكة المكرمة — خدمة احترافية معتمدة (2026)',
        description: 'عزل حراري بمكة المكرمة. خدمة احترافية. فريق متخصص. ضمان مكتوب. أسعار شفافة. خدمة سريعة.',
        h1: 'عزل حراري بمكة المكرمة — خدمة احترافية معتمدة مع ضمان',
        keywords: ['عزل حراري بمكة المكرمة', 'عزل حراري مكة المكرمة', 'شركة عزل حراري بمكة المكرمة', 'أفضل عزل حراري بمكة المكرمة'],
    },

    content: {
        introduction: 'عزل حراري بمكة المكرمة — خدمة متخصصة تراعي الظروف المناخية والبيئية في مكة المكرمة. فريق محترف مع أدوات حديثة وضمان مكتوب.',
        shortAnswer: 'عزل حراري بمكة المكرمة: خدمة احترافية بأسعار شفافة. فريق متخصص. ضمان مكتوب.',
        heroSubtitle: 'عزل حراري بمكة المكرمة. خدمة احترافية. ضمان.',
    },
    ...
    faq: [
        { question: 'كم تكلفة عزل حراري بمكة المكرمة؟', answer: 'تبدأ الأسعار من 150 ريال وتختلف حسب المساحة ونوع الخدمة. اطلب عرض سعر مجاني.' },
