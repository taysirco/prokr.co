// ══════════════════════════════════════════════════════════════
// تنظيف قصور بمكة المكرمة — Override مخصص (E-E-A-T Grade)
// صفحة: /makkah/palaces-cleaning
// ══════════════════════════════════════════════════════════════
...
export const override: PageOverride = {
    meta: {
        title: 'تنظيف قصور بمكة المكرمة — خدمة احترافية معتمدة (2026)',
        description: 'تنظيف قصور بمكة المكرمة. خدمة احترافية. فريق متخصص. ضمان مكتوب. أسعار شفافة. خدمة سريعة.',
        h1: 'تنظيف قصور بمكة المكرمة — خدمة احترافية معتمدة مع ضمان',
        keywords: ['تنظيف قصور بمكة المكرمة', 'تنظيف قصور مكة المكرمة', 'شركة تنظيف قصور بمكة المكرمة', 'أفضل تنظيف قصور بمكة المكرمة'],
    },

    content: {
        introduction: 'تنظيف قصور بمكة المكرمة — خدمة متخصصة تراعي الظروف المناخية والبيئية في مكة المكرمة. فريق محترف مع أدوات حديثة وضمان مكتوب.',
        shortAnswer: 'تنظيف قصور بمكة المكرمة: خدمة احترافية بأسعار شفافة. فريق متخصص. ضمان مكتوب.',
        heroSubtitle: 'تنظيف قصور بمكة المكرمة. خدمة احترافية. ضمان.',
    },
    ...
    faq: [
        { question: 'كم تكلفة تنظيف قصور بمكة المكرمة؟', answer: 'تبدأ الأسعار من 150 ريال وتختلف حسب المساحة ونوع الخدمة. اطلب عرض سعر مجاني.' },
