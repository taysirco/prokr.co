// ══════════════════════════════════════════════════════════════
// دباب نقل بمكة المكرمة — Override مخصص (E-E-A-T Grade)
// صفحة: /makkah/dabab
// ══════════════════════════════════════════════════════════════
...
export const override: PageOverride = {
    meta: {
        title: 'دباب نقل بمكة المكرمة — خدمة احترافية معتمدة (2026)',
        description: 'دباب نقل بمكة المكرمة. خدمة احترافية. فريق متخصص. ضمان مكتوب. أسعار شفافة. خدمة سريعة.',
        h1: 'دباب نقل بمكة المكرمة — خدمة احترافية معتمدة مع ضمان',
        keywords: ['دباب نقل بمكة المكرمة', 'دباب نقل مكة المكرمة', 'شركة دباب نقل بمكة المكرمة', 'أفضل دباب نقل بمكة المكرمة'],
    },

    content: {
        introduction: 'دباب نقل بمكة المكرمة — خدمة متخصصة تراعي الظروف المناخية والبيئية في مكة المكرمة. فريق محترف مع أدوات حديثة وضمان مكتوب.',
        shortAnswer: 'دباب نقل بمكة المكرمة: خدمة احترافية بأسعار شفافة. فريق متخصص. ضمان مكتوب.',
        heroSubtitle: 'دباب نقل بمكة المكرمة. خدمة احترافية. ضمان.',
    },
    ...
    faq: [
        { question: 'كم تكلفة دباب نقل بمكة المكرمة؟', answer: 'تبدأ الأسعار من 150 ريال وتختلف حسب المساحة ونوع الخدمة. اطلب عرض سعر مجاني.' },
