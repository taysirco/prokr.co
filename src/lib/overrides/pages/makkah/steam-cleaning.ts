...
export const override: PageOverride = {
    meta: {
        title: 'تنظيف بالبخار بمكة المكرمة — خدمة احترافية معتمدة (2026)',
        description: 'تنظيف بالبخار بمكة المكرمة. خدمة احترافية. فريق متخصص. ضمان مكتوب. أسعار شفافة. خدمة سريعة.',
        h1: 'تنظيف بالبخار بمكة المكرمة — خدمة احترافية معتمدة مع ضمان',
        keywords: ['تنظيف بالبخار بمكة المكرمة', 'تنظيف بالبخار مكة المكرمة', 'شركة تنظيف بالبخار بمكة المكرمة', 'أفضل تنظيف بالبخار بمكة المكرمة'],
    },

    content: {
        introduction: 'تنظيف بالبخار بمكة المكرمة — خدمة متخصصة تراعي الظروف المناخية والبيئية في مكة المكرمة. فريق محترف مع أدوات حديثة وضمان مكتوب.',
        shortAnswer: 'تنظيف بالبخار بمكة المكرمة: خدمة احترافية بأسعار شفافة. فريق متخصص. ضمان مكتوب.',
        heroSubtitle: 'تنظيف بالبخار بمكة المكرمة. خدمة احترافية. ضمان.',
    },
    ...
    faq: [
        { question: 'كم تكلفة تنظيف بالبخار بمكة المكرمة؟', answer: 'تبدأ الأسعار من 150 ريال وتختلف حسب المساحة ونوع الخدمة. اطلب عرض سعر مجاني.' },
