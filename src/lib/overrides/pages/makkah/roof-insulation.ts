...
export const override: PageOverride = {
    meta: {
        title: 'عزل أسطح بمكة المكرمة — خدمة احترافية معتمدة (2026)',
        description: 'عزل أسطح بمكة المكرمة. خدمة احترافية. فريق متخصص. ضمان مكتوب. أسعار شفافة. خدمة سريعة.',
        h1: 'عزل أسطح بمكة المكرمة — خدمة احترافية معتمدة مع ضمان',
        keywords: ['عزل أسطح بمكة المكرمة', 'عزل أسطح مكة المكرمة', 'شركة عزل أسطح بمكة المكرمة', 'أفضل عزل أسطح بمكة المكرمة'],
    },

    content: {
        introduction: 'عزل أسطح بمكة المكرمة — خدمة متخصصة تراعي الظروف المناخية والبيئية في مكة المكرمة. فريق محترف مع أدوات حديثة وضمان مكتوب.',
        shortAnswer: 'عزل أسطح بمكة المكرمة: خدمة احترافية بأسعار شفافة. فريق متخصص. ضمان مكتوب.',
        heroSubtitle: 'عزل أسطح بمكة المكرمة. خدمة احترافية. ضمان.',
    },
    ...
    faq: [
        { question: 'كم تكلفة عزل أسطح بمكة المكرمة؟', answer: 'تبدأ الأسعار من 150 ريال وتختلف حسب المساحة ونوع الخدمة. اطلب عرض سعر مجاني.' },
