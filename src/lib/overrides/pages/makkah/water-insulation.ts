...
export const override: PageOverride = {
    meta: {
        title: 'عزل مائي بمكة المكرمة — خدمة احترافية معتمدة (2026)',
        description: 'عزل مائي بمكة المكرمة. خدمة احترافية. فريق متخصص. ضمان مكتوب. أسعار شفافة. خدمة سريعة.',
        h1: 'عزل مائي بمكة المكرمة — خدمة احترافية معتمدة مع ضمان',
        keywords: ['عزل مائي بمكة المكرمة', 'عزل مائي مكة المكرمة', 'شركة عزل مائي بمكة المكرمة', 'أفضل عزل مائي بمكة المكرمة'],
    },

    content: {
        introduction: 'عزل مائي بمكة المكرمة — خدمة متخصصة تراعي الظروف المناخية والبيئية في مكة المكرمة. فريق محترف مع أدوات حديثة وضمان مكتوب.',
        shortAnswer: 'عزل مائي بمكة المكرمة: خدمة احترافية بأسعار شفافة. فريق متخصص. ضمان مكتوب.',
        heroSubtitle: 'عزل مائي بمكة المكرمة. خدمة احترافية. ضمان.',
    },
    ...
    faq: [
        { question: 'كم تكلفة عزل مائي بمكة المكرمة؟', answer: 'تبدأ الأسعار من 150 ريال وتختلف حسب المساحة ونوع الخدمة. اطلب عرض سعر مجاني.' },
