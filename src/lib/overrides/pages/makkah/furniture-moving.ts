...
export const override: PageOverride = {
    meta: {
        title: 'نقل عفش بمكة المكرمة — خدمة احترافية معتمدة (2026)',
        description: 'نقل عفش بمكة المكرمة. خدمة احترافية. فريق متخصص. ضمان مكتوب. أسعار شفافة. خدمة سريعة.',
        h1: 'نقل عفش بمكة المكرمة — خدمة احترافية معتمدة مع ضمان',
        keywords: ['نقل عفش بمكة المكرمة', 'نقل عفش مكة المكرمة', 'شركة نقل عفش بمكة المكرمة', 'أفضل نقل عفش بمكة المكرمة'],
    },

    content: {
        introduction: 'نقل عفش بمكة المكرمة — خدمة متخصصة تراعي الظروف المناخية والبيئية في مكة المكرمة. فريق محترف مع أدوات حديثة وضمان مكتوب.',
        shortAnswer: 'نقل عفش بمكة المكرمة: خدمة احترافية بأسعار شفافة. فريق متخصص. ضمان مكتوب.',
        heroSubtitle: 'نقل عفش بمكة المكرمة. خدمة احترافية. ضمان.',
    },
    ...
    faq: [
        { question: 'كم تكلفة نقل عفش بمكة المكرمة؟', answer: 'تبدأ الأسعار من 150 ريال وتختلف حسب المساحة ونوع الخدمة. اطلب عرض سعر مجاني.' },
    ...
    relatedServices: [
        { slug: 'makkah-furniture-storage', context: 'تخزين عفش بمكة المكرمة', priority: 1 },
