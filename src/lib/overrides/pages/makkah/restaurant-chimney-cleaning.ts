...
export const override: PageOverride = {
    meta: {
        title: 'تنظيف مداخن مطاعم بمكة المكرمة — خدمة احترافية معتمدة (2026)',
        description: 'تنظيف مداخن مطاعم بمكة المكرمة. خدمة احترافية. فريق متخصص. ضمان مكتوب. أسعار شفافة. خدمة سريعة.',
        h1: 'تنظيف مداخن مطاعم بمكة المكرمة — خدمة احترافية معتمدة مع ضمان',
        keywords: ['تنظيف مداخن مطاعم بمكة المكرمة', 'تنظيف مداخن مطاعم مكة المكرمة', 'شركة تنظيف مداخن مطاعم بمكة المكرمة', 'أفضل تنظيف مداخن مطاعم بمكة المكرمة'],
    },

    content: {
        introduction: 'تنظيف مداخن مطاعم بمكة المكرمة — خدمة متخصصة تراعي الظروف المناخية والبيئية في مكة المكرمة. فريق محترف مع أدوات حديثة وضمان مكتوب.',
        shortAnswer: 'تنظيف مداخن مطاعم بمكة المكرمة: خدمة احترافية بأسعار شفافة. فريق متخصص. ضمان مكتوب.',
        heroSubtitle: 'تنظيف مداخن مطاعم بمكة المكرمة. خدمة احترافية. ضمان.',
    },
    ...
    faq: [
        { question: 'كم تكلفة تنظيف مداخن مطاعم بمكة المكرمة؟', answer: 'تبدأ الأسعار من 150 ريال وتختلف حسب المساحة ونوع الخدمة. اطلب عرض سعر مجاني.' },
