...
export const override: PageOverride = {
    meta: {
        title: 'تنظيف واجهات زجاجية بمكة المكرمة — خدمة احترافية معتمدة (2026)',
        description: 'تنظيف واجهات زجاجية بمكة المكرمة. خدمة احترافية. فريق متخصص. ضمان مكتوب. أسعار شفافة. خدمة سريعة.',
        h1: 'تنظيف واجهات زجاجية بمكة المكرمة — خدمة احترافية معتمدة مع ضمان',
        keywords: ['تنظيف واجهات زجاجية بمكة المكرمة', 'تنظيف واجهات زجاجية مكة المكرمة', 'شركة تنظيف واجهات زجاجية بمكة المكرمة', 'أفضل تنظيف واجهات زجاجية بمكة المكرمة'],
    },

    content: {
        introduction: 'تنظيف واجهات زجاجية بمكة المكرمة — خدمة متخصصة تراعي الظروف المناخية والبيئية في مكة المكرمة. فريق محترف مع أدوات حديثة وضمان مكتوب.',
        shortAnswer: 'تنظيف واجهات زجاجية بمكة المكرمة: خدمة احترافية بأسعار شفافة. فريق متخصص. ضمان مكتوب.',
        heroSubtitle: 'تنظيف واجهات زجاجية بمكة المكرمة. خدمة احترافية. ضمان.',
    },
    ...
    faq: [
        { question: 'كم تكلفة تنظيف واجهات زجاجية بمكة المكرمة؟', answer: 'تبدأ الأسعار من 150 ريال وتختلف حسب المساحة ونوع الخدمة. اطلب عرض سعر مجاني.' },
