// ══════════════════════════════════════════════════════════════
// تنظيف أفران بمكة المكرمة — Override مخصص (E-E-A-T Grade)
...
export const override: PageOverride = {
    meta: {
        title: 'تنظيف أفران بمكة المكرمة — خدمة احترافية معتمدة (2026)',
        description: 'تنظيف أفران بمكة المكرمة. خدمة احترافية. فريق متخصص. ضمان مكتوب. أسعار شفافة. خدمة سريعة.',
        h1: 'تنظيف أفران بمكة المكرمة — خدمة احترافية معتمدة مع ضمان',
        keywords: ['تنظيف أفران بمكة المكرمة', 'تنظيف أفران مكة المكرمة', 'شركة تنظيف أفران بمكة المكرمة', 'أفضل تنظيف أفران بمكة المكرمة'],
    },

    content: {
        introduction: 'تنظيف أفران بمكة المكرمة — خدمة متخصصة تراعي الظروف المناخية والبيئية في مكة المكرمة. فريق محترف مع أدوات حديثة وضمان مكتوب.',
        shortAnswer: 'تنظيف أفران بمكة المكرمة: خدمة احترافية بأسعار شفافة. فريق متخصص. ضمان مكتوب.',
        heroSubtitle: 'تنظيف أفران بمكة المكرمة. خدمة احترافية. ضمان.',
    },
    ...
    faq: [
        { question: 'كم تكلفة تنظيف أفران بمكة المكرمة؟', answer: 'تبدأ الأسعار من 150 ريال وتختلف حسب المساحة ونوع الخدمة. اطلب عرض سعر مجاني.' },
