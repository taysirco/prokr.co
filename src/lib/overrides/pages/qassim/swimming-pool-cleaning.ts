// ══════════════════════════════════════════════════════════════
// تنظيف مسابح بالقصيم — Override مخصص (E-E-A-T Grade)
// صفحة: /qassim/swimming-pool-cleaning
// ══════════════════════════════════════════════════════════════
...
export const override: PageOverride = {
    meta: {
        title: 'تنظيف مسابح بالقصيم — خدمة احترافية معتمدة (2026)',
        description: 'تنظيف مسابح بالقصيم. خدمة احترافية. فريق متخصص. ضمان مكتوب. أسعار شفافة. خدمة سريعة.',
        h1: 'تنظيف مسابح بالقصيم — خدمة احترافية معتمدة مع ضمان',
        keywords: ['تنظيف مسابح بالقصيم', 'تنظيف مسابح القصيم', 'شركة تنظيف مسابح بالقصيم', 'أفضل تنظيف مسابح بالقصيم'],
    },

    content: {
        introduction: 'تنظيف مسابح بالقصيم — خدمة متخصصة تراعي الظروف المناخية والبيئية في القصيم. فريق محترف مع أدوات حديثة وضمان مكتوب.',
        shortAnswer: 'تنظيف مسابح بالقصيم: خدمة احترافية بأسعار شفافة. فريق متخصص. ضمان مكتوب.',
        heroSubtitle: 'تنظيف مسابح بالقصيم. خدمة احترافية. ضمان.',
    },
    ...
    faq: [
        { question: 'كم تكلفة تنظيف مسابح بالقصيم؟', answer: 'تبدأ الأسعار من 150 ريال وتختلف حسب المساحة ونوع الخدمة. اطلب عرض سعر مجاني.' },
