// ══════════════════════════════════════════════════════════════
// نقل عفش بالقصيم — Override مخصص (E-E-A-T Grade)
// صفحة: /qassim/furniture-moving
// ══════════════════════════════════════════════════════════════
...
export const override: PageOverride = {
    meta: {
        title: 'نقل عفش بالقصيم — خدمة احترافية معتمدة (2026)',
        description: 'نقل عفش بالقصيم. خدمة احترافية. فريق متخصص. ضمان مكتوب. أسعار شفافة. خدمة سريعة.',
        h1: 'نقل عفش بالقصيم — خدمة احترافية معتمدة مع ضمان',
        keywords: ['نقل عفش بالقصيم', 'نقل عفش القصيم', 'شركة نقل عفش بالقصيم', 'أفضل نقل عفش بالقصيم'],
    },

    content: {
        introduction: 'نقل عفش بالقصيم — خدمة متخصصة تراعي الظروف المناخية والبيئية في القصيم. فريق محترف مع أدوات حديثة وضمان مكتوب.',
        shortAnswer: 'نقل عفش بالقصيم: خدمة احترافية بأسعار شفافة. فريق متخصص. ضمان مكتوب.',
        heroSubtitle: 'نقل عفش بالقصيم. خدمة احترافية. ضمان.',
    },
    ...
    faq: [
        { question: 'كم تكلفة نقل عفش بالقصيم؟', answer: 'تبدأ الأسعار من 150 ريال وتختلف حسب المساحة ونوع الخدمة. اطلب عرض سعر مجاني.' },
    ...
    relatedServices: [
        { slug: 'qassim-furniture-storage', context: 'تخزين عفش بالقصيم', priority: 1 },
