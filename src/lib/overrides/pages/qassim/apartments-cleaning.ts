// ══════════════════════════════════════════════════════════════
// تنظيف شقق بالقصيم — Override مخصص (E-E-A-T Grade)
// صفحة: /qassim/apartments-cleaning
// ══════════════════════════════════════════════════════════════
...
export const override: PageOverride = {
    meta: {
        title: 'تنظيف شقق بالقصيم — خدمة احترافية معتمدة (2026)',
        description: 'تنظيف شقق بالقصيم. خدمة احترافية. فريق متخصص. ضمان مكتوب. أسعار شفافة. خدمة سريعة.',
        h1: 'تنظيف شقق بالقصيم — خدمة احترافية معتمدة مع ضمان',
        keywords: ['تنظيف شقق بالقصيم', 'تنظيف شقق القصيم', 'شركة تنظيف شقق بالقصيم', 'أفضل تنظيف شقق بالقصيم'],
    },

    content: {
        introduction: 'تنظيف شقق بالقصيم — خدمة متخصصة تراعي الظروف المناخية والبيئية في القصيم. فريق محترف مع أدوات حديثة وضمان مكتوب.',
        shortAnswer: 'تنظيف شقق بالقصيم: خدمة احترافية بأسعار شفافة. فريق متخصص. ضمان مكتوب.',
        heroSubtitle: 'تنظيف شقق بالقصيم. خدمة احترافية. ضمان.',
    },
    ...
    faq: [
        { question: 'كم تكلفة تنظيف شقق بالقصيم؟', answer: 'تبدأ الأسعار من 150 ريال وتختلف حسب المساحة ونوع الخدمة. اطلب عرض سعر مجاني.' },
