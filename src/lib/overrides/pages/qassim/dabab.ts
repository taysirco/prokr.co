// ══════════════════════════════════════════════════════════════
// دباب نقل بالقصيم — Override مخصص (E-E-A-T Grade)
// صفحة: /qassim/dabab
// ══════════════════════════════════════════════════════════════
...
export const override: PageOverride = {
    meta: {
        title: 'دباب نقل بالقصيم — خدمة احترافية معتمدة (2026)',
        description: 'دباب نقل بالقصيم. خدمة احترافية. فريق متخصص. ضمان مكتوب. أسعار شفافة. خدمة سريعة.',
        h1: 'دباب نقل بالقصيم — خدمة احترافية معتمدة مع ضمان',
        keywords: ['دباب نقل بالقصيم', 'دباب نقل القصيم', 'شركة دباب نقل بالقصيم', 'أفضل دباب نقل بالقصيم'],
    },

    content: {
        introduction: 'دباب نقل بالقصيم — خدمة متخصصة تراعي الظروف المناخية والبيئية في القصيم. فريق محترف مع أدوات حديثة وضمان مكتوب.',
        shortAnswer: 'دباب نقل بالقصيم: خدمة احترافية بأسعار شفافة. فريق متخصص. ضمان مكتوب.',
        heroSubtitle: 'دباب نقل بالقصيم. خدمة احترافية. ضمان.',
    },
    ...
    faq: [
        { question: 'كم تكلفة دباب نقل بالقصيم؟', answer: 'تبدأ الأسعار من 150 ريال وتختلف حسب المساحة ونوع الخدمة. اطلب عرض سعر مجاني.' },
