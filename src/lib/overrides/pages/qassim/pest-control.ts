// ══════════════════════════════════════════════════════════════
// مكافحة حشرات بالقصيم — Override مخصص (E-E-A-T Grade)
// صفحة: /qassim/pest-control
// ══════════════════════════════════════════════════════════════
...
export const override: PageOverride = {
    meta: {
        title: 'مكافحة حشرات بالقصيم — خدمة احترافية معتمدة (2026)',
        description: 'مكافحة حشرات بالقصيم. خدمة احترافية. فريق متخصص. ضمان مكتوب. أسعار شفافة. خدمة سريعة.',
        h1: 'مكافحة حشرات بالقصيم — خدمة احترافية معتمدة مع ضمان',
        keywords: ['مكافحة حشرات بالقصيم', 'مكافحة حشرات القصيم', 'شركة مكافحة حشرات بالقصيم', 'أفضل مكافحة حشرات بالقصيم'],
    },

    content: {
        introduction: 'مكافحة حشرات بالقصيم — خدمة متخصصة تراعي الظروف المناخية والبيئية في القصيم. فريق محترف مع أدوات حديثة وضمان مكتوب.',
        shortAnswer: 'مكافحة حشرات بالقصيم: خدمة احترافية بأسعار شفافة. فريق متخصص. ضمان مكتوب.',
        heroSubtitle: 'مكافحة حشرات بالقصيم. خدمة احترافية. ضمان.',
    },
    ...
    faq: [
        { question: 'كم تكلفة مكافحة حشرات بالقصيم؟', answer: 'تبدأ الأسعار من 150 ريال وتختلف حسب المساحة ونوع الخدمة. اطلب عرض سعر مجاني.' },
