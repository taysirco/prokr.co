// ══════════════════════════════════════════════════════════════
// جلي بلاط بالقصيم — Override مخصص (E-E-A-T Grade)
// صفحة: /qassim/floor-polishing
// ══════════════════════════════════════════════════════════════
...
export const override: PageOverride = {
    meta: {
        title: 'جلي بلاط بالقصيم — خدمة احترافية معتمدة (2026)',
        description: 'جلي بلاط بالقصيم. خدمة احترافية. فريق متخصص. ضمان مكتوب. أسعار شفافة. خدمة سريعة.',
        h1: 'جلي بلاط بالقصيم — خدمة احترافية معتمدة مع ضمان',
        keywords: ['جلي بلاط بالقصيم', 'جلي بلاط القصيم', 'شركة جلي بلاط بالقصيم', 'أفضل جلي بلاط بالقصيم'],
    },

    content: {
        introduction: 'جلي بلاط بالقصيم — خدمة متخصصة تراعي الظروف المناخية والبيئية في القصيم. فريق محترف مع أدوات حديثة وضمان مكتوب.',
        shortAnswer: 'جلي بلاط بالقصيم: خدمة احترافية بأسعار شفافة. فريق متخصص. ضمان مكتوب.',
        heroSubtitle: 'جلي بلاط بالقصيم. خدمة احترافية. ضمان.',
    },
    ...
    faq: [
        { question: 'كم تكلفة جلي بلاط بالقصيم؟', answer: 'تبدأ الأسعار من 150 ريال وتختلف حسب المساحة ونوع الخدمة. اطلب عرض سعر مجاني.' },
