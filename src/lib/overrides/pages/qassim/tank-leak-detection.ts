// ══════════════════════════════════════════════════════════════
// كشف تسربات خزانات بالقصيم — Override مخصص (E-E-A-T Grade)
// صفحة: /qassim/tank-leak-detection
// ══════════════════════════════════════════════════════════════
...
export const override: PageOverride = {
    meta: {
        title: 'كشف تسربات خزانات بالقصيم — خدمة احترافية معتمدة (2026)',
        description: 'كشف تسربات خزانات بالقصيم. خدمة احترافية. فريق متخصص. ضمان مكتوب. أسعار شفافة. خدمة سريعة.',
        h1: 'كشف تسربات خزانات بالقصيم — خدمة احترافية معتمدة مع ضمان',
        keywords: ['كشف تسربات خزانات بالقصيم', 'كشف تسربات خزانات القصيم', 'شركة كشف تسربات خزانات بالقصيم', 'أفضل كشف تسربات خزانات بالقصيم'],
    },

    content: {
        introduction: 'كشف تسربات خزانات بالقصيم — خدمة متخصصة تراعي الظروف المناخية والبيئية في القصيم. فريق محترف مع أدوات حديثة وضمان مكتوب.',
        shortAnswer: 'كشف تسربات خزانات بالقصيم: خدمة احترافية بأسعار شفافة. فريق متخصص. ضمان مكتوب.',
        heroSubtitle: 'كشف تسربات خزانات بالقصيم. خدمة احترافية. ضمان.',
    },
    ...
    faq: [
        { question: 'كم تكلفة كشف تسربات خزانات بالقصيم؟', answer: 'تبدأ الأسعار من 150 ريال وتختلف حسب المساحة ونوع الخدمة. اطلب عرض سعر مجاني.' },
