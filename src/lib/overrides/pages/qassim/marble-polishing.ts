// ══════════════════════════════════════════════════════════════
// جلي رخام بالقصيم — Override مخصص (E-E-A-T Grade)
// صفحة: /qassim/marble-polishing
// ══════════════════════════════════════════════════════════════
...
export const override: PageOverride = {
    meta: {
        title: 'جلي رخام بالقصيم — خدمة احترافية معتمدة (2026)',
        description: 'جلي رخام بالقصيم. خدمة احترافية. فريق متخصص. ضمان مكتوب. أسعار شفافة. خدمة سريعة.',
        h1: 'جلي رخام بالقصيم — خدمة احترافية معتمدة مع ضمان',
        keywords: ['جلي رخام بالقصيم', 'جلي رخام القصيم', 'شركة جلي رخام بالقصيم', 'أفضل جلي رخام بالقصيم'],
    },

    content: {
        introduction: 'جلي رخام بالقصيم — خدمة متخصصة تراعي الظروف المناخية والبيئية في القصيم. فريق محترف مع أدوات حديثة وضمان مكتوب.',
        shortAnswer: 'جلي رخام بالقصيم: خدمة احترافية بأسعار شفافة. فريق متخصص. ضمان مكتوب.',
        heroSubtitle: 'جلي رخام بالقصيم. خدمة احترافية. ضمان.',
    },
    ...
    faq: [
        { question: 'كم تكلفة جلي رخام بالقصيم؟', answer: 'تبدأ الأسعار من 150 ريال وتختلف حسب المساحة ونوع الخدمة. اطلب عرض سعر مجاني.' },
