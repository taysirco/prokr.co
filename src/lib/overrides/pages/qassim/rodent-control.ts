// ══════════════════════════════════════════════════════════════
// مكافحة فئران بالقصيم — Override مخصص (E-E-A-T Grade)
// صفحة: /qassim/rodent-control
// ══════════════════════════════════════════════════════════════
...
export const override: PageOverride = {
    meta: {
        title: 'مكافحة فئران بالقصيم — خدمة احترافية معتمدة (2026)',
        description: 'مكافحة فئران بالقصيم. خدمة احترافية. فريق متخصص. ضمان مكتوب. أسعار شفافة. خدمة سريعة.',
        h1: 'مكافحة فئران بالقصيم — خدمة احترافية معتمدة مع ضمان',
        keywords: ['مكافحة فئران بالقصيم', 'مكافحة فئران القصيم', 'شركة مكافحة فئران بالقصيم', 'أفضل مكافحة فئران بالقصيم'],
    },

    content: {
        introduction: 'مكافحة فئران بالقصيم — خدمة متخصصة تراعي الظروف المناخية والبيئية في القصيم. فريق محترف مع أدوات حديثة وضمان مكتوب.',
        shortAnswer: 'مكافحة فئران بالقصيم: خدمة احترافية بأسعار شفافة. فريق متخصص. ضمان مكتوب.',
        heroSubtitle: 'مكافحة فئران بالقصيم. خدمة احترافية. ضمان.',
    },
    ...
    faq: [
        { question: 'كم تكلفة مكافحة فئران بالقصيم؟', answer: 'تبدأ الأسعار من 150 ريال وتختلف حسب المساحة ونوع الخدمة. اطلب عرض سعر مجاني.' },
