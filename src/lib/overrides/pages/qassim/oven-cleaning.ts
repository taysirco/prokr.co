// ══════════════════════════════════════════════════════════════
// تنظيف أفران بالقصيم — Override مخصص (E-E-A-T Grade)
// صفحة: /qassim/oven-cleaning
// ══════════════════════════════════════════════════════════════
...
export const override: PageOverride = {
    meta: {
        title: 'تنظيف أفران بالقصيم — خدمة احترافية معتمدة (2026)',
        description: 'تنظيف أفران بالقصيم. خدمة احترافية. فريق متخصص. ضمان مكتوب. أسعار شفافة. خدمة سريعة.',
        h1: 'تنظيف أفران بالقصيم — خدمة احترافية معتمدة مع ضمان',
        keywords: ['تنظيف أفران بالقصيم', 'تنظيف أفران القصيم', 'شركة تنظيف أفران بالقصيم', 'أفضل تنظيف أفران بالقصيم'],
    },

    content: {
        introduction: 'تنظيف أفران بالقصيم — خدمة متخصصة تراعي الظروف المناخية والبيئية في القصيم. فريق محترف مع أدوات حديثة وضمان مكتوب.',
        shortAnswer: 'تنظيف أفران بالقصيم: خدمة احترافية بأسعار شفافة. فريق متخصص. ضمان مكتوب.',
        heroSubtitle: 'تنظيف أفران بالقصيم. خدمة احترافية. ضمان.',
    },
    ...
    faq: [
        { question: 'كم تكلفة تنظيف أفران بالقصيم؟', answer: 'تبدأ الأسعار من 150 ريال وتختلف حسب المساحة ونوع الخدمة. اطلب عرض سعر مجاني.' },
