// ══════════════════════════════════════════════════════════════
// تنظيف خزانات بحفر الباطن — Override مخصص (E-E-A-T Grade)
// صفحة: /hafr-albatin/tanks-cleaning
// ══════════════════════════════════════════════════════════════
...
export const override: PageOverride = {
    meta: {
        title: 'تنظيف خزانات بحفر الباطن — خدمة احترافية معتمدة (2026)',
        description: 'تنظيف خزانات بحفر الباطن. خدمة احترافية. فريق متخصص. ضمان مكتوب. أسعار شفافة. خدمة سريعة.',
        h1: 'تنظيف خزانات بحفر الباطن — خدمة احترافية معتمدة مع ضمان',
        keywords: ['تنظيف خزانات بحفر الباطن', 'تنظيف خزانات حفر الباطن', 'شركة تنظيف خزانات بحفر الباطن', 'أفضل تنظيف خزانات بحفر الباطن'],
    },

    content: {
        introduction: 'تنظيف خزانات بحفر الباطن — خدمة متخصصة تراعي الظروف المناخية والبيئية في حفر الباطن. فريق محترف مع أدوات حديثة وضمان مكتوب.',
        shortAnswer: 'تنظيف خزانات بحفر الباطن: خدمة احترافية بأسعار شفافة. فريق متخصص. ضمان مكتوب.',
        heroSubtitle: 'تنظيف خزانات بحفر الباطن. خدمة احترافية. ضمان.',
    },
    ...
    faq: [
        { question: 'كم تكلفة تنظيف خزانات بحفر الباطن؟', answer: 'تبدأ الأسعار من 150 ريال وتختلف حسب المساحة ونوع الخدمة. اطلب عرض سعر مجاني.' },
