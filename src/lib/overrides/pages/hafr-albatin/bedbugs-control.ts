// ══════════════════════════════════════════════════════════════
// مكافحة بق الفراش بحفر الباطن — Override مخصص (E-E-A-T Grade)
// صفحة: /hafr-albatin/bedbugs-control
// ══════════════════════════════════════════════════════════════
...
export const override: PageOverride = {
    meta: {
        title: 'مكافحة بق الفراش بحفر الباطن — خدمة احترافية معتمدة (2026)',
        description: 'مكافحة بق الفراش بحفر الباطن. خدمة احترافية. فريق متخصص. ضمان مكتوب. أسعار شفافة. خدمة سريعة.',
        h1: 'مكافحة بق الفراش بحفر الباطن — خدمة احترافية معتمدة مع ضمان',
        keywords: ['مكافحة بق الفراش بحفر الباطن', 'مكافحة بق الفراش حفر الباطن', 'شركة مكافحة بق الفراش بحفر الباطن', 'أفضل مكافحة بق الفراش بحفر الباطن'],
    },

    content: {
        introduction: 'مكافحة بق الفراش بحفر الباطن — خدمة متخصصة تراعي الظروف المناخية والبيئية في حفر الباطن. فريق محترف مع أدوات حديثة وضمان مكتوب.',
        shortAnswer: 'مكافحة بق الفراش بحفر الباطن: خدمة احترافية بأسعار شفافة. فريق متخصص. ضمان مكتوب.',
        heroSubtitle: 'مكافحة بق الفراش بحفر الباطن. خدمة احترافية. ضمان.',
    },
    ...
    faq: [
        { question: 'كم تكلفة مكافحة بق الفراش بحفر الباطن؟', answer: 'تبدأ الأسعار من 150 ريال وتختلف حسب المساحة ونوع الخدمة. اطلب عرض سعر مجاني.' },
