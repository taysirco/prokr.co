// ══════════════════════════════════════════════════════════════
// مكافحة نمل أبيض بحفر الباطن — Override مخصص (E-E-A-T Grade)
// صفحة: /hafr-albatin/termite-control
// ══════════════════════════════════════════════════════════════
...
export const override: PageOverride = {
    meta: {
        title: 'مكافحة نمل أبيض بحفر الباطن — خدمة احترافية معتمدة (2026)',
        description: 'مكافحة نمل أبيض بحفر الباطن. خدمة احترافية. فريق متخصص. ضمان مكتوب. أسعار شفافة. خدمة سريعة.',
        h1: 'مكافحة نمل أبيض بحفر الباطن — خدمة احترافية معتمدة مع ضمان',
        keywords: ['مكافحة نمل أبيض بحفر الباطن', 'مكافحة نمل أبيض حفر الباطن', 'شركة مكافحة نمل أبيض بحفر الباطن', 'أفضل مكافحة نمل أبيض بحفر الباطن'],
    },

    content: {
        introduction: 'مكافحة نمل أبيض بحفر الباطن — خدمة متخصصة تراعي الظروف المناخية والبيئية في حفر الباطن. فريق محترف مع أدوات حديثة وضمان مكتوب.',
        shortAnswer: 'مكافحة نمل أبيض بحفر الباطن: خدمة احترافية بأسعار شفافة. فريق متخصص. ضمان مكتوب.',
        heroSubtitle: 'مكافحة نمل أبيض بحفر الباطن. خدمة احترافية. ضمان.',
    },
    ...
    faq: [
        { question: 'كم تكلفة مكافحة نمل أبيض بحفر الباطن؟', answer: 'تبدأ الأسعار من 150 ريال وتختلف حسب المساحة ونوع الخدمة. اطلب عرض سعر مجاني.' },
