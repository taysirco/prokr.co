// ══════════════════════════════════════════════════════════════
// شفط بيارات بحفر الباطن — Override مخصص (E-E-A-T Grade)
// صفحة: /hafr-albatin/sewage-suction
// ══════════════════════════════════════════════════════════════
...
export const override: PageOverride = {
    meta: {
        title: 'شفط بيارات بحفر الباطن — خدمة احترافية معتمدة (2026)',
        description: 'شفط بيارات بحفر الباطن. خدمة احترافية. فريق متخصص. ضمان مكتوب. أسعار شفافة. خدمة سريعة.',
        h1: 'شفط بيارات بحفر الباطن — خدمة احترافية معتمدة مع ضمان',
        keywords: ['شفط بيارات بحفر الباطن', 'شفط بيارات حفر الباطن', 'شركة شفط بيارات بحفر الباطن', 'أفضل شفط بيارات بحفر الباطن'],
    },

    content: {
        introduction: 'شفط بيارات بحفر الباطن — خدمة متخصصة تراعي الظروف المناخية والبيئية في حفر الباطن. فريق محترف مع أدوات حديثة وضمان مكتوب.',
        shortAnswer: 'شفط بيارات بحفر الباطن: خدمة احترافية بأسعار شفافة. فريق متخصص. ضمان مكتوب.',
        heroSubtitle: 'شفط بيارات بحفر الباطن. خدمة احترافية. ضمان.',
    },
    ...
    faq: [
        { question: 'كم تكلفة شفط بيارات بحفر الباطن؟', answer: 'تبدأ الأسعار من 150 ريال وتختلف حسب المساحة ونوع الخدمة. اطلب عرض سعر مجاني.' },
