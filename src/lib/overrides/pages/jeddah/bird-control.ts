...
export const override: PageOverride = {
    ...
    content: {
        introduction: 'جدة تواجه نوارس بحر (pH 2-3) أشد حمضية 10× من حمام المدن الداخلية (pH 3-4). + الملح البحري (NaCl) يأكل SS304 خلال 2-3 سنوات. SS316 (Molybdenum) هو الوحيد المقبول. والرطوبة 80%: الفضلات لا تجف = بكتيريا حية دائمة ← تحتاج Anti-Bacterial وليس مجرد شطف. المبيدات المستخدمة مسجلة في نظام غد SFDA — آمنة بعد الجفاف الكامل (1-2 ساعة). البروتوكول: فحص أولي بجهاز حراري لتحديد مراكز الإصابة ← رش موجّه بالجرعة المناسبة ← متابعة بعد 14 يوم لضمان القضاء الكامل على دورة الحياة.',
