// ══════════════════════════════════════════════════════════════
// جلي رخام بالخبر — Override مخصص (E-E-A-T Grade)
// صفحة: /al-khobar/marble-polishing
// ══════════════════════════════════════════════════════════════
...
export const override: PageOverride = {
    meta: {
        title: 'جلي رخام بالخبر — خدمة احترافية معتمدة (2026)',
        description: 'جلي رخام بالخبر. خدمة احترافية. فريق متخصص. ضمان مكتوب. أسعار شفافة. خدمة سريعة.',
        h1: 'جلي رخام بالخبر — خدمة احترافية معتمدة مع ضمان',
        keywords: ['جلي رخام بالخبر', 'جلي رخام الخبر', 'شركة جلي رخام بالخبر', 'أفضل جلي رخام بالخبر'],
    },

    content: {
        introduction: 'جلي رخام بالخبر — خدمة متخصصة تراعي الظروف المناخية والبيئية في الخبر. فريق محترف مع أدوات حديثة وضمان مكتوب.',
        shortAnswer: 'جلي رخام بالخبر: خدمة احترافية بأسعار شفافة. فريق متخصص. ضمان مكتوب.',
        heroSubtitle: 'جلي رخام بالخبر. خدمة احترافية. ضمان.',
    },
    ...
    faq: [
        { question: 'كم تكلفة جلي رخام بالخبر؟', answer: 'تبدأ الأسعار من 150 ريال وتختلف حسب المساحة ونوع الخدمة. اطلب عرض سعر مجاني.' },
