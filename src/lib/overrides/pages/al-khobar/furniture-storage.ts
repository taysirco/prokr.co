...
export const override: PageOverride = {
    ...
    commonConcerns: [
        { concern: 'مستودع عادي أرخص.', solution: 'عادي في 85-95% = عفن + صدأ = تالف. أرخص بـ 200-300/شهر — أغلى بـ 10,000-50,000 في التلف.' },
        { concern: 'تخزين قصير.', solution: 'أسبوعان كافية لعفن في 85-95%. صدأ يبدأ في ساعات. قصير ≠ آمن.' },
    ],
    consumerEducation: [
