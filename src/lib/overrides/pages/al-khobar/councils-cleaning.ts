// ══════════════════════════════════════════════════════════════
// تنظيف مجالس بالخبر — Override مخصص (E-E-A-T Grade)
// صفحة: /al-khobar/councils-cleaning
// ══════════════════════════════════════════════════════════════
...
export const override: PageOverride = {
    meta: {
        title: 'تنظيف مجالس بالخبر — خدمة احترافية معتمدة (2026)',
        description: 'تنظيف مجالس بالخبر. خدمة احترافية. فريق متخصص. ضمان مكتوب. أسعار شفافة. خدمة سريعة.',
        h1: 'تنظيف مجالس بالخبر — خدمة احترافية معتمدة مع ضمان',
        keywords: ['تنظيف مجالس بالخبر', 'تنظيف مجالس الخبر', 'شركة تنظيف مجالس بالخبر', 'أفضل تنظيف مجالس بالخبر'],
    },

    content: {
        introduction: 'تنظيف مجالس بالخبر — خدمة متخصصة تراعي الظروف المناخية والبيئية في الخبر. فريق محترف مع أدوات حديثة وضمان مكتوب.',
        shortAnswer: 'تنظيف مجالس بالخبر: خدمة احترافية بأسعار شفافة. فريق متخصص. ضمان مكتوب.',
        heroSubtitle: 'تنظيف مجالس بالخبر. خدمة احترافية. ضمان.',
    },
    ...
    faq: [
        { question: 'كم تكلفة تنظيف مجالس بالخبر؟', answer: 'تبدأ الأسعار من 150 ريال وتختلف حسب المساحة ونوع الخدمة. اطلب عرض سعر مجاني.' },
