...
export const override: PageOverride = {
    ...
    commonConcerns: [
        { concern: 'عاملة واحدة.', solution: '6 محاور = تحتاج فريق مُتخصص. عاملة واحدة = 1/6 محور. الباقي = بدون حماية.' },
        { concern: 'لسنة كاملة؟', solution: 'NaCl يومي + عفن أسبوعي + بعوض شهري. سنة = 50 أسبوع بدون حماية. أسبوعي = الأمثل.' },
    ],
    consumerEducation: [
