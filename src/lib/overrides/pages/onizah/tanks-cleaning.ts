// ══════════════════════════════════════════════════════════════
// تنظيف خزانات بعنيزة — Override مخصص (E-E-A-T Grade)
// صفحة: /onizah/tanks-cleaning
// ══════════════════════════════════════════════════════════════
...
export const override: PageOverride = {
    meta: {
        title: 'تنظيف خزانات بعنيزة — خدمة احترافية معتمدة (2026)',
        description: 'تنظيف خزانات بعنيزة. خدمة احترافية. فريق متخصص. ضمان مكتوب. أسعار شفافة. خدمة سريعة.',
        h1: 'تنظيف خزانات بعنيزة — خدمة احترافية معتمدة مع ضمان',
        keywords: ['تنظيف خزانات بعنيزة', 'تنظيف خزانات عنيزة', 'شركة تنظيف خزانات بعنيزة', 'أفضل تنظيف خزانات بعنيزة'],
    },

    content: {
        introduction: 'تنظيف خزانات بعنيزة — خدمة متخصصة تراعي الظروف المناخية والبيئية في عنيزة. فريق محترف مع أدوات حديثة وضمان مكتوب.',
        shortAnswer: 'تنظيف خزانات بعنيزة: خدمة احترافية بأسعار شفافة. فريق متخصص. ضمان مكتوب.',
        heroSubtitle: 'تنظيف خزانات بعنيزة. خدمة احترافية. ضمان.',
    },
    ...
    faq: [
        { question: 'كم تكلفة تنظيف خزانات بعنيزة؟', answer: 'تبدأ الأسعار من 150 ريال وتختلف حسب المساحة ونوع الخدمة. اطلب عرض سعر مجاني.' },
