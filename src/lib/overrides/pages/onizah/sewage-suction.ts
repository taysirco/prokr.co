...
export const override: PageOverride = {
    meta: {
        title: 'شفط بيارات بعنيزة — خدمة احترافية معتمدة (2026)',
        description: 'شفط بيارات بعنيزة. خدمة احترافية. فريق متخصص. ضمان مكتوب. أسعار شفافة. خدمة سريعة.',
        h1: 'شفط بيارات بعنيزة — خدمة احترافية معتمدة مع ضمان',
        keywords: ['شفط بيارات بعنيزة', 'شفط بيارات عنيزة', 'شركة شفط بيارات بعنيزة', 'أفضل شفط بيارات بعنيزة'],
    },
