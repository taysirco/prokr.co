// ══════════════════════════════════════════════════════════════
// دينا نقل بعنيزة — Override مخصص (E-E-A-T Grade)
// صفحة: /onizah/dyna
// ══════════════════════════════════════════════════════════════
...
export const override: PageOverride = {
    meta: {
        title: 'دينا نقل بعنيزة — خدمة احترافية معتمدة (2026)',
        description: 'دينا نقل بعنيزة. خدمة احترافية. فريق متخصص. ضمان مكتوب. أسعار شفافة. خدمة سريعة.',
        h1: 'دينا نقل بعنيزة — خدمة احترافية معتمدة مع ضمان',
        keywords: ['دينا نقل بعنيزة', 'دينا نقل عنيزة', 'شركة دينا نقل بعنيزة', 'أفضل دينا نقل بعنيزة'],
    },

    content: {
        introduction: 'دينا نقل بعنيزة — خدمة متخصصة تراعي الظروف المناخية والبيئية في عنيزة. فريق محترف مع أدوات حديثة وضمان مكتوب.',
        shortAnswer: 'دينا نقل بعنيزة: خدمة احترافية بأسعار شفافة. فريق متخصص. ضمان مكتوب.',
        heroSubtitle: 'دينا نقل بعنيزة. خدمة احترافية. ضمان.',
    },
    ...
    faq: [
        { question: 'كم تكلفة دينا نقل بعنيزة؟', answer: 'تبدأ الأسعار من 150 ريال وتختلف حسب المساحة ونوع الخدمة. اطلب عرض سعر مجاني.' },
