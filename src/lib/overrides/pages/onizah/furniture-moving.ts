// ══════════════════════════════════════════════════════════════
// نقل عفش بعنيزة — Override مخصص (E-E-A-T Grade)
// صفحة: /onizah/furniture-moving
// ══════════════════════════════════════════════════════════════
...
export const override: PageOverride = {
    meta: {
        title: 'نقل عفش بعنيزة — خدمة احترافية معتمدة (2026)',
        description: 'نقل عفش بعنيزة. خدمة احترافية. فريق متخصص. ضمان مكتوب. أسعار شفافة. خدمة سريعة.',
        h1: 'نقل عفش بعنيزة — خدمة احترافية معتمدة مع ضمان',
        keywords: ['نقل عفش بعنيزة', 'نقل عفش عنيزة', 'شركة نقل عفش بعنيزة', 'أفضل نقل عفش بعنيزة'],
    },

    content: {
        introduction: 'نقل عفش بعنيزة — خدمة متخصصة تراعي الظروف المناخية والبيئية في عنيزة. فريق محترف مع أدوات حديثة وضمان مكتوب.',
        shortAnswer: 'نقل عفش بعنيزة: خدمة احترافية بأسعار شفافة. فريق متخصص. ضمان مكتوب.',
        heroSubtitle: 'نقل عفش بعنيزة. خدمة احترافية. ضمان.',
    },
    ...
    faq: [
        { question: 'كم تكلفة نقل عفش بعنيزة؟', answer: 'تبدأ الأسعار من 150 ريال وتختلف حسب المساحة ونوع الخدمة. اطلب عرض سعر مجاني.' },
    ...
    relatedServices: [
        { slug: 'onizah-furniture-storage', context: 'تخزين عفش بعنيزة', priority: 1 },
