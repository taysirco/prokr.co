...
export const override: PageOverride = {
    meta: {
        title: 'عزل فوم بعنيزة — خدمة احترافية معتمدة (2026)',
        description: 'عزل فوم بعنيزة. خدمة احترافية. فريق متخصص. ضمان مكتوب. أسعار شفافة. خدمة سريعة.',
        h1: 'عزل فوم بعنيزة — خدمة احترافية معتمدة مع ضمان',
        keywords: ['عزل فوم بعنيزة', 'عزل فوم عنيزة', 'شركة عزل فوم بعنيزة', 'أفضل عزل فوم بعنيزة'],
    },
