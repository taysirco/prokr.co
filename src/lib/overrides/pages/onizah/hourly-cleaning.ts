...
export const override: PageOverride = {
    ...
    commonConcerns: [
        { concern: 'أقل من خميس = أقل جودة.', solution: '3 خطوات لأن البيئة أبسط. لا عفن = لا حاجة لخطوات إضافية.' },
        { concern: 'حشرات تمور.', solution: 'فحص مداخل 30 ثانية كل زيارة. بسيط.' },
    ],
    consumerEducation: [
