// ══════════════════════════════════════════════════════════════
// تنظيف مداخن مطاعم بعنيزة — Override مخصص (E-E-A-T Grade)
// صفحة: /onizah/restaurant-chimney-cleaning
// ══════════════════════════════════════════════════════════════
...
export const override: PageOverride = {
    meta: {
        title: 'تنظيف مداخن مطاعم بعنيزة — خدمة احترافية معتمدة (2026)',
        description: 'تنظيف مداخن مطاعم بعنيزة. خدمة احترافية. فريق متخصص. ضمان مكتوب. أسعار شفافة. خدمة سريعة.',
        h1: 'تنظيف مداخن مطاعم بعنيزة — خدمة احترافية معتمدة مع ضمان',
        keywords: ['تنظيف مداخن مطاعم بعنيزة', 'تنظيف مداخن مطاعم عنيزة', 'شركة تنظيف مداخن مطاعم بعنيزة', 'أفضل تنظيف مداخن مطاعم بعنيزة'],
    },

    content: {
        introduction: 'تنظيف مداخن مطاعم بعنيزة — خدمة متخصصة تراعي الظروف المناخية والبيئية في عنيزة. فريق محترف مع أدوات حديثة وضمان مكتوب.',
        shortAnswer: 'تنظيف مداخن مطاعم بعنيزة: خدمة احترافية بأسعار شفافة. فريق متخصص. ضمان مكتوب.',
        heroSubtitle: 'تنظيف مداخن مطاعم بعنيزة. خدمة احترافية. ضمان.',
    },
    ...
    faq: [
        { question: 'كم تكلفة تنظيف مداخن مطاعم بعنيزة؟', answer: 'تبدأ الأسعار من 150 ريال وتختلف حسب المساحة ونوع الخدمة. اطلب عرض سعر مجاني.' },
