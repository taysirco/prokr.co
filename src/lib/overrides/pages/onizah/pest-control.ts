...
export const override: PageOverride = {
    ...
    commonConcerns: [{ concern: 'رش واحد يكفي.', solution: '4 مصادر مختلفة (نخيل + نمل + عقارب + حرارة). رش واحد ≠ يغطي. بروتوكول رباعي.' }],
    consumerEducation: [{ myth: 'الحرارة تقتل الحشرات.', truth: '48°م = تُسرّع دورة الحياة. بق 21 يوم بدلاً من 45. الحرارة = صديقة الحشرات.' },
