// ══════════════════════════════════════════════════════════════
// كشف تسربات خزانات بعنيزة — Override مخصص (E-E-A-T Grade)
// صفحة: /onizah/tank-leak-detection
// ══════════════════════════════════════════════════════════════
...
export const override: PageOverride = {
    meta: {
        title: 'كشف تسربات خزانات بعنيزة — خدمة احترافية معتمدة (2026)',
        description: 'كشف تسربات خزانات بعنيزة. خدمة احترافية. فريق متخصص. ضمان مكتوب. أسعار شفافة. خدمة سريعة.',
        h1: 'كشف تسربات خزانات بعنيزة — خدمة احترافية معتمدة مع ضمان',
        keywords: ['كشف تسربات خزانات بعنيزة', 'كشف تسربات خزانات عنيزة', 'شركة كشف تسربات خزانات بعنيزة', 'أفضل كشف تسربات خزانات بعنيزة'],
    },
    ...
    faq: [
        { question: 'كم تكلفة كشف تسربات خزانات بعنيزة؟', answer: 'تبدأ الأسعار من 150 ريال وتختلف حسب المساحة ونوع الخدمة. اطلب عرض سعر مجاني.' },
