// ══════════════════════════════════════════════════════════════
// عزل حراري بالخرج — Override مخصص (E-E-A-T Grade)
// صفحة: /al-kharj/thermal-insulation
// ══════════════════════════════════════════════════════════════
...
export const override: PageOverride = {
    meta: {
        title: 'عزل حراري بالخرج — خدمة احترافية معتمدة (2026)',
        description: 'عزل حراري بالخرج. خدمة احترافية. فريق متخصص. ضمان مكتوب. أسعار شفافة. خدمة سريعة.',
        h1: 'عزل حراري بالخرج — خدمة احترافية معتمدة مع ضمان',
        keywords: ['عزل حراري بالخرج', 'عزل حراري الخرج', 'شركة عزل حراري بالخرج', 'أفضل عزل حراري بالخرج'],
    },

    content: {
        introduction: 'عزل حراري بالخرج — خدمة متخصصة تراعي الظروف المناخية والبيئية في الخرج. فريق محترف مع أدوات حديثة وضمان مكتوب.',
        shortAnswer: 'عزل حراري بالخرج: خدمة احترافية بأسعار شفافة. فريق متخصص. ضمان مكتوب.',
        heroSubtitle: 'عزل حراري بالخرج. خدمة احترافية. ضمان.',
    },
    ...
    faq: [
        { question: 'كم تكلفة عزل حراري بالخرج؟', answer: 'تبدأ الأسعار من 150 ريال وتختلف حسب المساحة ونوع الخدمة. اطلب عرض سعر مجاني.' },
