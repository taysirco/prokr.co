// ══════════════════════════════════════════════════════════════
// تعقيم بالخرج — Override مخصص (E-E-A-T Grade)
// صفحة: /al-kharj/sanitization
// ══════════════════════════════════════════════════════════════
...
export const override: PageOverride = {
    meta: {
        title: 'تعقيم بالخرج — خدمة احترافية معتمدة (2026)',
        description: 'تعقيم بالخرج. خدمة احترافية. فريق متخصص. ضمان مكتوب. أسعار شفافة. خدمة سريعة.',
        h1: 'تعقيم بالخرج — خدمة احترافية معتمدة مع ضمان',
        keywords: ['تعقيم بالخرج', 'تعقيم الخرج', 'شركة تعقيم بالخرج', 'أفضل تعقيم بالخرج'],
    },

    content: {
        introduction: 'تعقيم بالخرج — خدمة متخصصة تراعي الظروف المناخية والبيئية في الخرج. فريق محترف مع أدوات حديثة وضمان مكتوب.',
        shortAnswer: 'تعقيم بالخرج: خدمة احترافية بأسعار شفافة. فريق متخصص. ضمان مكتوب.',
        heroSubtitle: 'تعقيم بالخرج. خدمة احترافية. ضمان.',
    },
    ...
    faq: [
        { question: 'كم تكلفة تعقيم بالخرج؟', answer: 'تبدأ الأسعار من 150 ريال وتختلف حسب المساحة ونوع الخدمة. اطلب عرض سعر مجاني.' },
