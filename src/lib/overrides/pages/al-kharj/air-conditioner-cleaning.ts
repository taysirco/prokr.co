// ══════════════════════════════════════════════════════════════
// تنظيف مكيفات بالخرج — Override مخصص (E-E-A-T Grade)
// صفحة: /al-kharj/air-conditioner-cleaning
// ══════════════════════════════════════════════════════════════
...
export const override: PageOverride = {
    meta: {
        title: 'تنظيف مكيفات بالخرج — خدمة احترافية معتمدة (2026)',
        description: 'تنظيف مكيفات بالخرج. خدمة احترافية. فريق متخصص. ضمان مكتوب. أسعار شفافة. خدمة سريعة.',
        h1: 'تنظيف مكيفات بالخرج — خدمة احترافية معتمدة مع ضمان',
        keywords: ['تنظيف مكيفات بالخرج', 'تنظيف مكيفات الخرج', 'شركة تنظيف مكيفات بالخرج', 'أفضل تنظيف مكيفات بالخرج'],
    },

    content: {
        introduction: 'تنظيف مكيفات بالخرج — خدمة متخصصة تراعي الظروف المناخية والبيئية في الخرج. فريق محترف مع أدوات حديثة وضمان مكتوب.',
        shortAnswer: 'تنظيف مكيفات بالخرج: خدمة احترافية بأسعار شفافة. فريق متخصص. ضمان مكتوب.',
        heroSubtitle: 'تنظيف مكيفات بالخرج. خدمة احترافية. ضمان.',
    },
    ...
    faq: [
        { question: 'كم تكلفة تنظيف مكيفات بالخرج؟', answer: 'تبدأ الأسعار من 150 ريال وتختلف حسب المساحة ونوع الخدمة. اطلب عرض سعر مجاني.' },
