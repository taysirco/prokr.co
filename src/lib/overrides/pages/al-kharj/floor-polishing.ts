// ══════════════════════════════════════════════════════════════
// جلي بلاط بالخرج — Override مخصص (E-E-A-T Grade)
// صفحة: /al-kharj/floor-polishing
// ══════════════════════════════════════════════════════════════
...
export const override: PageOverride = {
    meta: {
        title: 'جلي بلاط بالخرج — خدمة احترافية معتمدة (2026)',
        description: 'جلي بلاط بالخرج. خدمة احترافية. فريق متخصص. ضمان مكتوب. أسعار شفافة. خدمة سريعة.',
        h1: 'جلي بلاط بالخرج — خدمة احترافية معتمدة مع ضمان',
        keywords: ['جلي بلاط بالخرج', 'جلي بلاط الخرج', 'شركة جلي بلاط بالخرج', 'أفضل جلي بلاط بالخرج'],
    },

    content: {
        introduction: 'جلي بلاط بالخرج — خدمة متخصصة تراعي الظروف المناخية والبيئية في الخرج. فريق محترف مع أدوات حديثة وضمان مكتوب.',
        shortAnswer: 'جلي بلاط بالخرج: خدمة احترافية بأسعار شفافة. فريق متخصص. ضمان مكتوب.',
        heroSubtitle: 'جلي بلاط بالخرج. خدمة احترافية. ضمان.',
    },
    ...
    faq: [
        { question: 'كم تكلفة جلي بلاط بالخرج؟', answer: 'تبدأ الأسعار من 150 ريال وتختلف حسب المساحة ونوع الخدمة. اطلب عرض سعر مجاني.' },
