// ══════════════════════════════════════════════════════════════
// تنظيف سجاد بالخرج — Override مخصص (E-E-A-T Grade)
// صفحة: /al-kharj/carpet-cleaning
// ══════════════════════════════════════════════════════════════
...
export const override: PageOverride = {
    meta: {
        title: 'تنظيف سجاد بالخرج — خدمة احترافية معتمدة (2026)',
        description: 'تنظيف سجاد بالخرج. خدمة احترافية. فريق متخصص. ضمان مكتوب. أسعار شفافة. خدمة سريعة.',
        h1: 'تنظيف سجاد بالخرج — خدمة احترافية معتمدة مع ضمان',
        keywords: ['تنظيف سجاد بالخرج', 'تنظيف سجاد الخرج', 'شركة تنظيف سجاد بالخرج', 'أفضل تنظيف سجاد بالخرج'],
    },

    content: {
        introduction: 'تنظيف سجاد بالخرج — خدمة متخصصة تراعي الظروف المناخية والبيئية في الخرج. فريق محترف مع أدوات حديثة وضمان مكتوب.',
        shortAnswer: 'تنظيف سجاد بالخرج: خدمة احترافية بأسعار شفافة. فريق متخصص. ضمان مكتوب.',
        heroSubtitle: 'تنظيف سجاد بالخرج. خدمة احترافية. ضمان.',
    },
    ...
    faq: [
        { question: 'كم تكلفة تنظيف سجاد بالخرج؟', answer: 'تبدأ الأسعار من 150 ريال وتختلف حسب المساحة ونوع الخدمة. اطلب عرض سعر مجاني.' },
