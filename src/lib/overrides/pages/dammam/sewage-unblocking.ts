...
export const override: PageOverride = {
    meta: {
        title: 'تسليك مجاري بالدمام — خدمة احترافية معتمدة (2026)',
        description: 'تسليك مجاري بالدمام. خدمة احترافية. فريق متخصص. ضمان مكتوب. أسعار شفافة. خدمة سريعة.',
        h1: 'تسليك مجاري بالدمام — خدمة احترافية معتمدة مع ضمان',
        keywords: ['تسليك مجاري بالدمام', 'تسليك مجاري الدمام', 'شركة تسليك مجاري بالدمام', 'أفضل تسليك مجاري بالدمام'],
    },

    content: {
        introduction: 'تسليك مجاري بالدمام — خدمة متخصصة تراعي الظروف المناخية والبيئية في الدمام. فريق محترف مع أدوات حديثة وضمان مكتوب.',
        shortAnswer: 'تسليك مجاري بالدمام: خدمة احترافية بأسعار شفافة. فريق متخصص. ضمان مكتوب.',
        heroSubtitle: 'تسليك مجاري بالدمام. خدمة احترافية. ضمان.',
    },
    ...
    faq: [
        { question: 'كم تكلفة تسليك مجاري بالدمام؟', answer: 'تبدأ الأسعار من 150 ريال وتختلف حسب المساحة ونوع الخدمة. اطلب عرض سعر مجاني.' },
