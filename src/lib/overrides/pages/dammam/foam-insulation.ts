...
export const override: PageOverride = {
    meta: {
        title: 'عزل فوم بالدمام — خدمة احترافية معتمدة (2026)',
        description: 'عزل فوم بالدمام. خدمة احترافية. فريق متخصص. ضمان مكتوب. أسعار شفافة. خدمة سريعة.',
        h1: 'عزل فوم بالدمام — خدمة احترافية معتمدة مع ضمان',
        keywords: ['عزل فوم بالدمام', 'عزل فوم الدمام', 'شركة عزل فوم بالدمام', 'أفضل عزل فوم بالدمام'],
    },

    content: {
        introduction: 'عزل فوم بالدمام — خدمة متخصصة تراعي الظروف المناخية والبيئية في الدمام. فريق محترف مع أدوات حديثة وضمان مكتوب.',
        shortAnswer: 'عزل فوم بالدمام: خدمة احترافية بأسعار شفافة. فريق متخصص. ضمان مكتوب.',
        heroSubtitle: 'عزل فوم بالدمام. خدمة احترافية. ضمان.',
    },
    ...
    faq: [
        { question: 'كم تكلفة عزل فوم بالدمام؟', answer: 'تبدأ الأسعار من 150 ريال وتختلف حسب المساحة ونوع الخدمة. اطلب عرض سعر مجاني.' },
