...
export const override: PageOverride = {
    meta: {
        title: 'تنظيف مداخن مطاعم بالدمام — خدمة احترافية معتمدة (2026)',
        description: 'تنظيف مداخن مطاعم بالدمام. خدمة احترافية. فريق متخصص. ضمان مكتوب. أسعار شفافة. خدمة سريعة.',
        h1: 'تنظيف مداخن مطاعم بالدمام — خدمة احترافية معتمدة مع ضمان',
        keywords: ['تنظيف مداخن مطاعم بالدمام', 'تنظيف مداخن مطاعم الدمام', 'شركة تنظيف مداخن مطاعم بالدمام', 'أفضل تنظيف مداخن مطاعم بالدمام'],
    },

    content: {
        introduction: 'تنظيف مداخن مطاعم بالدمام — خدمة متخصصة تراعي الظروف المناخية والبيئية في الدمام. فريق محترف مع أدوات حديثة وضمان مكتوب.',
        shortAnswer: 'تنظيف مداخن مطاعم بالدمام: خدمة احترافية بأسعار شفافة. فريق متخصص. ضمان مكتوب.',
        heroSubtitle: 'تنظيف مداخن مطاعم بالدمام. خدمة احترافية. ضمان.',
    },
    ...
    faq: [
        { question: 'كم تكلفة تنظيف مداخن مطاعم بالدمام؟', answer: 'تبدأ الأسعار من 150 ريال وتختلف حسب المساحة ونوع الخدمة. اطلب عرض سعر مجاني.' },
