...
export const override: PageOverride = {
    meta: {
        title: 'جلي بلاط بالدمام — خدمة احترافية معتمدة (2026)',
        description: 'جلي بلاط بالدمام. خدمة احترافية. فريق متخصص. ضمان مكتوب. أسعار شفافة. خدمة سريعة.',
        h1: 'جلي بلاط بالدمام — خدمة احترافية معتمدة مع ضمان',
        keywords: ['جلي بلاط بالدمام', 'جلي بلاط الدمام', 'شركة جلي بلاط بالدمام', 'أفضل جلي بلاط بالدمام'],
    },

    content: {
        introduction: 'جلي بلاط بالدمام — خدمة متخصصة تراعي الظروف المناخية والبيئية في الدمام. فريق محترف مع أدوات حديثة وضمان مكتوب.',
        shortAnswer: 'جلي بلاط بالدمام: خدمة احترافية بأسعار شفافة. فريق متخصص. ضمان مكتوب.',
        heroSubtitle: 'جلي بلاط بالدمام. خدمة احترافية. ضمان.',
    },
    ...
    faq: [
        { question: 'كم تكلفة جلي بلاط بالدمام؟', answer: 'تبدأ الأسعار من 150 ريال وتختلف حسب المساحة ونوع الخدمة. اطلب عرض سعر مجاني.' },
