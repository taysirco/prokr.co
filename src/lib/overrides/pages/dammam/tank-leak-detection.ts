...
export const override: PageOverride = {
    meta: {
        title: 'كشف تسربات خزانات بالدمام — خدمة احترافية معتمدة (2026)',
        description: 'كشف تسربات خزانات بالدمام. خدمة احترافية. فريق متخصص. ضمان مكتوب. أسعار شفافة. خدمة سريعة.',
        h1: 'كشف تسربات خزانات بالدمام — خدمة احترافية معتمدة مع ضمان',
        keywords: ['كشف تسربات خزانات بالدمام', 'كشف تسربات خزانات الدمام', 'شركة كشف تسربات خزانات بالدمام', 'أفضل كشف تسربات خزانات بالدمام'],
    },

    content: {
        introduction: 'كشف تسربات خزانات بالدمام — خدمة متخصصة تراعي الظروف المناخية والبيئية في الدمام. فريق محترف مع أدوات حديثة وضمان مكتوب.',
        shortAnswer: 'كشف تسربات خزانات بالدمام: خدمة احترافية بأسعار شفافة. فريق متخصص. ضمان مكتوب.',
        heroSubtitle: 'كشف تسربات خزانات بالدمام. خدمة احترافية. ضمان.',
    },
    ...
    faq: [
        { question: 'كم تكلفة كشف تسربات خزانات بالدمام؟', answer: 'تبدأ الأسعار من 150 ريال وتختلف حسب المساحة ونوع الخدمة. اطلب عرض سعر مجاني.' },
