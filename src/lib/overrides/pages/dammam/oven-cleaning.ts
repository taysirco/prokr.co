...
export const override: PageOverride = {
    meta: {
        title: 'تنظيف أفران بالدمام — خدمة احترافية معتمدة (2026)',
        description: 'تنظيف أفران بالدمام. خدمة احترافية. فريق متخصص. ضمان مكتوب. أسعار شفافة. خدمة سريعة.',
        h1: 'تنظيف أفران بالدمام — خدمة احترافية معتمدة مع ضمان',
        keywords: ['تنظيف أفران بالدمام', 'تنظيف أفران الدمام', 'شركة تنظيف أفران بالدمام', 'أفضل تنظيف أفران بالدمام'],
    },

    content: {
        introduction: 'تنظيف أفران بالدمام — خدمة متخصصة تراعي الظروف المناخية والبيئية في الدمام. فريق محترف مع أدوات حديثة وضمان مكتوب.',
        shortAnswer: 'تنظيف أفران بالدمام: خدمة احترافية بأسعار شفافة. فريق متخصص. ضمان مكتوب.',
        heroSubtitle: 'تنظيف أفران بالدمام. خدمة احترافية. ضمان.',
    },
    ...
    faq: [
        { question: 'كم تكلفة تنظيف أفران بالدمام؟', answer: 'تبدأ الأسعار من 150 ريال وتختلف حسب المساحة ونوع الخدمة. اطلب عرض سعر مجاني.' },
