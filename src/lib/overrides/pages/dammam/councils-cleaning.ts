...
export const override: PageOverride = {
    meta: {
        title: 'تنظيف مجالس بالدمام — خدمة احترافية معتمدة (2026)',
        description: 'تنظيف مجالس بالدمام. خدمة احترافية. فريق متخصص. ضمان مكتوب. أسعار شفافة. خدمة سريعة.',
        h1: 'تنظيف مجالس بالدمام — خدمة احترافية معتمدة مع ضمان',
        keywords: ['تنظيف مجالس بالدمام', 'تنظيف مجالس الدمام', 'شركة تنظيف مجالس بالدمام', 'أفضل تنظيف مجالس بالدمام'],
    },

    content: {
        introduction: 'تنظيف مجالس بالدمام — خدمة متخصصة تراعي الظروف المناخية والبيئية في الدمام. فريق محترف مع أدوات حديثة وضمان مكتوب.',
        shortAnswer: 'تنظيف مجالس بالدمام: خدمة احترافية بأسعار شفافة. فريق متخصص. ضمان مكتوب.',
        heroSubtitle: 'تنظيف مجالس بالدمام. خدمة احترافية. ضمان.',
    },
    ...
    faq: [
        { question: 'كم تكلفة تنظيف مجالس بالدمام؟', answer: 'تبدأ الأسعار من 150 ريال وتختلف حسب المساحة ونوع الخدمة. اطلب عرض سعر مجاني.' },
