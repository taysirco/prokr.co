// ══════════════════════════════════════════════════════════════
// مكافحة حمام بالدمام — Override مخصص (E-E-A-T Grade)
...
export const override: PageOverride = {
    meta: {
        title: 'مكافحة حمام بالدمام — خدمة احترافية معتمدة (2026)',
        description: 'مكافحة حمام بالدمام. خدمة احترافية. فريق متخصص. ضمان مكتوب. أسعار شفافة. خدمة سريعة.',
        h1: 'مكافحة حمام بالدمام — خدمة احترافية معتمدة مع ضمان',
        keywords: ['مكافحة حمام بالدمام', 'مكافحة حمام الدمام', 'شركة مكافحة حمام بالدمام', 'أفضل مكافحة حمام بالدمام'],
    },

    content: {
        introduction: 'مكافحة حمام بالدمام — خدمة متخصصة تراعي الظروف المناخية والبيئية في الدمام. فريق محترف مع أدوات حديثة وضمان مكتوب.',
        shortAnswer: 'مكافحة حمام بالدمام: خدمة احترافية بأسعار شفافة. فريق متخصص. ضمان مكتوب.',
        heroSubtitle: 'مكافحة حمام بالدمام. خدمة احترافية. ضمان.',
    },
    ...
    faq: [
        { question: 'كم تكلفة مكافحة حمام بالدمام؟', answer: 'تبدأ الأسعار من 150 ريال وتختلف حسب المساحة ونوع الخدمة. اطلب عرض سعر مجاني.' },
