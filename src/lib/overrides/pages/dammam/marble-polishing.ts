...
export const override: PageOverride = {
    meta: {
        title: 'جلي رخام بالدمام — خدمة احترافية معتمدة (2026)',
        description: 'جلي رخام بالدمام. خدمة احترافية. فريق متخصص. ضمان مكتوب. أسعار شفافة. خدمة سريعة.',
        h1: 'جلي رخام بالدمام — خدمة احترافية معتمدة مع ضمان',
        keywords: ['جلي رخام بالدمام', 'جلي رخام الدمام', 'شركة جلي رخام بالدمام', 'أفضل جلي رخام بالدمام'],
    },

    content: {
        introduction: 'جلي رخام بالدمام — خدمة متخصصة تراعي الظروف المناخية والبيئية في الدمام. فريق محترف مع أدوات حديثة وضمان مكتوب.',
        shortAnswer: 'جلي رخام بالدمام: خدمة احترافية بأسعار شفافة. فريق متخصص. ضمان مكتوب.',
        heroSubtitle: 'جلي رخام بالدمام. خدمة احترافية. ضمان.',
    },
    ...
    faq: [
        { question: 'كم تكلفة جلي رخام بالدمام؟', answer: 'تبدأ الأسعار من 150 ريال وتختلف حسب المساحة ونوع الخدمة. اطلب عرض سعر مجاني.' },
