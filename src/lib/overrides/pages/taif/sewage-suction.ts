// ══════════════════════════════════════════════════════════════
// شفط بيارات بالطائف — Override مخصص (E-E-A-T Grade)
// صفحة: /taif/sewage-suction
// ══════════════════════════════════════════════════════════════
...
export const override: PageOverride = {
    meta: {
        title: 'شفط بيارات بالطائف — خدمة احترافية معتمدة (2026)',
        description: 'شفط بيارات بالطائف. خدمة احترافية. فريق متخصص. ضمان مكتوب. أسعار شفافة. خدمة سريعة.',
        h1: 'شفط بيارات بالطائف — خدمة احترافية معتمدة مع ضمان',
        keywords: ['شفط بيارات بالطائف', 'شفط بيارات الطائف', 'شركة شفط بيارات بالطائف', 'أفضل شفط بيارات بالطائف'],
    },

    content: {
        introduction: 'شفط بيارات بالطائف — خدمة متخصصة تراعي الظروف المناخية والبيئية في الطائف. فريق محترف مع أدوات حديثة وضمان مكتوب.',
        shortAnswer: 'شفط بيارات بالطائف: خدمة احترافية بأسعار شفافة. فريق متخصص. ضمان مكتوب.',
        heroSubtitle: 'شفط بيارات بالطائف. خدمة احترافية. ضمان.',
    },
    ...
    faq: [
        { question: 'كم تكلفة شفط بيارات بالطائف؟', answer: 'تبدأ الأسعار من 150 ريال وتختلف حسب المساحة ونوع الخدمة. اطلب عرض سعر مجاني.' },
