// ══════════════════════════════════════════════════════════════
// تنظيف واجهات زجاجية بالطائف — Override مخصص (E-E-A-T Grade)
// صفحة: /taif/glass-facades-cleaning
// ══════════════════════════════════════════════════════════════
...
export const override: PageOverride = {
    meta: {
        title: 'تنظيف واجهات زجاجية بالطائف — خدمة احترافية معتمدة (2026)',
        description: 'تنظيف واجهات زجاجية بالطائف. خدمة احترافية. فريق متخصص. ضمان مكتوب. أسعار شفافة. خدمة سريعة.',
        h1: 'تنظيف واجهات زجاجية بالطائف — خدمة احترافية معتمدة مع ضمان',
        keywords: ['تنظيف واجهات زجاجية بالطائف', 'تنظيف واجهات زجاجية الطائف', 'شركة تنظيف واجهات زجاجية بالطائف', 'أفضل تنظيف واجهات زجاجية بالطائف'],
    },

    content: {
        introduction: 'تنظيف واجهات زجاجية بالطائف — خدمة متخصصة تراعي الظروف المناخية والبيئية في الطائف. فريق محترف مع أدوات حديثة وضمان مكتوب.',
        shortAnswer: 'تنظيف واجهات زجاجية بالطائف: خدمة احترافية بأسعار شفافة. فريق متخصص. ضمان مكتوب.',
        heroSubtitle: 'تنظيف واجهات زجاجية بالطائف. خدمة احترافية. ضمان.',
    },
    ...
    faq: [
        { question: 'كم تكلفة تنظيف واجهات زجاجية بالطائف؟', answer: 'تبدأ الأسعار من 150 ريال وتختلف حسب المساحة ونوع الخدمة. اطلب عرض سعر مجاني.' },
