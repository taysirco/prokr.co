// ══════════════════════════════════════════════════════════════
// رش حشرات بالطائف — Override مخصص (E-E-A-T Grade)
// صفحة: /taif/insects-spraying
// ══════════════════════════════════════════════════════════════
...
export const override: PageOverride = {
    meta: {
        title: 'رش حشرات بالطائف — خدمة احترافية معتمدة (2026)',
        description: 'رش حشرات بالطائف. خدمة احترافية. فريق متخصص. ضمان مكتوب. أسعار شفافة. خدمة سريعة.',
        h1: 'رش حشرات بالطائف — خدمة احترافية معتمدة مع ضمان',
        keywords: ['رش حشرات بالطائف', 'رش حشرات الطائف', 'شركة رش حشرات بالطائف', 'أفضل رش حشرات بالطائف'],
    },

    content: {
        introduction: 'رش حشرات بالطائف — خدمة متخصصة تراعي الظروف المناخية والبيئية في الطائف. فريق محترف مع أدوات حديثة وضمان مكتوب.',
        shortAnswer: 'رش حشرات بالطائف: خدمة احترافية بأسعار شفافة. فريق متخصص. ضمان مكتوب.',
        heroSubtitle: 'رش حشرات بالطائف. خدمة احترافية. ضمان.',
    },
    ...
    faq: [
        { question: 'كم تكلفة رش حشرات بالطائف؟', answer: 'تبدأ الأسعار من 150 ريال وتختلف حسب المساحة ونوع الخدمة. اطلب عرض سعر مجاني.' },
