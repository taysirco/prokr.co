// ══════════════════════════════════════════════════════════════
// مكافحة حشرات بالطائف — Override مخصص (E-E-A-T Grade)
// صفحة: /taif/pest-control
// ══════════════════════════════════════════════════════════════
...
export const override: PageOverride = {
    meta: {
        title: 'مكافحة حشرات بالطائف — خدمة احترافية معتمدة (2026)',
        description: 'مكافحة حشرات بالطائف. خدمة احترافية. فريق متخصص. ضمان مكتوب. أسعار شفافة. خدمة سريعة.',
        h1: 'مكافحة حشرات بالطائف — خدمة احترافية معتمدة مع ضمان',
        keywords: ['مكافحة حشرات بالطائف', 'مكافحة حشرات الطائف', 'شركة مكافحة حشرات بالطائف', 'أفضل مكافحة حشرات بالطائف'],
    },

    content: {
        introduction: 'مكافحة حشرات بالطائف — خدمة متخصصة تراعي الظروف المناخية والبيئية في الطائف. فريق محترف مع أدوات حديثة وضمان مكتوب.',
        shortAnswer: 'مكافحة حشرات بالطائف: خدمة احترافية بأسعار شفافة. فريق متخصص. ضمان مكتوب.',
        heroSubtitle: 'مكافحة حشرات بالطائف. خدمة احترافية. ضمان.',
    },
    ...
    faq: [
        { question: 'كم تكلفة مكافحة حشرات بالطائف؟', answer: 'تبدأ الأسعار من 150 ريال وتختلف حسب المساحة ونوع الخدمة. اطلب عرض سعر مجاني.' },
