// ══════════════════════════════════════════════════════════════
// تنظيف سجاد بالطائف — Override مخصص (E-E-A-T Grade)
// صفحة: /taif/carpet-cleaning
// ══════════════════════════════════════════════════════════════
...
export const override: PageOverride = {
    meta: {
        title: 'تنظيف سجاد بالطائف — خدمة احترافية معتمدة (2026)',
        description: 'تنظيف سجاد بالطائف. خدمة احترافية. فريق متخصص. ضمان مكتوب. أسعار شفافة. خدمة سريعة.',
        h1: 'تنظيف سجاد بالطائف — خدمة احترافية معتمدة مع ضمان',
        keywords: ['تنظيف سجاد بالطائف', 'تنظيف سجاد الطائف', 'شركة تنظيف سجاد بالطائف', 'أفضل تنظيف سجاد بالطائف'],
    },

    content: {
        introduction: 'تنظيف سجاد بالطائف — خدمة متخصصة تراعي الظروف المناخية والبيئية في الطائف. فريق محترف مع أدوات حديثة وضمان مكتوب.',
        shortAnswer: 'تنظيف سجاد بالطائف: خدمة احترافية بأسعار شفافة. فريق متخصص. ضمان مكتوب.',
        heroSubtitle: 'تنظيف سجاد بالطائف. خدمة احترافية. ضمان.',
    },
    ...
    faq: [
        { question: 'كم تكلفة تنظيف سجاد بالطائف؟', answer: 'تبدأ الأسعار من 150 ريال وتختلف حسب المساحة ونوع الخدمة. اطلب عرض سعر مجاني.' },
