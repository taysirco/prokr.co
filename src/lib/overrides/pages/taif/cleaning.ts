...
export const override: PageOverride = {
    meta: {
        title: 'تنظيف منازل بالطائف — خدمة احترافية معتمدة (2026)',
        description: 'تنظيف منازل بالطائف. خدمة احترافية. فريق متخصص. ضمان مكتوب. أسعار شفافة. خدمة سريعة.',
        h1: 'تنظيف منازل بالطائف — خدمة احترافية معتمدة مع ضمان',
        keywords: ['تنظيف منازل بالطائف', 'تنظيف منازل الطائف', 'شركة تنظيف منازل بالطائف', 'أفضل تنظيف منازل بالطائف'],
    },

    content: {
        introduction: 'تنظيف منازل بالطائف — خدمة متخصصة تراعي الظروف المناخية والبيئية في الطائف. فريق محترف مع أدوات حديثة وضمان مكتوب.',
        shortAnswer: 'تنظيف منازل بالطائف: خدمة احترافية بأسعار شفافة. فريق متخصص. ضمان مكتوب.',
        heroSubtitle: 'تنظيف منازل بالطائف. خدمة احترافية. ضمان.',
    },
    ...
    faq: [
        { question: 'كم تكلفة تنظيف منازل بالطائف؟', answer: 'تبدأ الأسعار من 150 ريال وتختلف حسب المساحة ونوع الخدمة. اطلب عرض سعر مجاني.' },
