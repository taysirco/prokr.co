// ══════════════════════════════════════════════════════════════
// عزل حراري بالطائف — Override مخصص (E-E-A-T Grade)
// صفحة: /taif/thermal-insulation
// ══════════════════════════════════════════════════════════════
...
export const override: PageOverride = {
    meta: {
        title: 'عزل حراري بالطائف — خدمة احترافية معتمدة (2026)',
        description: 'عزل حراري بالطائف. خدمة احترافية. فريق متخصص. ضمان مكتوب. أسعار شفافة. خدمة سريعة.',
        h1: 'عزل حراري بالطائف — خدمة احترافية معتمدة مع ضمان',
        keywords: ['عزل حراري بالطائف', 'عزل حراري الطائف', 'شركة عزل حراري بالطائف', 'أفضل عزل حراري بالطائف'],
    },

    content: {
        introduction: 'عزل حراري بالطائف — خدمة متخصصة تراعي الظروف المناخية والبيئية في الطائف. فريق محترف مع أدوات حديثة وضمان مكتوب.',
        shortAnswer: 'عزل حراري بالطائف: خدمة احترافية بأسعار شفافة. فريق متخصص. ضمان مكتوب.',
        heroSubtitle: 'عزل حراري بالطائف. خدمة احترافية. ضمان.',
    },
    ...
    faq: [
        { question: 'كم تكلفة عزل حراري بالطائف؟', answer: 'تبدأ الأسعار من 150 ريال وتختلف حسب المساحة ونوع الخدمة. اطلب عرض سعر مجاني.' },
