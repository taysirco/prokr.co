// ══════════════════════════════════════════════════════════════
// تنظيف فلل بالطائف — Override مخصص (E-E-A-T Grade)
// صفحة: /taif/villas-cleaning
// ══════════════════════════════════════════════════════════════
...
export const override: PageOverride = {
    meta: {
        title: 'تنظيف فلل بالطائف — خدمة احترافية معتمدة (2026)',
        description: 'تنظيف فلل بالطائف. خدمة احترافية. فريق متخصص. ضمان مكتوب. أسعار شفافة. خدمة سريعة.',
        h1: 'تنظيف فلل بالطائف — خدمة احترافية معتمدة مع ضمان',
        keywords: ['تنظيف فلل بالطائف', 'تنظيف فلل الطائف', 'شركة تنظيف فلل بالطائف', 'أفضل تنظيف فلل بالطائف'],
    },

    content: {
        introduction: 'تنظيف فلل بالطائف — خدمة متخصصة تراعي الظروف المناخية والبيئية في الطائف. فريق محترف مع أدوات حديثة وضمان مكتوب.',
        shortAnswer: 'تنظيف فلل بالطائف: خدمة احترافية بأسعار شفافة. فريق متخصص. ضمان مكتوب.',
        heroSubtitle: 'تنظيف فلل بالطائف. خدمة احترافية. ضمان.',
    },
    ...
    faq: [
        { question: 'كم تكلفة تنظيف فلل بالطائف؟', answer: 'تبدأ الأسعار من 150 ريال وتختلف حسب المساحة ونوع الخدمة. اطلب عرض سعر مجاني.' },
