// ══════════════════════════════════════════════════════════════
// كشف تسربات حمامات بالطائف — Override مخصص (E-E-A-T Grade)
// صفحة: /taif/bathroom-leak-detection
// ══════════════════════════════════════════════════════════════
...
export const override: PageOverride = {
    meta: {
        title: 'كشف تسربات حمامات بالطائف — خدمة احترافية معتمدة (2026)',
        description: 'كشف تسربات حمامات بالطائف. خدمة احترافية. فريق متخصص. ضمان مكتوب. أسعار شفافة. خدمة سريعة.',
        h1: 'كشف تسربات حمامات بالطائف — خدمة احترافية معتمدة مع ضمان',
        keywords: ['كشف تسربات حمامات بالطائف', 'كشف تسربات حمامات الطائف', 'شركة كشف تسربات حمامات بالطائف', 'أفضل كشف تسربات حمامات بالطائف'],
    },

    content: {
        introduction: 'كشف تسربات حمامات بالطائف — خدمة متخصصة تراعي الظروف المناخية والبيئية في الطائف. فريق محترف مع أدوات حديثة وضمان مكتوب.',
        shortAnswer: 'كشف تسربات حمامات بالطائف: خدمة احترافية بأسعار شفافة. فريق متخصص. ضمان مكتوب.',
        heroSubtitle: 'كشف تسربات حمامات بالطائف. خدمة احترافية. ضمان.',
    },
    ...
    faq: [
        { question: 'كم تكلفة كشف تسربات حمامات بالطائف؟', answer: 'تبدأ الأسعار من 150 ريال وتختلف حسب المساحة ونوع الخدمة. اطلب عرض سعر مجاني.' },
