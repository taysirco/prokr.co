// ══════════════════════════════════════════════════════════════
// تنظيف محلات بنجران — Override مخصص (E-E-A-T Grade)
// صفحة: /najran/shops-cleaning
// ══════════════════════════════════════════════════════════════
...
export const override: PageOverride = {
    meta: {
        title: 'تنظيف محلات بنجران — خدمة احترافية معتمدة (2026)',
        description: 'تنظيف محلات بنجران. خدمة احترافية. فريق متخصص. ضمان مكتوب. أسعار شفافة. خدمة سريعة.',
        h1: 'تنظيف محلات بنجران — خدمة احترافية معتمدة مع ضمان',
        keywords: ['تنظيف محلات بنجران', 'تنظيف محلات نجران', 'شركة تنظيف محلات بنجران', 'أفضل تنظيف محلات بنجران'],
    },

    content: {
        introduction: 'تنظيف محلات بنجران — خدمة متخصصة تراعي الظروف المناخية والبيئية في نجران. فريق محترف مع أدوات حديثة وضمان مكتوب.',
        shortAnswer: 'تنظيف محلات بنجران: خدمة احترافية بأسعار شفافة. فريق متخصص. ضمان مكتوب.',
        heroSubtitle: 'تنظيف محلات بنجران. خدمة احترافية. ضمان.',
    },
    ...
    faq: [
        { question: 'كم تكلفة تنظيف محلات بنجران؟', answer: 'تبدأ الأسعار من 150 ريال وتختلف حسب المساحة ونوع الخدمة. اطلب عرض سعر مجاني.' },
