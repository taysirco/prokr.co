// ══════════════════════════════════════════════════════════════
// دينا نقل بنجران — Override مخصص (E-E-A-T Grade)
// صفحة: /najran/dyna
// ══════════════════════════════════════════════════════════════
...
export const override: PageOverride = {
    meta: {
        title: 'دينا نقل بنجران — خدمة احترافية معتمدة (2026)',
        description: 'دينا نقل بنجران. خدمة احترافية. فريق متخصص. ضمان مكتوب. أسعار شفافة. خدمة سريعة.',
        h1: 'دينا نقل بنجران — خدمة احترافية معتمدة مع ضمان',
        keywords: ['دينا نقل بنجران', 'دينا نقل نجران', 'شركة دينا نقل بنجران', 'أفضل دينا نقل بنجران'],
    },

    content: {
        introduction: 'دينا نقل بنجران — خدمة متخصصة تراعي الظروف المناخية والبيئية في نجران. فريق محترف مع أدوات حديثة وضمان مكتوب.',
        shortAnswer: 'دينا نقل بنجران: خدمة احترافية بأسعار شفافة. فريق متخصص. ضمان مكتوب.',
        heroSubtitle: 'دينا نقل بنجران. خدمة احترافية. ضمان.',
    },
    ...
    faq: [
        { question: 'كم تكلفة دينا نقل بنجران؟', answer: 'تبدأ الأسعار من 150 ريال وتختلف حسب المساحة ونوع الخدمة. اطلب عرض سعر مجاني.' },
