// ══════════════════════════════════════════════════════════════
// نقل عفش بنجران — Override مخصص (E-E-A-T Grade)
// صفحة: /najran/furniture-moving
// ══════════════════════════════════════════════════════════════
...
export const override: PageOverride = {
    meta: {
        title: 'نقل عفش بنجران — خدمة احترافية معتمدة (2026)',
        description: 'نقل عفش بنجران. خدمة احترافية. فريق متخصص. ضمان مكتوب. أسعار شفافة. خدمة سريعة.',
        h1: 'نقل عفش بنجران — خدمة احترافية معتمدة مع ضمان',
        keywords: ['نقل عفش بنجران', 'نقل عفش نجران', 'شركة نقل عفش بنجران', 'أفضل نقل عفش بنجران'],
    },

    content: {
        introduction: 'نقل عفش بنجران — خدمة متخصصة تراعي الظروف المناخية والبيئية في نجران. فريق محترف مع أدوات حديثة وضمان مكتوب.',
        shortAnswer: 'نقل عفش بنجران: خدمة احترافية بأسعار شفافة. فريق متخصص. ضمان مكتوب.',
        heroSubtitle: 'نقل عفش بنجران. خدمة احترافية. ضمان.',
    },
    ...
    faq: [
        { question: 'كم تكلفة نقل عفش بنجران؟', answer: 'تبدأ الأسعار من 150 ريال وتختلف حسب المساحة ونوع الخدمة. اطلب عرض سعر مجاني.' },
    ...
    relatedServices: [
        { slug: 'najran-furniture-storage', context: 'تخزين عفش بنجران', priority: 1 },
