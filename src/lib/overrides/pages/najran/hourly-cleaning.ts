// ══════════════════════════════════════════════════════════════
// تنظيف بالساعة بنجران — Override مخصص (E-E-A-T Grade)
// صفحة: /najran/hourly-cleaning
// ══════════════════════════════════════════════════════════════
...
export const override: PageOverride = {
    meta: {
        title: 'تنظيف بالساعة بنجران — خدمة احترافية معتمدة (2026)',
        description: 'تنظيف بالساعة بنجران. خدمة احترافية. فريق متخصص. ضمان مكتوب. أسعار شفافة. خدمة سريعة.',
        h1: 'تنظيف بالساعة بنجران — خدمة احترافية معتمدة مع ضمان',
        keywords: ['تنظيف بالساعة بنجران', 'تنظيف بالساعة نجران', 'شركة تنظيف بالساعة بنجران', 'أفضل تنظيف بالساعة بنجران'],
    },

    content: {
        introduction: 'تنظيف بالساعة بنجران — خدمة متخصصة تراعي الظروف المناخية والبيئية في نجران. فريق محترف مع أدوات حديثة وضمان مكتوب.',
        shortAnswer: 'تنظيف بالساعة بنجران: خدمة احترافية بأسعار شفافة. فريق متخصص. ضمان مكتوب.',
        heroSubtitle: 'تنظيف بالساعة بنجران. خدمة احترافية. ضمان.',
    },
    ...
    faq: [
        { question: 'كم تكلفة تنظيف بالساعة بنجران؟', answer: 'تبدأ الأسعار من 150 ريال وتختلف حسب المساحة ونوع الخدمة. اطلب عرض سعر مجاني.' },
