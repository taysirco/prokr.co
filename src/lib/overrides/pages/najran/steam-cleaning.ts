// ══════════════════════════════════════════════════════════════
// تنظيف بالبخار بنجران — Override مخصص (E-E-A-T Grade)
// صفحة: /najran/steam-cleaning
// ══════════════════════════════════════════════════════════════
...
export const override: PageOverride = {
    meta: {
        title: 'تنظيف بالبخار بنجران — خدمة احترافية معتمدة (2026)',
        description: 'تنظيف بالبخار بنجران. خدمة احترافية. فريق متخصص. ضمان مكتوب. أسعار شفافة. خدمة سريعة.',
        h1: 'تنظيف بالبخار بنجران — خدمة احترافية معتمدة مع ضمان',
        keywords: ['تنظيف بالبخار بنجران', 'تنظيف بالبخار نجران', 'شركة تنظيف بالبخار بنجران', 'أفضل تنظيف بالبخار بنجران'],
    },

    content: {
        introduction: 'تنظيف بالبخار بنجران — خدمة متخصصة تراعي الظروف المناخية والبيئية في نجران. فريق محترف مع أدوات حديثة وضمان مكتوب.',
        shortAnswer: 'تنظيف بالبخار بنجران: خدمة احترافية بأسعار شفافة. فريق متخصص. ضمان مكتوب.',
        heroSubtitle: 'تنظيف بالبخار بنجران. خدمة احترافية. ضمان.',
    },
    ...
    faq: [
        { question: 'كم تكلفة تنظيف بالبخار بنجران؟', answer: 'تبدأ الأسعار من 150 ريال وتختلف حسب المساحة ونوع الخدمة. اطلب عرض سعر مجاني.' },
