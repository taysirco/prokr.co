// ══════════════════════════════════════════════════════════════
// تنظيف خزانات بنجران — Override مخصص (E-E-A-T Grade)
// صفحة: /najran/tanks-cleaning
// ══════════════════════════════════════════════════════════════
...
export const override: PageOverride = {
    meta: {
        title: 'تنظيف خزانات بنجران — خدمة احترافية معتمدة (2026)',
        description: 'تنظيف خزانات بنجران. خدمة احترافية. فريق متخصص. ضمان مكتوب. أسعار شفافة. خدمة سريعة.',
        h1: 'تنظيف خزانات بنجران — خدمة احترافية معتمدة مع ضمان',
        keywords: ['تنظيف خزانات بنجران', 'تنظيف خزانات نجران', 'شركة تنظيف خزانات بنجران', 'أفضل تنظيف خزانات بنجران'],
    },

    content: {
        introduction: 'تنظيف خزانات بنجران — خدمة متخصصة تراعي الظروف المناخية والبيئية في نجران. فريق محترف مع أدوات حديثة وضمان مكتوب.',
        shortAnswer: 'تنظيف خزانات بنجران: خدمة احترافية بأسعار شفافة. فريق متخصص. ضمان مكتوب.',
        heroSubtitle: 'تنظيف خزانات بنجران. خدمة احترافية. ضمان.',
    },
    ...
    faq: [
        { question: 'كم تكلفة تنظيف خزانات بنجران؟', answer: 'تبدأ الأسعار من 150 ريال وتختلف حسب المساحة ونوع الخدمة. اطلب عرض سعر مجاني.' },
