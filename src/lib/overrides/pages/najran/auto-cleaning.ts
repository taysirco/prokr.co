// ══════════════════════════════════════════════════════════════
// تنظيف سيارات بنجران — Override مخصص (E-E-A-T Grade)
// صفحة: /najran/auto-cleaning
// ══════════════════════════════════════════════════════════════
...
export const override: PageOverride = {
    meta: {
        title: 'تنظيف سيارات بنجران — خدمة احترافية معتمدة (2026)',
        description: 'تنظيف سيارات بنجران. خدمة احترافية. فريق متخصص. ضمان مكتوب. أسعار شفافة. خدمة سريعة.',
        h1: 'تنظيف سيارات بنجران — خدمة احترافية معتمدة مع ضمان',
        keywords: ['تنظيف سيارات بنجران', 'تنظيف سيارات نجران', 'شركة تنظيف سيارات بنجران', 'أفضل تنظيف سيارات بنجران'],
    },

    content: {
        introduction: 'تنظيف سيارات بنجران — خدمة متخصصة تراعي الظروف المناخية والبيئية في نجران. فريق محترف مع أدوات حديثة وضمان مكتوب.',
        shortAnswer: 'تنظيف سيارات بنجران: خدمة احترافية بأسعار شفافة. فريق متخصص. ضمان مكتوب.',
        heroSubtitle: 'تنظيف سيارات بنجران. خدمة احترافية. ضمان.',
    },
    ...
    faq: [
        { question: 'كم تكلفة تنظيف سيارات بنجران؟', answer: 'تبدأ الأسعار من 150 ريال وتختلف حسب المساحة ونوع الخدمة. اطلب عرض سعر مجاني.' },
