// ══════════════════════════════════════════════════════════════
// تنظيف واجهات زجاجية بنجران — Override مخصص (E-E-A-T Grade)
// صفحة: /najran/glass-facades-cleaning
// ══════════════════════════════════════════════════════════════
...
export const override: PageOverride = {
    meta: {
        title: 'تنظيف واجهات زجاجية بنجران — خدمة احترافية معتمدة (2026)',
        description: 'تنظيف واجهات زجاجية بنجران. خدمة احترافية. فريق متخصص. ضمان مكتوب. أسعار شفافة. خدمة سريعة.',
        h1: 'تنظيف واجهات زجاجية بنجران — خدمة احترافية معتمدة مع ضمان',
        keywords: ['تنظيف واجهات زجاجية بنجران', 'تنظيف واجهات زجاجية نجران', 'شركة تنظيف واجهات زجاجية بنجران', 'أفضل تنظيف واجهات زجاجية بنجران'],
    },

    content: {
        introduction: 'تنظيف واجهات زجاجية بنجران — خدمة متخصصة تراعي الظروف المناخية والبيئية في نجران. فريق محترف مع أدوات حديثة وضمان مكتوب.',
        shortAnswer: 'تنظيف واجهات زجاجية بنجران: خدمة احترافية بأسعار شفافة. فريق متخصص. ضمان مكتوب.',
        heroSubtitle: 'تنظيف واجهات زجاجية بنجران. خدمة احترافية. ضمان.',
    },
    ...
    faq: [
        { question: 'كم تكلفة تنظيف واجهات زجاجية بنجران؟', answer: 'تبدأ الأسعار من 150 ريال وتختلف حسب المساحة ونوع الخدمة. اطلب عرض سعر مجاني.' },
