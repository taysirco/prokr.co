// ══════════════════════════════════════════════════════════════
// عزل مائي بنجران — Override مخصص (E-E-A-T Grade)
// صفحة: /najran/water-insulation
// ══════════════════════════════════════════════════════════════
...
export const override: PageOverride = {
    meta: {
        title: 'عزل مائي بنجران — خدمة احترافية معتمدة (2026)',
        description: 'عزل مائي بنجران. خدمة احترافية. فريق متخصص. ضمان مكتوب. أسعار شفافة. خدمة سريعة.',
        h1: 'عزل مائي بنجران — خدمة احترافية معتمدة مع ضمان',
        keywords: ['عزل مائي بنجران', 'عزل مائي نجران', 'شركة عزل مائي بنجران', 'أفضل عزل مائي بنجران'],
    },

    content: {
        introduction: 'عزل مائي بنجران — خدمة متخصصة تراعي الظروف المناخية والبيئية في نجران. فريق محترف مع أدوات حديثة وضمان مكتوب.',
        shortAnswer: 'عزل مائي بنجران: خدمة احترافية بأسعار شفافة. فريق متخصص. ضمان مكتوب.',
        heroSubtitle: 'عزل مائي بنجران. خدمة احترافية. ضمان.',
    },
    ...
    faq: [
        { question: 'كم تكلفة عزل مائي بنجران؟', answer: 'تبدأ الأسعار من 150 ريال وتختلف حسب المساحة ونوع الخدمة. اطلب عرض سعر مجاني.' },
