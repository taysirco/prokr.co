// ══════════════════════════════════════════════════════════════
// مكافحة نمل أبيض بنجران — Override مخصص (E-E-A-T Grade)
// صفحة: /najran/termite-control
// ══════════════════════════════════════════════════════════════
...
export const override: PageOverride = {
    meta: {
        title: 'مكافحة نمل أبيض بنجران — خدمة احترافية معتمدة (2026)',
        description: 'مكافحة نمل أبيض بنجران. خدمة احترافية. فريق متخصص. ضمان مكتوب. أسعار شفافة. خدمة سريعة.',
        h1: 'مكافحة نمل أبيض بنجران — خدمة احترافية معتمدة مع ضمان',
        keywords: ['مكافحة نمل أبيض بنجران', 'مكافحة نمل أبيض نجران', 'شركة مكافحة نمل أبيض بنجران', 'أفضل مكافحة نمل أبيض بنجران'],
    },

    content: {
        introduction: 'مكافحة نمل أبيض بنجران — خدمة متخصصة تراعي الظروف المناخية والبيئية في نجران. فريق محترف مع أدوات حديثة وضمان مكتوب.',
        shortAnswer: 'مكافحة نمل أبيض بنجران: خدمة احترافية بأسعار شفافة. فريق متخصص. ضمان مكتوب.',
        heroSubtitle: 'مكافحة نمل أبيض بنجران. خدمة احترافية. ضمان.',
    },
    ...
    faq: [
        { question: 'كم تكلفة مكافحة نمل أبيض بنجران؟', answer: 'تبدأ الأسعار من 150 ريال وتختلف حسب المساحة ونوع الخدمة. اطلب عرض سعر مجاني.' },
