// ══════════════════════════════════════════════════════════════
// نقل عفش خروج بنجران — Override مخصص (E-E-A-T Grade)
// صفحة: /najran/moving-out
// ══════════════════════════════════════════════════════════════
...
export const override: PageOverride = {
    meta: {
        title: 'نقل عفش خروج بنجران — خدمة احترافية معتمدة (2026)',
        description: 'نقل عفش خروج بنجران. خدمة احترافية. فريق متخصص. ضمان مكتوب. أسعار شفافة. خدمة سريعة.',
        h1: 'نقل عفش خروج بنجران — خدمة احترافية معتمدة مع ضمان',
        keywords: ['نقل عفش خروج بنجران', 'نقل عفش خروج نجران', 'شركة نقل عفش خروج بنجران', 'أفضل نقل عفش خروج بنجران'],
    },

    content: {
        introduction: 'نقل عفش خروج بنجران — خدمة متخصصة تراعي الظروف المناخية والبيئية في نجران. فريق محترف مع أدوات حديثة وضمان مكتوب.',
        shortAnswer: 'نقل عفش خروج بنجران: خدمة احترافية بأسعار شفافة. فريق متخصص. ضمان مكتوب.',
        heroSubtitle: 'نقل عفش خروج بنجران. خدمة احترافية. ضمان.',
    },
    ...
    faq: [
        { question: 'كم تكلفة نقل عفش خروج بنجران؟', answer: 'تبدأ الأسعار من 150 ريال وتختلف حسب المساحة ونوع الخدمة. اطلب عرض سعر مجاني.' },
