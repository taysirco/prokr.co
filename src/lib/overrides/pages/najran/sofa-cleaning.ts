// ══════════════════════════════════════════════════════════════
// تنظيف كنب بنجران — Override مخصص (E-E-A-T Grade)
// صفحة: /najran/sofa-cleaning
// ══════════════════════════════════════════════════════════════
...
export const override: PageOverride = {
    meta: {
        title: 'تنظيف كنب بنجران — خدمة احترافية معتمدة (2026)',
        description: 'تنظيف كنب بنجران. خدمة احترافية. فريق متخصص. ضمان مكتوب. أسعار شفافة. خدمة سريعة.',
        h1: 'تنظيف كنب بنجران — خدمة احترافية معتمدة مع ضمان',
        keywords: ['تنظيف كنب بنجران', 'تنظيف كنب نجران', 'شركة تنظيف كنب بنجران', 'أفضل تنظيف كنب بنجران'],
    },

    content: {
        introduction: 'تنظيف كنب بنجران — خدمة متخصصة تراعي الظروف المناخية والبيئية في نجران. فريق محترف مع أدوات حديثة وضمان مكتوب.',
        shortAnswer: 'تنظيف كنب بنجران: خدمة احترافية بأسعار شفافة. فريق متخصص. ضمان مكتوب.',
        heroSubtitle: 'تنظيف كنب بنجران. خدمة احترافية. ضمان.',
    },
    ...
    faq: [
        { question: 'كم تكلفة تنظيف كنب بنجران؟', answer: 'تبدأ الأسعار من 150 ريال وتختلف حسب المساحة ونوع الخدمة. اطلب عرض سعر مجاني.' },
