// ══════════════════════════════════════════════════════════════
// تنظيف منازل بينبع — Override مخصص (E-E-A-T Grade)
// صفحة: /yanbu/cleaning
// ══════════════════════════════════════════════════════════════
...
export const override: PageOverride = {
    meta: {
        title: 'تنظيف منازل بينبع — خدمة احترافية معتمدة (2026)',
        description: 'تنظيف منازل بينبع. خدمة احترافية. فريق متخصص. ضمان مكتوب. أسعار شفافة. خدمة سريعة.',
        h1: 'تنظيف منازل بينبع — خدمة احترافية معتمدة مع ضمان',
        keywords: ['تنظيف منازل بينبع', 'تنظيف منازل ينبع', 'شركة تنظيف منازل بينبع', 'أفضل تنظيف منازل بينبع'],
    },

    content: {
        introduction: 'تنظيف منازل بينبع — خدمة متخصصة تراعي الظروف المناخية والبيئية في ينبع. فريق محترف مع أدوات حديثة وضمان مكتوب.',
        shortAnswer: 'تنظيف منازل بينبع: خدمة احترافية بأسعار شفافة. فريق متخصص. ضمان مكتوب.',
        heroSubtitle: 'تنظيف منازل بينبع. خدمة احترافية. ضمان.',
    },
    ...
    faq: [
        { question: 'كم تكلفة تنظيف منازل بينبع؟', answer: 'تبدأ الأسعار من 150 ريال وتختلف حسب المساحة ونوع الخدمة. اطلب عرض سعر مجاني.' },
