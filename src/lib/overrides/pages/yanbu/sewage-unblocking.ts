// ══════════════════════════════════════════════════════════════
// تسليك مجاري بينبع — Override مخصص (E-E-A-T Grade)
// صفحة: /yanbu/sewage-unblocking
// ══════════════════════════════════════════════════════════════
...
export const override: PageOverride = {
    meta: {
        title: 'تسليك مجاري بينبع — خدمة احترافية معتمدة (2026)',
        description: 'تسليك مجاري بينبع. خدمة احترافية. فريق متخصص. ضمان مكتوب. أسعار شفافة. خدمة سريعة.',
        h1: 'تسليك مجاري بينبع — خدمة احترافية معتمدة مع ضمان',
        keywords: ['تسليك مجاري بينبع', 'تسليك مجاري ينبع', 'شركة تسليك مجاري بينبع', 'أفضل تسليك مجاري بينبع'],
    },

    content: {
        introduction: 'تسليك مجاري بينبع — خدمة متخصصة تراعي الظروف المناخية والبيئية في ينبع. فريق محترف مع أدوات حديثة وضمان مكتوب.',
        shortAnswer: 'تسليك مجاري بينبع: خدمة احترافية بأسعار شفافة. فريق متخصص. ضمان مكتوب.',
        heroSubtitle: 'تسليك مجاري بينبع. خدمة احترافية. ضمان.',
    },
    ...
    faq: [
        { question: 'كم تكلفة تسليك مجاري بينبع؟', answer: 'تبدأ الأسعار من 150 ريال وتختلف حسب المساحة ونوع الخدمة. اطلب عرض سعر مجاني.' },
