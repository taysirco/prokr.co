// ══════════════════════════════════════════════════════════════
// جلي بلاط بينبع — Override مخصص (E-E-A-T Grade)
// صفحة: /yanbu/floor-polishing
// ══════════════════════════════════════════════════════════════
...
export const override: PageOverride = {
    meta: {
        title: 'جلي بلاط بينبع — خدمة احترافية معتمدة (2026)',
        description: 'جلي بلاط بينبع. خدمة احترافية. فريق متخصص. ضمان مكتوب. أسعار شفافة. خدمة سريعة.',
        h1: 'جلي بلاط بينبع — خدمة احترافية معتمدة مع ضمان',
        keywords: ['جلي بلاط بينبع', 'جلي بلاط ينبع', 'شركة جلي بلاط بينبع', 'أفضل جلي بلاط بينبع'],
    },

    content: {
        introduction: 'جلي بلاط بينبع — خدمة متخصصة تراعي الظروف المناخية والبيئية في ينبع. فريق محترف مع أدوات حديثة وضمان مكتوب.',
        shortAnswer: 'جلي بلاط بينبع: خدمة احترافية بأسعار شفافة. فريق متخصص. ضمان مكتوب.',
        heroSubtitle: 'جلي بلاط بينبع. خدمة احترافية. ضمان.',
    },
    ...
    faq: [
        { question: 'كم تكلفة جلي بلاط بينبع؟', answer: 'تبدأ الأسعار من 150 ريال وتختلف حسب المساحة ونوع الخدمة. اطلب عرض سعر مجاني.' },
