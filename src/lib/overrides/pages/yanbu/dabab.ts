// ══════════════════════════════════════════════════════════════
// دباب نقل بينبع — Override مخصص (E-E-A-T Grade)
// صفحة: /yanbu/dabab
// ══════════════════════════════════════════════════════════════
...
export const override: PageOverride = {
    meta: {
        title: 'دباب نقل بينبع — خدمة احترافية معتمدة (2026)',
        description: 'دباب نقل بينبع. خدمة احترافية. فريق متخصص. ضمان مكتوب. أسعار شفافة. خدمة سريعة.',
        h1: 'دباب نقل بينبع — خدمة احترافية معتمدة مع ضمان',
        keywords: ['دباب نقل بينبع', 'دباب نقل ينبع', 'شركة دباب نقل بينبع', 'أفضل دباب نقل بينبع'],
    },

    content: {
        introduction: 'دباب نقل بينبع — خدمة متخصصة تراعي الظروف المناخية والبيئية في ينبع. فريق محترف مع أدوات حديثة وضمان مكتوب.',
        shortAnswer: 'دباب نقل بينبع: خدمة احترافية بأسعار شفافة. فريق متخصص. ضمان مكتوب.',
        heroSubtitle: 'دباب نقل بينبع. خدمة احترافية. ضمان.',
    },
    ...
    faq: [
        { question: 'كم تكلفة دباب نقل بينبع؟', answer: 'تبدأ الأسعار من 150 ريال وتختلف حسب المساحة ونوع الخدمة. اطلب عرض سعر مجاني.' },
