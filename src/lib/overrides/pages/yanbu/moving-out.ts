// ══════════════════════════════════════════════════════════════
// نقل عفش خروج بينبع — Override مخصص (E-E-A-T Grade)
// صفحة: /yanbu/moving-out
// ══════════════════════════════════════════════════════════════
...
export const override: PageOverride = {
    meta: {
        title: 'نقل عفش خروج بينبع — خدمة احترافية معتمدة (2026)',
        description: 'نقل عفش خروج بينبع. خدمة احترافية. فريق متخصص. ضمان مكتوب. أسعار شفافة. خدمة سريعة.',
        h1: 'نقل عفش خروج بينبع — خدمة احترافية معتمدة مع ضمان',
        keywords: ['نقل عفش خروج بينبع', 'نقل عفش خروج ينبع', 'شركة نقل عفش خروج بينبع', 'أفضل نقل عفش خروج بينبع'],
    },

    content: {
        introduction: 'نقل عفش خروج بينبع — خدمة متخصصة تراعي الظروف المناخية والبيئية في ينبع. فريق محترف مع أدوات حديثة وضمان مكتوب.',
        shortAnswer: 'نقل عفش خروج بينبع: خدمة احترافية بأسعار شفافة. فريق متخصص. ضمان مكتوب.',
        heroSubtitle: 'نقل عفش خروج بينبع. خدمة احترافية. ضمان.',
    },
    ...
    faq: [
        { question: 'كم تكلفة نقل عفش خروج بينبع؟', answer: 'تبدأ الأسعار من 150 ريال وتختلف حسب المساحة ونوع الخدمة. اطلب عرض سعر مجاني.' },
