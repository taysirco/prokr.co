// ══════════════════════════════════════════════════════════════
// عزل مائي بالباحة — Override مخصص (E-E-A-T Grade)
// صفحة: /al-baha/water-insulation
// ══════════════════════════════════════════════════════════════
...
export const override: PageOverride = {
    meta: {
        title: 'عزل مائي بالباحة — خدمة احترافية معتمدة (2026)',
        description: 'عزل مائي بالباحة. خدمة احترافية. فريق متخصص. ضمان مكتوب. أسعار شفافة. خدمة سريعة.',
        h1: 'عزل مائي بالباحة — خدمة احترافية معتمدة مع ضمان',
        keywords: ['عزل مائي بالباحة', 'عزل مائي الباحة', 'شركة عزل مائي بالباحة', 'أفضل عزل مائي بالباحة'],
    },

    content: {
        introduction: 'عزل مائي بالباحة — خدمة متخصصة تراعي الظروف المناخية والبيئية في الباحة. فريق محترف مع أدوات حديثة وضمان مكتوب.',
        shortAnswer: 'عزل مائي بالباحة: خدمة احترافية بأسعار شفافة. فريق متخصص. ضمان مكتوب.',
        heroSubtitle: 'عزل مائي بالباحة. خدمة احترافية. ضمان.',
    },
    ...
    faq: [
        { question: 'كم تكلفة عزل مائي بالباحة؟', answer: 'تبدأ الأسعار من 150 ريال وتختلف حسب المساحة ونوع الخدمة. اطلب عرض سعر مجاني.' },
