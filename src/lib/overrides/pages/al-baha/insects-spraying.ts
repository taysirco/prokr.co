// ══════════════════════════════════════════════════════════════
// رش حشرات بالباحة — Override مخصص (E-E-A-T Grade)
// صفحة: /al-baha/insects-spraying
// ══════════════════════════════════════════════════════════════
...
export const override: PageOverride = {
    meta: {
        title: 'رش حشرات بالباحة — خدمة احترافية معتمدة (2026)',
        description: 'رش حشرات بالباحة. خدمة احترافية. فريق متخصص. ضمان مكتوب. أسعار شفافة. خدمة سريعة.',
        h1: 'رش حشرات بالباحة — خدمة احترافية معتمدة مع ضمان',
        keywords: ['رش حشرات بالباحة', 'رش حشرات الباحة', 'شركة رش حشرات بالباحة', 'أفضل رش حشرات بالباحة'],
    },

    content: {
        introduction: 'رش حشرات بالباحة — خدمة متخصصة تراعي الظروف المناخية والبيئية في الباحة. فريق محترف مع أدوات حديثة وضمان مكتوب.',
        shortAnswer: 'رش حشرات بالباحة: خدمة احترافية بأسعار شفافة. فريق متخصص. ضمان مكتوب.',
        heroSubtitle: 'رش حشرات بالباحة. خدمة احترافية. ضمان.',
    },
    ...
    faq: [
        { question: 'كم تكلفة رش حشرات بالباحة؟', answer: 'تبدأ الأسعار من 150 ريال وتختلف حسب المساحة ونوع الخدمة. اطلب عرض سعر مجاني.' },
