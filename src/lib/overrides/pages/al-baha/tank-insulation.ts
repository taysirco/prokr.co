// ══════════════════════════════════════════════════════════════
// عزل خزانات بالباحة — Override مخصص (E-E-A-T Grade)
// صفحة: /al-baha/tank-insulation
// ══════════════════════════════════════════════════════════════
...
export const override: PageOverride = {
    meta: {
        title: 'عزل خزانات بالباحة — خدمة احترافية معتمدة (2026)',
        description: 'عزل خزانات بالباحة. خدمة احترافية. فريق متخصص. ضمان مكتوب. أسعار شفافة. خدمة سريعة.',
        h1: 'عزل خزانات بالباحة — خدمة احترافية معتمدة مع ضمان',
        keywords: ['عزل خزانات بالباحة', 'عزل خزانات الباحة', 'شركة عزل خزانات بالباحة', 'أفضل عزل خزانات بالباحة'],
    },

    content: {
        introduction: 'عزل خزانات بالباحة — خدمة متخصصة تراعي الظروف المناخية والبيئية في الباحة. فريق محترف مع أدوات حديثة وضمان مكتوب.',
        shortAnswer: 'عزل خزانات بالباحة: خدمة احترافية بأسعار شفافة. فريق متخصص. ضمان مكتوب.',
        heroSubtitle: 'عزل خزانات بالباحة. خدمة احترافية. ضمان.',
    },
    ...
    faq: [
        { question: 'كم تكلفة عزل خزانات بالباحة؟', answer: 'تبدأ الأسعار من 150 ريال وتختلف حسب المساحة ونوع الخدمة. اطلب عرض سعر مجاني.' },
