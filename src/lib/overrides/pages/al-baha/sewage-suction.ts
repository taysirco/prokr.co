// ══════════════════════════════════════════════════════════════
// شفط بيارات بالباحة — Override مخصص (E-E-A-T Grade)
// صفحة: /al-baha/sewage-suction
// ══════════════════════════════════════════════════════════════
...
export const override: PageOverride = {
    meta: {
        title: 'شفط بيارات بالباحة — خدمة احترافية معتمدة (2026)',
        description: 'شفط بيارات بالباحة. خدمة احترافية. فريق متخصص. ضمان مكتوب. أسعار شفافة. خدمة سريعة.',
        h1: 'شفط بيارات بالباحة — خدمة احترافية معتمدة مع ضمان',
        keywords: ['شفط بيارات بالباحة', 'شفط بيارات الباحة', 'شركة شفط بيارات بالباحة', 'أفضل شفط بيارات بالباحة'],
    },

    content: {
        introduction: 'شفط بيارات بالباحة — خدمة متخصصة تراعي الظروف المناخية والبيئية في الباحة. فريق محترف مع أدوات حديثة وضمان مكتوب.',
        shortAnswer: 'شفط بيارات بالباحة: خدمة احترافية بأسعار شفافة. فريق متخصص. ضمان مكتوب.',
        heroSubtitle: 'شفط بيارات بالباحة. خدمة احترافية. ضمان.',
    },
    ...
    faq: [
        { question: 'كم تكلفة شفط بيارات بالباحة؟', answer: 'تبدأ الأسعار من 150 ريال وتختلف حسب المساحة ونوع الخدمة. اطلب عرض سعر مجاني.' },
