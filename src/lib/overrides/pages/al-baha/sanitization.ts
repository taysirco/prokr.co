// ══════════════════════════════════════════════════════════════
// تعقيم بالباحة — Override مخصص (E-E-A-T Grade)
// صفحة: /al-baha/sanitization
// ══════════════════════════════════════════════════════════════
...
export const override: PageOverride = {
    meta: {
        title: 'تعقيم بالباحة — خدمة احترافية معتمدة (2026)',
        description: 'تعقيم بالباحة. خدمة احترافية. فريق متخصص. ضمان مكتوب. أسعار شفافة. خدمة سريعة.',
        h1: 'تعقيم بالباحة — خدمة احترافية معتمدة مع ضمان',
        keywords: ['تعقيم بالباحة', 'تعقيم الباحة', 'شركة تعقيم بالباحة', 'أفضل تعقيم بالباحة'],
    },

    content: {
        introduction: 'تعقيم بالباحة — خدمة متخصصة تراعي الظروف المناخية والبيئية في الباحة. فريق محترف مع أدوات حديثة وضمان مكتوب.',
        shortAnswer: 'تعقيم بالباحة: خدمة احترافية بأسعار شفافة. فريق متخصص. ضمان مكتوب.',
        heroSubtitle: 'تعقيم بالباحة. خدمة احترافية. ضمان.',
    },
    ...
    faq: [
        { question: 'كم تكلفة تعقيم بالباحة؟', answer: 'تبدأ الأسعار من 150 ريال وتختلف حسب المساحة ونوع الخدمة. اطلب عرض سعر مجاني.' },
