// ══════════════════════════════════════════════════════════════
// عزل أسطح بجازان — Override مخصص (E-E-A-T Grade)
// صفحة: /jazan/roof-insulation
// ══════════════════════════════════════════════════════════════
...
export const override: PageOverride = {
    meta: {
        title: 'عزل أسطح بجازان — خدمة احترافية معتمدة (2026)',
        description: 'عزل أسطح بجازان. خدمة احترافية. فريق متخصص. ضمان مكتوب. أسعار شفافة. خدمة سريعة.',
        h1: 'عزل أسطح بجازان — خدمة احترافية معتمدة مع ضمان',
        keywords: ['عزل أسطح بجازان', 'عزل أسطح جازان', 'شركة عزل أسطح بجازان', 'أفضل عزل أسطح بجازان'],
    },

    content: {
        introduction: 'عزل أسطح بجازان — خدمة متخصصة تراعي الظروف المناخية والبيئية في جازان. فريق محترف مع أدوات حديثة وضمان مكتوب.',
        shortAnswer: 'عزل أسطح بجازان: خدمة احترافية بأسعار شفافة. فريق متخصص. ضمان مكتوب.',
        heroSubtitle: 'عزل أسطح بجازان. خدمة احترافية. ضمان.',
    },
    ...
    faq: [
        { question: 'كم تكلفة عزل أسطح بجازان؟', answer: 'تبدأ الأسعار من 150 ريال وتختلف حسب المساحة ونوع الخدمة. اطلب عرض سعر مجاني.' },
