// ══════════════════════════════════════════════════════════════
// تنظيف قصور بجازان — Override مخصص (E-E-A-T Grade)
// صفحة: /jazan/palaces-cleaning
// ══════════════════════════════════════════════════════════════
...
export const override: PageOverride = {
    meta: {
        title: 'تنظيف قصور بجازان — خدمة احترافية معتمدة (2026)',
        description: 'تنظيف قصور بجازان. خدمة احترافية. فريق متخصص. ضمان مكتوب. أسعار شفافة. خدمة سريعة.',
        h1: 'تنظيف قصور بجازان — خدمة احترافية معتمدة مع ضمان',
        keywords: ['تنظيف قصور بجازان', 'تنظيف قصور جازان', 'شركة تنظيف قصور بجازان', 'أفضل تنظيف قصور بجازان'],
    },

    content: {
        introduction: 'تنظيف قصور بجازان — خدمة متخصصة تراعي الظروف المناخية والبيئية في جازان. فريق محترف مع أدوات حديثة وضمان مكتوب.',
        shortAnswer: 'تنظيف قصور بجازان: خدمة احترافية بأسعار شفافة. فريق متخصص. ضمان مكتوب.',
        heroSubtitle: 'تنظيف قصور بجازان. خدمة احترافية. ضمان.',
    },
    ...
    faq: [
        { question: 'كم تكلفة تنظيف قصور بجازان؟', answer: 'تبدأ الأسعار من 150 ريال وتختلف حسب المساحة ونوع الخدمة. اطلب عرض سعر مجاني.' },
