// ══════════════════════════════════════════════════════════════
// تنظيف محلات بجازان — Override مخصص (E-E-A-T Grade)
// صفحة: /jazan/shops-cleaning
// ══════════════════════════════════════════════════════════════
...
export const override: PageOverride = {
    meta: {
        title: 'تنظيف محلات بجازان — خدمة احترافية معتمدة (2026)',
        description: 'تنظيف محلات بجازان. خدمة احترافية. فريق متخصص. ضمان مكتوب. أسعار شفافة. خدمة سريعة.',
        h1: 'تنظيف محلات بجازان — خدمة احترافية معتمدة مع ضمان',
        keywords: ['تنظيف محلات بجازان', 'تنظيف محلات جازان', 'شركة تنظيف محلات بجازان', 'أفضل تنظيف محلات بجازان'],
    },

    content: {
        introduction: 'تنظيف محلات بجازان — خدمة متخصصة تراعي الظروف المناخية والبيئية في جازان. فريق محترف مع أدوات حديثة وضمان مكتوب.',
        shortAnswer: 'تنظيف محلات بجازان: خدمة احترافية بأسعار شفافة. فريق متخصص. ضمان مكتوب.',
        heroSubtitle: 'تنظيف محلات بجازان. خدمة احترافية. ضمان.',
    },
    ...
    faq: [
        { question: 'كم تكلفة تنظيف محلات بجازان؟', answer: 'تبدأ الأسعار من 150 ريال وتختلف حسب المساحة ونوع الخدمة. اطلب عرض سعر مجاني.' },
