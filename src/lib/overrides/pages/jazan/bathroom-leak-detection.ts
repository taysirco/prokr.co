// ══════════════════════════════════════════════════════════════
// كشف تسربات حمامات بجازان — Override مخصص (E-E-A-T Grade)
// صفحة: /jazan/bathroom-leak-detection
// ══════════════════════════════════════════════════════════════
...
export const override: PageOverride = {
    meta: {
        title: 'كشف تسربات حمامات بجازان — خدمة احترافية معتمدة (2026)',
        description: 'كشف تسربات حمامات بجازان. خدمة احترافية. فريق متخصص. ضمان مكتوب. أسعار شفافة. خدمة سريعة.',
        h1: 'كشف تسربات حمامات بجازان — خدمة احترافية معتمدة مع ضمان',
        keywords: ['كشف تسربات حمامات بجازان', 'كشف تسربات حمامات جازان', 'شركة كشف تسربات حمامات بجازان', 'أفضل كشف تسربات حمامات بجازان'],
    },

    content: {
        introduction: 'كشف تسربات حمامات بجازان — خدمة متخصصة تراعي الظروف المناخية والبيئية في جازان. فريق محترف مع أدوات حديثة وضمان مكتوب.',
        shortAnswer: 'كشف تسربات حمامات بجازان: خدمة احترافية بأسعار شفافة. فريق متخصص. ضمان مكتوب.',
        heroSubtitle: 'كشف تسربات حمامات بجازان. خدمة احترافية. ضمان.',
    },
    ...
    faq: [
        { question: 'كم تكلفة كشف تسربات حمامات بجازان؟', answer: 'تبدأ الأسعار من 150 ريال وتختلف حسب المساحة ونوع الخدمة. اطلب عرض سعر مجاني.' },
