// ══════════════════════════════════════════════════════════════
// دينا نقل بجازان — Override مخصص (E-E-A-T Grade)
// صفحة: /jazan/dyna
// ══════════════════════════════════════════════════════════════
...
export const override: PageOverride = {
    meta: {
        title: 'دينا نقل بجازان — خدمة احترافية معتمدة (2026)',
        description: 'دينا نقل بجازان. خدمة احترافية. فريق متخصص. ضمان مكتوب. أسعار شفافة. خدمة سريعة.',
        h1: 'دينا نقل بجازان — خدمة احترافية معتمدة مع ضمان',
        keywords: ['دينا نقل بجازان', 'دينا نقل جازان', 'شركة دينا نقل بجازان', 'أفضل دينا نقل بجازان'],
    },

    content: {
        introduction: 'دينا نقل بجازان — خدمة متخصصة تراعي الظروف المناخية والبيئية في جازان. فريق محترف مع أدوات حديثة وضمان مكتوب.',
        shortAnswer: 'دينا نقل بجازان: خدمة احترافية بأسعار شفافة. فريق متخصص. ضمان مكتوب.',
        heroSubtitle: 'دينا نقل بجازان. خدمة احترافية. ضمان.',
    },
    ...
    faq: [
        { question: 'كم تكلفة دينا نقل بجازان؟', answer: 'تبدأ الأسعار من 150 ريال وتختلف حسب المساحة ونوع الخدمة. اطلب عرض سعر مجاني.' },
