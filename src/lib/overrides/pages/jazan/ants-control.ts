// ══════════════════════════════════════════════════════════════
// مكافحة نمل بجازان — Override مخصص (E-E-A-T Grade)
// صفحة: /jazan/ants-control
// ══════════════════════════════════════════════════════════════
...
export const override: PageOverride = {
    meta: {
        title: 'مكافحة نمل بجازان — خدمة احترافية معتمدة (2026)',
        description: 'مكافحة نمل بجازان. خدمة احترافية. فريق متخصص. ضمان مكتوب. أسعار شفافة. خدمة سريعة.',
        h1: 'مكافحة نمل بجازان — خدمة احترافية معتمدة مع ضمان',
        keywords: ['مكافحة نمل بجازان', 'مكافحة نمل جازان', 'شركة مكافحة نمل بجازان', 'أفضل مكافحة نمل بجازان'],
    },

    content: {
        introduction: 'مكافحة نمل بجازان — خدمة متخصصة تراعي الظروف المناخية والبيئية في جازان. فريق محترف مع أدوات حديثة وضمان مكتوب.',
        shortAnswer: 'مكافحة نمل بجازان: خدمة احترافية بأسعار شفافة. فريق متخصص. ضمان مكتوب.',
        heroSubtitle: 'مكافحة نمل بجازان. خدمة احترافية. ضمان.',
    },
    ...
    faq: [
        { question: 'كم تكلفة مكافحة نمل بجازان؟', answer: 'تبدأ الأسعار من 150 ريال وتختلف حسب المساحة ونوع الخدمة. اطلب عرض سعر مجاني.' },
