...
export const override: PageOverride = {
    ...
    commonConcerns: [{ concern: 'بخاخ عادي يكفي.', solution: 'pH 9-10 لا يخترق عفن الشحوم المُركّب. pH 13 مهني = يخترق.' }],
    consumerEducation: [{ myth: 'الفرن يُنظف نفسه بالحرارة.', truth: 'الحرارة تقتل البكتيريا — لكن لا تُزيل عفن الشحوم ولا الصدأ. تنظيف مهني = كامل.' },
