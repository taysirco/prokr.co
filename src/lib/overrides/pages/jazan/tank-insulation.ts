// ══════════════════════════════════════════════════════════════
// عزل خزانات بجازان — Override مخصص (E-E-A-T Grade)
// صفحة: /jazan/tank-insulation
// ══════════════════════════════════════════════════════════════
...
export const override: PageOverride = {
    meta: {
        title: 'عزل خزانات بجازان — خدمة احترافية معتمدة (2026)',
        description: 'عزل خزانات بجازان. خدمة احترافية. فريق متخصص. ضمان مكتوب. أسعار شفافة. خدمة سريعة.',
        h1: 'عزل خزانات بجازان — خدمة احترافية معتمدة مع ضمان',
        keywords: ['عزل خزانات بجازان', 'عزل خزانات جازان', 'شركة عزل خزانات بجازان', 'أفضل عزل خزانات بجازان'],
    },

    content: {
        introduction: 'عزل خزانات بجازان — خدمة متخصصة تراعي الظروف المناخية والبيئية في جازان. فريق محترف مع أدوات حديثة وضمان مكتوب.',
        shortAnswer: 'عزل خزانات بجازان: خدمة احترافية بأسعار شفافة. فريق متخصص. ضمان مكتوب.',
        heroSubtitle: 'عزل خزانات بجازان. خدمة احترافية. ضمان.',
    },
    ...
    faq: [
        { question: 'كم تكلفة عزل خزانات بجازان؟', answer: 'تبدأ الأسعار من 150 ريال وتختلف حسب المساحة ونوع الخدمة. اطلب عرض سعر مجاني.' },
