...
export const override: PageOverride = {
    ...
    faq: [{ question: 'جازان أخطر من تبوك للنمل؟', answer: 'نعم — في تبوك: الجفاف والصقيع يبطئان النمل. في جازان: 80% = بيئة مثالية 12/12. أسرع تكاثر + أطول أنفاق + لا توقف موسمي.' },
        ...
        { question: 'كم جلسة يحتاج العلاج؟', answer: 'إصابة خفيفة: جلسة واحدة. متوسطة: 2-3 جلسات بفاصل 7-14 يوم. شديدة: 3-4 جلسات + متابعة ربع سنوية.' },
    
        { question: 'هل الرش يحتاج إخلاء المنزل؟', answer: 'إخلاء 2-4 ساعات للأطفال وكبار السن. المبيدات المعتمدة SFDA آمنة بعد الجفاف الكامل (1-2 ساعة). طيور وأسماك: أبلغ الشركة لاستخدام مبيد أخف.' },
        { question: 'كم يدوم مفعول الرش؟', answer: 'رش وقائي: 30-45 يوم. رش علاجي (إصابة نشطة): يحتاج 2-3 جلسات بفاصل 7-14 يوم. عقد ربع سنوي = أفضل حماية. في المناطق الرطبة: عمر المبيد أقصر.' },
    ],
    ...
    warnings: ['80% = بيئة مثالية = الإصابة تتوسع بسرعة. التأخير = كارثة.', 'حاجز 3+ سنوات في جازان = منتهي (التحلل البيولوجي).',
        'احذر شركات بدون ترخيص بلدي — مبيدات غير مسجلة تسبب تسمم وحساسية تنفسية حادة.',
    ],
    ...
    commonConcerns: [{ concern: 'ما شفت نمل.', solution: 'النمل تحت الأرض. 80% = أنفاق مستقرة = قد يصل دون أن تُلاحظ. Bait Stations = كشف مبكر.' }],
