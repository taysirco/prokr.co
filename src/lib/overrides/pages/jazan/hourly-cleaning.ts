// ══════════════════════════════════════════════════════════════
// تنظيف بالساعة بجازان — Override مخصص (E-E-A-T Grade)
// صفحة: /jazan/hourly-cleaning
// ══════════════════════════════════════════════════════════════
...
export const override: PageOverride = {
    meta: {
        title: 'تنظيف بالساعة بجازان — خدمة احترافية معتمدة (2026)',
        description: 'تنظيف بالساعة بجازان. خدمة احترافية. فريق متخصص. ضمان مكتوب. أسعار شفافة. خدمة سريعة.',
        h1: 'تنظيف بالساعة بجازان — خدمة احترافية معتمدة مع ضمان',
        keywords: ['تنظيف بالساعة بجازان', 'تنظيف بالساعة جازان', 'شركة تنظيف بالساعة بجازان', 'أفضل تنظيف بالساعة بجازان'],
    },

    content: {
        introduction: 'تنظيف بالساعة بجازان — خدمة متخصصة تراعي الظروف المناخية والبيئية في جازان. فريق محترف مع أدوات حديثة وضمان مكتوب.',
        shortAnswer: 'تنظيف بالساعة بجازان: خدمة احترافية بأسعار شفافة. فريق متخصص. ضمان مكتوب.',
        heroSubtitle: 'تنظيف بالساعة بجازان. خدمة احترافية. ضمان.',
    },
    ...
    faq: [
        { question: 'كم تكلفة تنظيف بالساعة بجازان؟', answer: 'تبدأ الأسعار من 150 ريال وتختلف حسب المساحة ونوع الخدمة. اطلب عرض سعر مجاني.' },
