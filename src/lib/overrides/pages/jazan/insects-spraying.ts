// ══════════════════════════════════════════════════════════════
// رش حشرات بجازان — Override مخصص (E-E-A-T Grade)
// صفحة: /jazan/insects-spraying
// ══════════════════════════════════════════════════════════════
...
export const override: PageOverride = {
    meta: {
        title: 'رش حشرات بجازان — خدمة احترافية معتمدة (2026)',
        description: 'رش حشرات بجازان. خدمة احترافية. فريق متخصص. ضمان مكتوب. أسعار شفافة. خدمة سريعة.',
        h1: 'رش حشرات بجازان — خدمة احترافية معتمدة مع ضمان',
        keywords: ['رش حشرات بجازان', 'رش حشرات جازان', 'شركة رش حشرات بجازان', 'أفضل رش حشرات بجازان'],
    },

    content: {
        introduction: 'رش حشرات بجازان — خدمة متخصصة تراعي الظروف المناخية والبيئية في جازان. فريق محترف مع أدوات حديثة وضمان مكتوب.',
        shortAnswer: 'رش حشرات بجازان: خدمة احترافية بأسعار شفافة. فريق متخصص. ضمان مكتوب.',
        heroSubtitle: 'رش حشرات بجازان. خدمة احترافية. ضمان.',
    },
    ...
    faq: [
        { question: 'كم تكلفة رش حشرات بجازان؟', answer: 'تبدأ الأسعار من 150 ريال وتختلف حسب المساحة ونوع الخدمة. اطلب عرض سعر مجاني.' },
