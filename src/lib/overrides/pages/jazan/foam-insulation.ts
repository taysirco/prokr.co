// ══════════════════════════════════════════════════════════════
// عزل فوم بجازان — Override مخصص (E-E-A-T Grade)
// صفحة: /jazan/foam-insulation
// ══════════════════════════════════════════════════════════════
...
export const override: PageOverride = {
    meta: {
        title: 'عزل فوم بجازان — خدمة احترافية معتمدة (2026)',
        description: 'عزل فوم بجازان. خدمة احترافية. فريق متخصص. ضمان مكتوب. أسعار شفافة. خدمة سريعة.',
        h1: 'عزل فوم بجازان — خدمة احترافية معتمدة مع ضمان',
        keywords: ['عزل فوم بجازان', 'عزل فوم جازان', 'شركة عزل فوم بجازان', 'أفضل عزل فوم بجازان'],
    },

    content: {
        introduction: 'عزل فوم بجازان — خدمة متخصصة تراعي الظروف المناخية والبيئية في جازان. فريق محترف مع أدوات حديثة وضمان مكتوب.',
        shortAnswer: 'عزل فوم بجازان: خدمة احترافية بأسعار شفافة. فريق متخصص. ضمان مكتوب.',
        heroSubtitle: 'عزل فوم بجازان. خدمة احترافية. ضمان.',
    },
    ...
    faq: [
        { question: 'كم تكلفة عزل فوم بجازان؟', answer: 'تبدأ الأسعار من 150 ريال وتختلف حسب المساحة ونوع الخدمة. اطلب عرض سعر مجاني.' },
