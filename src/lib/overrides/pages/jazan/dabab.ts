// ══════════════════════════════════════════════════════════════
// دباب نقل بجازان — Override مخصص (E-E-A-T Grade)
// صفحة: /jazan/dabab
// ══════════════════════════════════════════════════════════════
...
export const override: PageOverride = {
    meta: {
        title: 'دباب نقل بجازان — خدمة احترافية معتمدة (2026)',
        description: 'دباب نقل بجازان. خدمة احترافية. فريق متخصص. ضمان مكتوب. أسعار شفافة. خدمة سريعة.',
        h1: 'دباب نقل بجازان — خدمة احترافية معتمدة مع ضمان',
        keywords: ['دباب نقل بجازان', 'دباب نقل جازان', 'شركة دباب نقل بجازان', 'أفضل دباب نقل بجازان'],
    },

    content: {
        introduction: 'دباب نقل بجازان — خدمة متخصصة تراعي الظروف المناخية والبيئية في جازان. فريق محترف مع أدوات حديثة وضمان مكتوب.',
        shortAnswer: 'دباب نقل بجازان: خدمة احترافية بأسعار شفافة. فريق متخصص. ضمان مكتوب.',
        heroSubtitle: 'دباب نقل بجازان. خدمة احترافية. ضمان.',
    },
    ...
    faq: [
        { question: 'كم تكلفة دباب نقل بجازان؟', answer: 'تبدأ الأسعار من 150 ريال وتختلف حسب المساحة ونوع الخدمة. اطلب عرض سعر مجاني.' },
