// ══════════════════════════════════════════════════════════════
// تعقيم ببريدة — Override مخصص (E-E-A-T Grade)
// صفحة: /buraidah/sanitization
// ══════════════════════════════════════════════════════════════
...
export const override: PageOverride = {
    meta: {
        title: 'تعقيم ببريدة — خدمة احترافية معتمدة (2026)',
        description: 'تعقيم ببريدة. خدمة احترافية. فريق متخصص. ضمان مكتوب. أسعار شفافة. خدمة سريعة.',
        h1: 'تعقيم ببريدة — خدمة احترافية معتمدة مع ضمان',
        keywords: ['تعقيم ببريدة', 'تعقيم بريدة', 'شركة تعقيم ببريدة', 'أفضل تعقيم ببريدة'],
    },

    content: {
        introduction: 'تعقيم ببريدة — خدمة متخصصة تراعي الظروف المناخية والبيئية في بريدة. فريق محترف مع أدوات حديثة وضمان مكتوب.',
        shortAnswer: 'تعقيم ببريدة: خدمة احترافية بأسعار شفافة. فريق متخصص. ضمان مكتوب.',
        heroSubtitle: 'تعقيم ببريدة. خدمة احترافية. ضمان.',
    },
    ...
    faq: [
        { question: 'كم تكلفة تعقيم ببريدة؟', answer: 'تبدأ الأسعار من 150 ريال وتختلف حسب المساحة ونوع الخدمة. اطلب عرض سعر مجاني.' },
