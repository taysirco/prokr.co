// ══════════════════════════════════════════════════════════════
// جلي بلاط ببريدة — Override مخصص (E-E-A-T Grade)
// صفحة: /buraidah/floor-polishing
// ══════════════════════════════════════════════════════════════
...
export const override: PageOverride = {
    meta: {
        title: 'جلي بلاط ببريدة — خدمة احترافية معتمدة (2026)',
        description: 'جلي بلاط ببريدة. خدمة احترافية. فريق متخصص. ضمان مكتوب. أسعار شفافة. خدمة سريعة.',
        h1: 'جلي بلاط ببريدة — خدمة احترافية معتمدة مع ضمان',
        keywords: ['جلي بلاط ببريدة', 'جلي بلاط بريدة', 'شركة جلي بلاط ببريدة', 'أفضل جلي بلاط ببريدة'],
    },

    content: {
        introduction: 'جلي بلاط ببريدة — خدمة متخصصة تراعي الظروف المناخية والبيئية في بريدة. فريق محترف مع أدوات حديثة وضمان مكتوب.',
        shortAnswer: 'جلي بلاط ببريدة: خدمة احترافية بأسعار شفافة. فريق متخصص. ضمان مكتوب.',
        heroSubtitle: 'جلي بلاط ببريدة. خدمة احترافية. ضمان.',
    },
    ...
    faq: [
        { question: 'كم تكلفة جلي بلاط ببريدة؟', answer: 'تبدأ الأسعار من 150 ريال وتختلف حسب المساحة ونوع الخدمة. اطلب عرض سعر مجاني.' },
