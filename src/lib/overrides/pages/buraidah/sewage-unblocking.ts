// ══════════════════════════════════════════════════════════════
// تسليك مجاري ببريدة — Override مخصص (E-E-A-T Grade)
// صفحة: /buraidah/sewage-unblocking
// ══════════════════════════════════════════════════════════════
...
export const override: PageOverride = {
    meta: {
        title: 'تسليك مجاري ببريدة — خدمة احترافية معتمدة (2026)',
        description: 'تسليك مجاري ببريدة. خدمة احترافية. فريق متخصص. ضمان مكتوب. أسعار شفافة. خدمة سريعة.',
        h1: 'تسليك مجاري ببريدة — خدمة احترافية معتمدة مع ضمان',
        keywords: ['تسليك مجاري ببريدة', 'تسليك مجاري بريدة', 'شركة تسليك مجاري ببريدة', 'أفضل تسليك مجاري ببريدة'],
    },

    content: {
        introduction: 'تسليك مجاري ببريدة — خدمة متخصصة تراعي الظروف المناخية والبيئية في بريدة. فريق محترف مع أدوات حديثة وضمان مكتوب.',
        shortAnswer: 'تسليك مجاري ببريدة: خدمة احترافية بأسعار شفافة. فريق متخصص. ضمان مكتوب.',
        heroSubtitle: 'تسليك مجاري ببريدة. خدمة احترافية. ضمان.',
    },
    ...
    faq: [
        { question: 'كم تكلفة تسليك مجاري ببريدة؟', answer: 'تبدأ الأسعار من 150 ريال وتختلف حسب المساحة ونوع الخدمة. اطلب عرض سعر مجاني.' },
