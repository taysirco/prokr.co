// ══════════════════════════════════════════════════════════════
// تنظيف شقق ببريدة — Override مخصص (E-E-A-T Grade)
// صفحة: /buraidah/apartments-cleaning
// ══════════════════════════════════════════════════════════════
...
export const override: PageOverride = {
    meta: {
        title: 'تنظيف شقق ببريدة — خدمة احترافية معتمدة (2026)',
        description: 'تنظيف شقق ببريدة. خدمة احترافية. فريق متخصص. ضمان مكتوب. أسعار شفافة. خدمة سريعة.',
        h1: 'تنظيف شقق ببريدة — خدمة احترافية معتمدة مع ضمان',
        keywords: ['تنظيف شقق ببريدة', 'تنظيف شقق بريدة', 'شركة تنظيف شقق ببريدة', 'أفضل تنظيف شقق ببريدة'],
    },

    content: {
        introduction: 'تنظيف شقق ببريدة — خدمة متخصصة تراعي الظروف المناخية والبيئية في بريدة. فريق محترف مع أدوات حديثة وضمان مكتوب.',
        shortAnswer: 'تنظيف شقق ببريدة: خدمة احترافية بأسعار شفافة. فريق متخصص. ضمان مكتوب.',
        heroSubtitle: 'تنظيف شقق ببريدة. خدمة احترافية. ضمان.',
    },
    ...
    faq: [
        { question: 'كم تكلفة تنظيف شقق ببريدة؟', answer: 'تبدأ الأسعار من 150 ريال وتختلف حسب المساحة ونوع الخدمة. اطلب عرض سعر مجاني.' },
