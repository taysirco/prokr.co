// ══════════════════════════════════════════════════════════════
// رش حشرات ببريدة — Override مخصص (E-E-A-T Grade)
// صفحة: /buraidah/insects-spraying
// ══════════════════════════════════════════════════════════════
...
export const override: PageOverride = {
    meta: {
        title: 'رش حشرات ببريدة — خدمة احترافية معتمدة (2026)',
        description: 'رش حشرات ببريدة. خدمة احترافية. فريق متخصص. ضمان مكتوب. أسعار شفافة. خدمة سريعة.',
        h1: 'رش حشرات ببريدة — خدمة احترافية معتمدة مع ضمان',
        keywords: ['رش حشرات ببريدة', 'رش حشرات بريدة', 'شركة رش حشرات ببريدة', 'أفضل رش حشرات ببريدة'],
    },

    content: {
        introduction: 'رش حشرات ببريدة — خدمة متخصصة تراعي الظروف المناخية والبيئية في بريدة. فريق محترف مع أدوات حديثة وضمان مكتوب.',
        shortAnswer: 'رش حشرات ببريدة: خدمة احترافية بأسعار شفافة. فريق متخصص. ضمان مكتوب.',
        heroSubtitle: 'رش حشرات ببريدة. خدمة احترافية. ضمان.',
    },
    ...
    faq: [
        { question: 'كم تكلفة رش حشرات ببريدة؟', answer: 'تبدأ الأسعار من 150 ريال وتختلف حسب المساحة ونوع الخدمة. اطلب عرض سعر مجاني.' },
