// ══════════════════════════════════════════════════════════════
// دباب نقل بالاحساء — Override مخصص (E-E-A-T Grade)
// صفحة: /al-ahsa/dabab
// ══════════════════════════════════════════════════════════════
...
export const override: PageOverride = {
    meta: {
        title: 'دباب نقل بالاحساء — خدمة احترافية معتمدة (2026)',
        description: 'دباب نقل بالاحساء. خدمة احترافية. فريق متخصص. ضمان مكتوب. أسعار شفافة. خدمة سريعة.',
        h1: 'دباب نقل بالاحساء — خدمة احترافية معتمدة مع ضمان',
        keywords: ['دباب نقل بالاحساء', 'دباب نقل الاحساء', 'شركة دباب نقل بالاحساء', 'أفضل دباب نقل بالاحساء'],
    },

    content: {
        introduction: 'دباب نقل بالاحساء — خدمة متخصصة تراعي الظروف المناخية والبيئية في الاحساء. فريق محترف مع أدوات حديثة وضمان مكتوب.',
        shortAnswer: 'دباب نقل بالاحساء: خدمة احترافية بأسعار شفافة. فريق متخصص. ضمان مكتوب.',
        heroSubtitle: 'دباب نقل بالاحساء. خدمة احترافية. ضمان.',
    },
    ...
    faq: [
        { question: 'كم تكلفة دباب نقل بالاحساء؟', answer: 'تبدأ الأسعار من 150 ريال وتختلف حسب المساحة ونوع الخدمة. اطلب عرض سعر مجاني.' },
