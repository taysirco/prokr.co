...
export const override: PageOverride = {
    ...
    commonConcerns: [
        { concern: 'CaSO₄ ميزة — ما يصدّئ.', solution: 'لا يُصدّئ = صحيح (ميزة!). لكن يترسب Scale = خشونة + بكتيريا + مضخة أقصر عمراً. مشكلة مختلفة — ليست أقل.' },
        { concern: 'مسبح مُغطى — ما يحتاج.', solution: 'غطاء يُقلل لقاح + تبخر (ممتاز!). لكن: CaSO₄ من الماء نفسه. + البعوض يبيض حتى تحت غطاء مفتوح. 2 من 4 تحتاج صيانة.' },
    ],
    consumerEducation: [
