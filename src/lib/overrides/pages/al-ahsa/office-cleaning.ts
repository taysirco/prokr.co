...
export const override: PageOverride = {
    ...
    commonConcerns: [
        { concern: 'الأجهزة حديثة — تتحمل.', solution: 'الفلتر يسد — حديث أو قديم. Throttling يحدث لأي معالج. 15-25% أبطأ = ساعات ضائعة يومياً.' },
        { concern: 'عاملة المبنى تكفي.', solution: 'عاملة المبنى = ممسحة + ماء أحساء. CaSO₄ على الشاشات + لقاح يُفرش + تربة تنتقل. 3 أخطاء في كل زيارة.' },
    ],
    consumerEducation: [
