// ══════════════════════════════════════════════════════════════
// مكافحة صراصير بالاحساء — Override مخصص (E-E-A-T Grade)
// صفحة: /al-ahsa/cockroach-control
// ══════════════════════════════════════════════════════════════
...
export const override: PageOverride = {
    meta: {
        title: 'مكافحة صراصير بالاحساء — خدمة احترافية معتمدة (2026)',
        description: 'مكافحة صراصير بالاحساء. خدمة احترافية. فريق متخصص. ضمان مكتوب. أسعار شفافة. خدمة سريعة.',
        h1: 'مكافحة صراصير بالاحساء — خدمة احترافية معتمدة مع ضمان',
        keywords: ['مكافحة صراصير بالاحساء', 'مكافحة صراصير الاحساء', 'شركة مكافحة صراصير بالاحساء', 'أفضل مكافحة صراصير بالاحساء'],
    },

    content: {
        introduction: 'مكافحة صراصير بالاحساء — خدمة متخصصة تراعي الظروف المناخية والبيئية في الاحساء. فريق محترف مع أدوات حديثة وضمان مكتوب.',
        shortAnswer: 'مكافحة صراصير بالاحساء: خدمة احترافية بأسعار شفافة. فريق متخصص. ضمان مكتوب.',
        heroSubtitle: 'مكافحة صراصير بالاحساء. خدمة احترافية. ضمان.',
    },
    ...
    faq: [
        { question: 'كم تكلفة مكافحة صراصير بالاحساء؟', answer: 'تبدأ الأسعار من 150 ريال وتختلف حسب المساحة ونوع الخدمة. اطلب عرض سعر مجاني.' },
