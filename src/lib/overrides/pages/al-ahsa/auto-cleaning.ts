// ══════════════════════════════════════════════════════════════
// تنظيف سيارات بالاحساء — Override مخصص (E-E-A-T Grade)
// صفحة: /al-ahsa/auto-cleaning
// ══════════════════════════════════════════════════════════════
...
export const override: PageOverride = {
    meta: {
        title: 'تنظيف سيارات بالاحساء — خدمة احترافية معتمدة (2026)',
        description: 'تنظيف سيارات بالاحساء. خدمة احترافية. فريق متخصص. ضمان مكتوب. أسعار شفافة. خدمة سريعة.',
        h1: 'تنظيف سيارات بالاحساء — خدمة احترافية معتمدة مع ضمان',
        keywords: ['تنظيف سيارات بالاحساء', 'تنظيف سيارات الاحساء', 'شركة تنظيف سيارات بالاحساء', 'أفضل تنظيف سيارات بالاحساء'],
    },

    content: {
        introduction: 'تنظيف سيارات بالاحساء — خدمة متخصصة تراعي الظروف المناخية والبيئية في الاحساء. فريق محترف مع أدوات حديثة وضمان مكتوب.',
        shortAnswer: 'تنظيف سيارات بالاحساء: خدمة احترافية بأسعار شفافة. فريق متخصص. ضمان مكتوب.',
        heroSubtitle: 'تنظيف سيارات بالاحساء. خدمة احترافية. ضمان.',
    },
    ...
    faq: [
        { question: 'كم تكلفة تنظيف سيارات بالاحساء؟', answer: 'تبدأ الأسعار من 150 ريال وتختلف حسب المساحة ونوع الخدمة. اطلب عرض سعر مجاني.' },
