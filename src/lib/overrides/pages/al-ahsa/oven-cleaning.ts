// ══════════════════════════════════════════════════════════════
// تنظيف أفران بالاحساء — Override مخصص (E-E-A-T Grade)
// صفحة: /al-ahsa/oven-cleaning
// ══════════════════════════════════════════════════════════════
...
export const override: PageOverride = {
    meta: {
        title: 'تنظيف أفران بالاحساء — خدمة احترافية معتمدة (2026)',
        description: 'تنظيف أفران بالاحساء. خدمة احترافية. فريق متخصص. ضمان مكتوب. أسعار شفافة. خدمة سريعة.',
        h1: 'تنظيف أفران بالاحساء — خدمة احترافية معتمدة مع ضمان',
        keywords: ['تنظيف أفران بالاحساء', 'تنظيف أفران الاحساء', 'شركة تنظيف أفران بالاحساء', 'أفضل تنظيف أفران بالاحساء'],
    },

    content: {
        introduction: 'تنظيف أفران بالاحساء — خدمة متخصصة تراعي الظروف المناخية والبيئية في الاحساء. فريق محترف مع أدوات حديثة وضمان مكتوب.',
        shortAnswer: 'تنظيف أفران بالاحساء: خدمة احترافية بأسعار شفافة. فريق متخصص. ضمان مكتوب.',
        heroSubtitle: 'تنظيف أفران بالاحساء. خدمة احترافية. ضمان.',
    },
    ...
    faq: [
        { question: 'كم تكلفة تنظيف أفران بالاحساء؟', answer: 'تبدأ الأسعار من 150 ريال وتختلف حسب المساحة ونوع الخدمة. اطلب عرض سعر مجاني.' },
