// ══════════════════════════════════════════════════════════════
// تنظيف مكيفات بالاحساء — Override مخصص (E-E-A-T Grade)
// صفحة: /al-ahsa/air-conditioner-cleaning
// ══════════════════════════════════════════════════════════════
...
export const override: PageOverride = {
    meta: {
        title: 'تنظيف مكيفات بالاحساء — خدمة احترافية معتمدة (2026)',
        description: 'تنظيف مكيفات بالاحساء. خدمة احترافية. فريق متخصص. ضمان مكتوب. أسعار شفافة. خدمة سريعة.',
        h1: 'تنظيف مكيفات بالاحساء — خدمة احترافية معتمدة مع ضمان',
        keywords: ['تنظيف مكيفات بالاحساء', 'تنظيف مكيفات الاحساء', 'شركة تنظيف مكيفات بالاحساء', 'أفضل تنظيف مكيفات بالاحساء'],
    },

    content: {
        introduction: 'تنظيف مكيفات بالاحساء — خدمة متخصصة تراعي الظروف المناخية والبيئية في الاحساء. فريق محترف مع أدوات حديثة وضمان مكتوب.',
        shortAnswer: 'تنظيف مكيفات بالاحساء: خدمة احترافية بأسعار شفافة. فريق متخصص. ضمان مكتوب.',
        heroSubtitle: 'تنظيف مكيفات بالاحساء. خدمة احترافية. ضمان.',
    },
    ...
    faq: [
        { question: 'كم تكلفة تنظيف مكيفات بالاحساء؟', answer: 'تبدأ الأسعار من 150 ريال وتختلف حسب المساحة ونوع الخدمة. اطلب عرض سعر مجاني.' },
