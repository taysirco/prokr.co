...
export const override: PageOverride = {
    ...
    commonConcerns: [
        { concern: 'Winterization غالي (500-1,200 ريال).', solution: 'أنبوب مُنفجر: 300-1,500 ريال. مضخة: 1,000-3,000 ريال. بلاط Frost Spalling: 2,000-10,000 ريال. ليلة واحدة -2°م = 2,000-15,000 ريال. Winterization = 5-10% من ضرر محتمل.' },
        { concern: '6 أشهر فقط موسم — ما يستاهل مسبح.', solution: '6 أشهر كافية (مايو-أكتوبر). + Winterization يحمي الاستثمار. المسبح = 50,000-200,000 ريال. الصيانة = 2,000-4,000 ريال/سنة = 1-2% من الاستثمار.' },
    ],
    consumerEducation: [
