// ══════════════════════════════════════════════════════════════
// تنظيف مداخن مطاعم بتبوك — Override مخصص (E-E-A-T Grade)
// صفحة: /tabuk/restaurant-chimney-cleaning
// ══════════════════════════════════════════════════════════════
...
export const override: PageOverride = {
    meta: {
        title: 'تنظيف مداخن مطاعم بتبوك — خدمة احترافية معتمدة (2026)',
        description: 'تنظيف مداخن مطاعم بتبوك. خدمة احترافية. فريق متخصص. ضمان مكتوب. أسعار شفافة. خدمة سريعة.',
        h1: 'تنظيف مداخن مطاعم بتبوك — خدمة احترافية معتمدة مع ضمان',
        keywords: ['تنظيف مداخن مطاعم بتبوك', 'تنظيف مداخن مطاعم تبوك', 'شركة تنظيف مداخن مطاعم بتبوك', 'أفضل تنظيف مداخن مطاعم بتبوك'],
    },

    content: {
        introduction: 'تنظيف مداخن مطاعم بتبوك — خدمة متخصصة تراعي الظروف المناخية والبيئية في تبوك. فريق محترف مع أدوات حديثة وضمان مكتوب.',
        shortAnswer: 'تنظيف مداخن مطاعم بتبوك: خدمة احترافية بأسعار شفافة. فريق متخصص. ضمان مكتوب.',
        heroSubtitle: 'تنظيف مداخن مطاعم بتبوك. خدمة احترافية. ضمان.',
    },
    ...
    faq: [
        { question: 'كم تكلفة تنظيف مداخن مطاعم بتبوك؟', answer: 'تبدأ الأسعار من 150 ريال وتختلف حسب المساحة ونوع الخدمة. اطلب عرض سعر مجاني.' },
