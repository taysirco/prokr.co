// ══════════════════════════════════════════════════════════════
// رش حشرات بتبوك — Override مخصص (E-E-A-T Grade)
// صفحة: /tabuk/insects-spraying
// ══════════════════════════════════════════════════════════════
...
export const override: PageOverride = {
    meta: {
        title: 'رش حشرات بتبوك — خدمة احترافية معتمدة (2026)',
        description: 'رش حشرات بتبوك. خدمة احترافية. فريق متخصص. ضمان مكتوب. أسعار شفافة. خدمة سريعة.',
        h1: 'رش حشرات بتبوك — خدمة احترافية معتمدة مع ضمان',
        keywords: ['رش حشرات بتبوك', 'رش حشرات تبوك', 'شركة رش حشرات بتبوك', 'أفضل رش حشرات بتبوك'],
    },

    content: {
        introduction: 'رش حشرات بتبوك — خدمة متخصصة تراعي الظروف المناخية والبيئية في تبوك. فريق محترف مع أدوات حديثة وضمان مكتوب.',
        shortAnswer: 'رش حشرات بتبوك: خدمة احترافية بأسعار شفافة. فريق متخصص. ضمان مكتوب.',
        heroSubtitle: 'رش حشرات بتبوك. خدمة احترافية. ضمان.',
    },
    ...
    faq: [
        { question: 'كم تكلفة رش حشرات بتبوك؟', answer: 'تبدأ الأسعار من 150 ريال وتختلف حسب المساحة ونوع الخدمة. اطلب عرض سعر مجاني.' },
