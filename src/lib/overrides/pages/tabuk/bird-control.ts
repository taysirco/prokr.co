// ══════════════════════════════════════════════════════════════
// مكافحة حمام بتبوك — Override مخصص (E-E-A-T Grade)
// صفحة: /tabuk/bird-control
// ══════════════════════════════════════════════════════════════
...
export const override: PageOverride = {
    meta: {
        title: 'مكافحة حمام بتبوك — خدمة احترافية معتمدة (2026)',
        description: 'مكافحة حمام بتبوك. خدمة احترافية. فريق متخصص. ضمان مكتوب. أسعار شفافة. خدمة سريعة.',
        h1: 'مكافحة حمام بتبوك — خدمة احترافية معتمدة مع ضمان',
        keywords: ['مكافحة حمام بتبوك', 'مكافحة حمام تبوك', 'شركة مكافحة حمام بتبوك', 'أفضل مكافحة حمام بتبوك'],
    },

    content: {
        introduction: 'مكافحة حمام بتبوك — خدمة متخصصة تراعي الظروف المناخية والبيئية في تبوك. فريق محترف مع أدوات حديثة وضمان مكتوب.',
        shortAnswer: 'مكافحة حمام بتبوك: خدمة احترافية بأسعار شفافة. فريق متخصص. ضمان مكتوب.',
        heroSubtitle: 'مكافحة حمام بتبوك. خدمة احترافية. ضمان.',
    },
    ...
    faq: [
        { question: 'كم تكلفة مكافحة حمام بتبوك؟', answer: 'تبدأ الأسعار من 150 ريال وتختلف حسب المساحة ونوع الخدمة. اطلب عرض سعر مجاني.' },
