// ══════════════════════════════════════════════════════════════
// تعقيم بتبوك — Override مخصص (E-E-A-T Grade)
// صفحة: /tabuk/sanitization
// ══════════════════════════════════════════════════════════════
...
export const override: PageOverride = {
    meta: {
        title: 'تعقيم بتبوك — خدمة احترافية معتمدة (2026)',
        description: 'تعقيم بتبوك. خدمة احترافية. فريق متخصص. ضمان مكتوب. أسعار شفافة. خدمة سريعة.',
        h1: 'تعقيم بتبوك — خدمة احترافية معتمدة مع ضمان',
        keywords: ['تعقيم بتبوك', 'تعقيم تبوك', 'شركة تعقيم بتبوك', 'أفضل تعقيم بتبوك'],
    },

    content: {
        introduction: 'تعقيم بتبوك — خدمة متخصصة تراعي الظروف المناخية والبيئية في تبوك. فريق محترف مع أدوات حديثة وضمان مكتوب.',
        shortAnswer: 'تعقيم بتبوك: خدمة احترافية بأسعار شفافة. فريق متخصص. ضمان مكتوب.',
        heroSubtitle: 'تعقيم بتبوك. خدمة احترافية. ضمان.',
    },
    ...
    faq: [
        { question: 'كم تكلفة تعقيم بتبوك؟', answer: 'تبدأ الأسعار من 150 ريال وتختلف حسب المساحة ونوع الخدمة. اطلب عرض سعر مجاني.' },
