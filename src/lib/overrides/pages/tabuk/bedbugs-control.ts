// ══════════════════════════════════════════════════════════════
// مكافحة بق الفراش بتبوك — Override مخصص (E-E-A-T Grade)
// صفحة: /tabuk/bedbugs-control
// ══════════════════════════════════════════════════════════════
...
export const override: PageOverride = {
    meta: {
        title: 'مكافحة بق الفراش بتبوك — خدمة احترافية معتمدة (2026)',
        description: 'مكافحة بق الفراش بتبوك. خدمة احترافية. فريق متخصص. ضمان مكتوب. أسعار شفافة. خدمة سريعة.',
        h1: 'مكافحة بق الفراش بتبوك — خدمة احترافية معتمدة مع ضمان',
        keywords: ['مكافحة بق الفراش بتبوك', 'مكافحة بق الفراش تبوك', 'شركة مكافحة بق الفراش بتبوك', 'أفضل مكافحة بق الفراش بتبوك'],
    },

    content: {
        introduction: 'مكافحة بق الفراش بتبوك — خدمة متخصصة تراعي الظروف المناخية والبيئية في تبوك. فريق محترف مع أدوات حديثة وضمان مكتوب.',
        shortAnswer: 'مكافحة بق الفراش بتبوك: خدمة احترافية بأسعار شفافة. فريق متخصص. ضمان مكتوب.',
        heroSubtitle: 'مكافحة بق الفراش بتبوك. خدمة احترافية. ضمان.',
    },
    ...
    faq: [
        { question: 'كم تكلفة مكافحة بق الفراش بتبوك؟', answer: 'تبدأ الأسعار من 150 ريال وتختلف حسب المساحة ونوع الخدمة. اطلب عرض سعر مجاني.' },
