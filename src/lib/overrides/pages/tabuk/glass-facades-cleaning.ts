// ══════════════════════════════════════════════════════════════
// تنظيف واجهات زجاجية بتبوك — Override مخصص (E-E-A-T Grade)
// صفحة: /tabuk/glass-facades-cleaning
// ══════════════════════════════════════════════════════════════
...
export const override: PageOverride = {
    meta: {
        title: 'تنظيف واجهات زجاجية بتبوك — خدمة احترافية معتمدة (2026)',
        description: 'تنظيف واجهات زجاجية بتبوك. خدمة احترافية. فريق متخصص. ضمان مكتوب. أسعار شفافة. خدمة سريعة.',
        h1: 'تنظيف واجهات زجاجية بتبوك — خدمة احترافية معتمدة مع ضمان',
        keywords: ['تنظيف واجهات زجاجية بتبوك', 'تنظيف واجهات زجاجية تبوك', 'شركة تنظيف واجهات زجاجية بتبوك', 'أفضل تنظيف واجهات زجاجية بتبوك'],
    },

    content: {
        introduction: 'تنظيف واجهات زجاجية بتبوك — خدمة متخصصة تراعي الظروف المناخية والبيئية في تبوك. فريق محترف مع أدوات حديثة وضمان مكتوب.',
        shortAnswer: 'تنظيف واجهات زجاجية بتبوك: خدمة احترافية بأسعار شفافة. فريق متخصص. ضمان مكتوب.',
        heroSubtitle: 'تنظيف واجهات زجاجية بتبوك. خدمة احترافية. ضمان.',
    },
    ...
    faq: [
        { question: 'كم تكلفة تنظيف واجهات زجاجية بتبوك؟', answer: 'تبدأ الأسعار من 150 ريال وتختلف حسب المساحة ونوع الخدمة. اطلب عرض سعر مجاني.' },
