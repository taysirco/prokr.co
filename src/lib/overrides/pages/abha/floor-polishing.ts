// ══════════════════════════════════════════════════════════════
// جلي بلاط بأبها — Override مخصص (E-E-A-T Grade)
// صفحة: /abha/floor-polishing
// ══════════════════════════════════════════════════════════════
...
export const override: PageOverride = {
    meta: {
        title: 'جلي بلاط بأبها — خدمة احترافية معتمدة (2026)',
        description: 'جلي بلاط بأبها. خدمة احترافية. فريق متخصص. ضمان مكتوب. أسعار شفافة. خدمة سريعة.',
        h1: 'جلي بلاط بأبها — خدمة احترافية معتمدة مع ضمان',
        keywords: ['جلي بلاط بأبها', 'جلي بلاط أبها', 'شركة جلي بلاط بأبها', 'أفضل جلي بلاط بأبها'],
    },

    content: {
        introduction: 'جلي بلاط بأبها — خدمة متخصصة تراعي الظروف المناخية والبيئية في أبها. فريق محترف مع أدوات حديثة وضمان مكتوب.',
        shortAnswer: 'جلي بلاط بأبها: خدمة احترافية بأسعار شفافة. فريق متخصص. ضمان مكتوب.',
        heroSubtitle: 'جلي بلاط بأبها. خدمة احترافية. ضمان.',
    },
    ...
    faq: [
        { question: 'كم تكلفة جلي بلاط بأبها؟', answer: 'تبدأ الأسعار من 150 ريال وتختلف حسب المساحة ونوع الخدمة. اطلب عرض سعر مجاني.' },
