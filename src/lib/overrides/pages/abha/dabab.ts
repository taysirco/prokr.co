// ══════════════════════════════════════════════════════════════
// دباب نقل بأبها — Override مخصص (E-E-A-T Grade)
// صفحة: /abha/dabab
// ══════════════════════════════════════════════════════════════
...
export const override: PageOverride = {
    meta: {
        title: 'دباب نقل بأبها — خدمة احترافية معتمدة (2026)',
        description: 'دباب نقل بأبها. خدمة احترافية. فريق متخصص. ضمان مكتوب. أسعار شفافة. خدمة سريعة.',
        h1: 'دباب نقل بأبها — خدمة احترافية معتمدة مع ضمان',
        keywords: ['دباب نقل بأبها', 'دباب نقل أبها', 'شركة دباب نقل بأبها', 'أفضل دباب نقل بأبها'],
    },

    content: {
        introduction: 'دباب نقل بأبها — خدمة متخصصة تراعي الظروف المناخية والبيئية في أبها. فريق محترف مع أدوات حديثة وضمان مكتوب.',
        shortAnswer: 'دباب نقل بأبها: خدمة احترافية بأسعار شفافة. فريق متخصص. ضمان مكتوب.',
        heroSubtitle: 'دباب نقل بأبها. خدمة احترافية. ضمان.',
    },
    ...
    faq: [
        { question: 'كم تكلفة دباب نقل بأبها؟', answer: 'تبدأ الأسعار من 150 ريال وتختلف حسب المساحة ونوع الخدمة. اطلب عرض سعر مجاني.' },
