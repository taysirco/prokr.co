// ══════════════════════════════════════════════════════════════
// تنظيف مكيفات بأبها — Override مخصص (E-E-A-T Grade)
// صفحة: /abha/air-conditioner-cleaning
// ══════════════════════════════════════════════════════════════
...
export const override: PageOverride = {
    meta: {
        title: 'تنظيف مكيفات بأبها — خدمة احترافية معتمدة (2026)',
        description: 'تنظيف مكيفات بأبها. خدمة احترافية. فريق متخصص. ضمان مكتوب. أسعار شفافة. خدمة سريعة.',
        h1: 'تنظيف مكيفات بأبها — خدمة احترافية معتمدة مع ضمان',
        keywords: ['تنظيف مكيفات بأبها', 'تنظيف مكيفات أبها', 'شركة تنظيف مكيفات بأبها', 'أفضل تنظيف مكيفات بأبها'],
    },

    content: {
        introduction: 'تنظيف مكيفات بأبها — خدمة متخصصة تراعي الظروف المناخية والبيئية في أبها. فريق محترف مع أدوات حديثة وضمان مكتوب.',
        shortAnswer: 'تنظيف مكيفات بأبها: خدمة احترافية بأسعار شفافة. فريق متخصص. ضمان مكتوب.',
        heroSubtitle: 'تنظيف مكيفات بأبها. خدمة احترافية. ضمان.',
    },
    ...
    faq: [
        { question: 'كم تكلفة تنظيف مكيفات بأبها؟', answer: 'تبدأ الأسعار من 150 ريال وتختلف حسب المساحة ونوع الخدمة. اطلب عرض سعر مجاني.' },
