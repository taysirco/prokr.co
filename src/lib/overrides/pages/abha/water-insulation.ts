// ══════════════════════════════════════════════════════════════
// عزل مائي بأبها — Override مخصص (E-E-A-T Grade)
// صفحة: /abha/water-insulation
// ══════════════════════════════════════════════════════════════
...
export const override: PageOverride = {
    meta: {
        title: 'عزل مائي بأبها — خدمة احترافية معتمدة (2026)',
        description: 'عزل مائي بأبها. خدمة احترافية. فريق متخصص. ضمان مكتوب. أسعار شفافة. خدمة سريعة.',
        h1: 'عزل مائي بأبها — خدمة احترافية معتمدة مع ضمان',
        keywords: ['عزل مائي بأبها', 'عزل مائي أبها', 'شركة عزل مائي بأبها', 'أفضل عزل مائي بأبها'],
    },

    content: {
        introduction: 'عزل مائي بأبها — خدمة متخصصة تراعي الظروف المناخية والبيئية في أبها. فريق محترف مع أدوات حديثة وضمان مكتوب.',
        shortAnswer: 'عزل مائي بأبها: خدمة احترافية بأسعار شفافة. فريق متخصص. ضمان مكتوب.',
        heroSubtitle: 'عزل مائي بأبها. خدمة احترافية. ضمان.',
    },
    ...
    faq: [
        { question: 'كم تكلفة عزل مائي بأبها؟', answer: 'تبدأ الأسعار من 150 ريال وتختلف حسب المساحة ونوع الخدمة. اطلب عرض سعر مجاني.' },
