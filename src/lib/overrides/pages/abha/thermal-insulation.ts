// ══════════════════════════════════════════════════════════════
// عزل حراري بأبها — Override مخصص (E-E-A-T Grade)
// صفحة: /abha/thermal-insulation
// ══════════════════════════════════════════════════════════════
...
export const override: PageOverride = {
    meta: {
        title: 'عزل حراري بأبها — خدمة احترافية معتمدة (2026)',
        description: 'عزل حراري بأبها. خدمة احترافية. فريق متخصص. ضمان مكتوب. أسعار شفافة. خدمة سريعة.',
        h1: 'عزل حراري بأبها — خدمة احترافية معتمدة مع ضمان',
        keywords: ['عزل حراري بأبها', 'عزل حراري أبها', 'شركة عزل حراري بأبها', 'أفضل عزل حراري بأبها'],
    },

    content: {
        introduction: 'عزل حراري بأبها — خدمة متخصصة تراعي الظروف المناخية والبيئية في أبها. فريق محترف مع أدوات حديثة وضمان مكتوب.',
        shortAnswer: 'عزل حراري بأبها: خدمة احترافية بأسعار شفافة. فريق متخصص. ضمان مكتوب.',
        heroSubtitle: 'عزل حراري بأبها. خدمة احترافية. ضمان.',
    },
    ...
    faq: [
        { question: 'كم تكلفة عزل حراري بأبها؟', answer: 'تبدأ الأسعار من 150 ريال وتختلف حسب المساحة ونوع الخدمة. اطلب عرض سعر مجاني.' },
