// ══════════════════════════════════════════════════════════════
// تنظيف أثاث بأبها — Override مخصص (E-E-A-T Grade)
// صفحة: /abha/furniture-cleaning
// ══════════════════════════════════════════════════════════════
...
export const override: PageOverride = {
    meta: {
        title: 'تنظيف أثاث بأبها — خدمة احترافية معتمدة (2026)',
        description: 'تنظيف أثاث بأبها. خدمة احترافية. فريق متخصص. ضمان مكتوب. أسعار شفافة. خدمة سريعة.',
        h1: 'تنظيف أثاث بأبها — خدمة احترافية معتمدة مع ضمان',
        keywords: ['تنظيف أثاث بأبها', 'تنظيف أثاث أبها', 'شركة تنظيف أثاث بأبها', 'أفضل تنظيف أثاث بأبها'],
    },

    content: {
        introduction: 'تنظيف أثاث بأبها — خدمة متخصصة تراعي الظروف المناخية والبيئية في أبها. فريق محترف مع أدوات حديثة وضمان مكتوب.',
        shortAnswer: 'تنظيف أثاث بأبها: خدمة احترافية بأسعار شفافة. فريق متخصص. ضمان مكتوب.',
        heroSubtitle: 'تنظيف أثاث بأبها. خدمة احترافية. ضمان.',
    },
    ...
    faq: [
        { question: 'كم تكلفة تنظيف أثاث بأبها؟', answer: 'تبدأ الأسعار من 150 ريال وتختلف حسب المساحة ونوع الخدمة. اطلب عرض سعر مجاني.' },
