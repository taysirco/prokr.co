// ══════════════════════════════════════════════════════════════
// مكافحة ثعابين وعقارب بأبها — Override مخصص (E-E-A-T Grade)
// صفحة: /abha/snakes-control
// ══════════════════════════════════════════════════════════════
...
export const override: PageOverride = {
    meta: {
        title: 'مكافحة ثعابين وعقارب بأبها — خدمة احترافية معتمدة (2026)',
        description: 'مكافحة ثعابين وعقارب بأبها. خدمة احترافية. فريق متخصص. ضمان مكتوب. أسعار شفافة. خدمة سريعة.',
        h1: 'مكافحة ثعابين وعقارب بأبها — خدمة احترافية معتمدة مع ضمان',
        keywords: ['مكافحة ثعابين وعقارب بأبها', 'مكافحة ثعابين وعقارب أبها', 'شركة مكافحة ثعابين وعقارب بأبها', 'أفضل مكافحة ثعابين وعقارب بأبها'],
    },

    content: {
        introduction: 'مكافحة ثعابين وعقارب بأبها — خدمة متخصصة تراعي الظروف المناخية والبيئية في أبها. فريق محترف مع أدوات حديثة وضمان مكتوب.',
        shortAnswer: 'مكافحة ثعابين وعقارب بأبها: خدمة احترافية بأسعار شفافة. فريق متخصص. ضمان مكتوب.',
        heroSubtitle: 'مكافحة ثعابين وعقارب بأبها. خدمة احترافية. ضمان.',
    },
    ...
    faq: [
        { question: 'كم تكلفة مكافحة ثعابين وعقارب بأبها؟', answer: 'تبدأ الأسعار من 150 ريال وتختلف حسب المساحة ونوع الخدمة. اطلب عرض سعر مجاني.' },
