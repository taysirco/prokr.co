// ══════════════════════════════════════════════════════════════
// كشف تسربات حمامات بأبها — Override مخصص (E-E-A-T Grade)
// صفحة: /abha/bathroom-leak-detection
// ══════════════════════════════════════════════════════════════
...
export const override: PageOverride = {
    meta: {
        title: 'كشف تسربات حمامات بأبها — خدمة احترافية معتمدة (2026)',
        description: 'كشف تسربات حمامات بأبها. خدمة احترافية. فريق متخصص. ضمان مكتوب. أسعار شفافة. خدمة سريعة.',
        h1: 'كشف تسربات حمامات بأبها — خدمة احترافية معتمدة مع ضمان',
        keywords: ['كشف تسربات حمامات بأبها', 'كشف تسربات حمامات أبها', 'شركة كشف تسربات حمامات بأبها', 'أفضل كشف تسربات حمامات بأبها'],
    },

    content: {
        introduction: 'كشف تسربات حمامات بأبها — خدمة متخصصة تراعي الظروف المناخية والبيئية في أبها. فريق محترف مع أدوات حديثة وضمان مكتوب.',
        shortAnswer: 'كشف تسربات حمامات بأبها: خدمة احترافية بأسعار شفافة. فريق متخصص. ضمان مكتوب.',
        heroSubtitle: 'كشف تسربات حمامات بأبها. خدمة احترافية. ضمان.',
    },
    ...
    faq: [
        { question: 'كم تكلفة كشف تسربات حمامات بأبها؟', answer: 'تبدأ الأسعار من 150 ريال وتختلف حسب المساحة ونوع الخدمة. اطلب عرض سعر مجاني.' },
