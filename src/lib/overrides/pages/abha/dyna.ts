// ══════════════════════════════════════════════════════════════
// دينا نقل بأبها — Override مخصص (E-E-A-T Grade)
// صفحة: /abha/dyna
// ══════════════════════════════════════════════════════════════
...
export const override: PageOverride = {
    meta: {
        title: 'دينا نقل بأبها — خدمة احترافية معتمدة (2026)',
        description: 'دينا نقل بأبها. خدمة احترافية. فريق متخصص. ضمان مكتوب. أسعار شفافة. خدمة سريعة.',
        h1: 'دينا نقل بأبها — خدمة احترافية معتمدة مع ضمان',
        keywords: ['دينا نقل بأبها', 'دينا نقل أبها', 'شركة دينا نقل بأبها', 'أفضل دينا نقل بأبها'],
    },

    content: {
        introduction: 'دينا نقل بأبها — خدمة متخصصة تراعي الظروف المناخية والبيئية في أبها. فريق محترف مع أدوات حديثة وضمان مكتوب.',
        shortAnswer: 'دينا نقل بأبها: خدمة احترافية بأسعار شفافة. فريق متخصص. ضمان مكتوب.',
        heroSubtitle: 'دينا نقل بأبها. خدمة احترافية. ضمان.',
    },
    ...
    faq: [
        { question: 'كم تكلفة دينا نقل بأبها؟', answer: 'تبدأ الأسعار من 150 ريال وتختلف حسب المساحة ونوع الخدمة. اطلب عرض سعر مجاني.' },
