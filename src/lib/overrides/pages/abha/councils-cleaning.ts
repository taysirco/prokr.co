// ══════════════════════════════════════════════════════════════
// تنظيف مجالس بأبها — Override مخصص (E-E-A-T Grade)
// صفحة: /abha/councils-cleaning
// ══════════════════════════════════════════════════════════════
...
export const override: PageOverride = {
    meta: {
        title: 'تنظيف مجالس بأبها — خدمة احترافية معتمدة (2026)',
        description: 'تنظيف مجالس بأبها. خدمة احترافية. فريق متخصص. ضمان مكتوب. أسعار شفافة. خدمة سريعة.',
        h1: 'تنظيف مجالس بأبها — خدمة احترافية معتمدة مع ضمان',
        keywords: ['تنظيف مجالس بأبها', 'تنظيف مجالس أبها', 'شركة تنظيف مجالس بأبها', 'أفضل تنظيف مجالس بأبها'],
    },

    content: {
        introduction: 'تنظيف مجالس بأبها — خدمة متخصصة تراعي الظروف المناخية والبيئية في أبها. فريق محترف مع أدوات حديثة وضمان مكتوب.',
        shortAnswer: 'تنظيف مجالس بأبها: خدمة احترافية بأسعار شفافة. فريق متخصص. ضمان مكتوب.',
        heroSubtitle: 'تنظيف مجالس بأبها. خدمة احترافية. ضمان.',
    },
    ...
    faq: [
        { question: 'كم تكلفة تنظيف مجالس بأبها؟', answer: 'تبدأ الأسعار من 150 ريال وتختلف حسب المساحة ونوع الخدمة. اطلب عرض سعر مجاني.' },
