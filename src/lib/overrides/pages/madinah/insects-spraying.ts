// ══════════════════════════════════════════════════════════════
// رش حشرات بالمدينة المنورة — Override مخصص (E-E-A-T Grade)
// صفحة: /madinah/insects-spraying
// ══════════════════════════════════════════════════════════════
...
export const override: PageOverride = {
    meta: {
        title: 'رش حشرات بالمدينة المنورة — خدمة احترافية معتمدة (2026)',
        description: 'رش حشرات بالمدينة المنورة. خدمة احترافية. فريق متخصص. ضمان مكتوب. أسعار شفافة. خدمة سريعة.',
        h1: 'رش حشرات بالمدينة المنورة — خدمة احترافية معتمدة مع ضمان',
        keywords: ['رش حشرات بالمدينة المنورة', 'رش حشرات المدينة المنورة', 'شركة رش حشرات بالمدينة المنورة', 'أفضل رش حشرات بالمدينة المنورة'],
    },

    content: {
        introduction: 'رش حشرات بالمدينة المنورة — خدمة متخصصة تراعي الظروف المناخية والبيئية في المدينة المنورة. فريق محترف مع أدوات حديثة وضمان مكتوب.',
        shortAnswer: 'رش حشرات بالمدينة المنورة: خدمة احترافية بأسعار شفافة. فريق متخصص. ضمان مكتوب.',
        heroSubtitle: 'رش حشرات بالمدينة المنورة. خدمة احترافية. ضمان.',
    },
    ...
    faq: [
        { question: 'كم تكلفة رش حشرات بالمدينة المنورة؟', answer: 'تبدأ الأسعار من 150 ريال وتختلف حسب المساحة ونوع الخدمة. اطلب عرض سعر مجاني.' },
