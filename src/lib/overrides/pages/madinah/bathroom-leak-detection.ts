// ══════════════════════════════════════════════════════════════
// كشف تسربات حمامات بالمدينة المنورة — Override مخصص (E-E-A-T Grade)
...
export const override: PageOverride = {
    meta: {
        title: 'كشف تسربات حمامات بالمدينة المنورة — خدمة احترافية معتمدة (2026)',
        description: 'كشف تسربات حمامات بالمدينة المنورة. خدمة احترافية. فريق متخصص. ضمان مكتوب. أسعار شفافة. خدمة سريعة.',
        h1: 'كشف تسربات حمامات بالمدينة المنورة — خدمة احترافية معتمدة مع ضمان',
        keywords: ['كشف تسربات حمامات بالمدينة المنورة', 'كشف تسربات حمامات المدينة المنورة', 'شركة كشف تسربات حمامات بالمدينة المنورة', 'أفضل كشف تسربات حمامات بالمدينة المنورة'],
    },

    content: {
        introduction: 'كشف تسربات حمامات بالمدينة المنورة — خدمة متخصصة تراعي الظروف المناخية والبيئية في المدينة المنورة. فريق محترف مع أدوات حديثة وضمان مكتوب.',
        shortAnswer: 'كشف تسربات حمامات بالمدينة المنورة: خدمة احترافية بأسعار شفافة. فريق متخصص. ضمان مكتوب.',
        heroSubtitle: 'كشف تسربات حمامات بالمدينة المنورة. خدمة احترافية. ضمان.',
    },
    ...
    faq: [
        { question: 'كم تكلفة كشف تسربات حمامات بالمدينة المنورة؟', answer: 'تبدأ الأسعار من 150 ريال وتختلف حسب المساحة ونوع الخدمة. اطلب عرض سعر مجاني.' },
