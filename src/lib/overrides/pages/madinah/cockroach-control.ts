// ══════════════════════════════════════════════════════════════
// مكافحة صراصير بالمدينة المنورة — Override مخصص (E-E-A-T Grade)
// صفحة: /madinah/cockroach-control
// ══════════════════════════════════════════════════════════════
...
export const override: PageOverride = {
    meta: {
        title: 'مكافحة صراصير بالمدينة المنورة — خدمة احترافية معتمدة (2026)',
        description: 'مكافحة صراصير بالمدينة المنورة. خدمة احترافية. فريق متخصص. ضمان مكتوب. أسعار شفافة. خدمة سريعة.',
        h1: 'مكافحة صراصير بالمدينة المنورة — خدمة احترافية معتمدة مع ضمان',
        keywords: ['مكافحة صراصير بالمدينة المنورة', 'مكافحة صراصير المدينة المنورة', 'شركة مكافحة صراصير بالمدينة المنورة', 'أفضل مكافحة صراصير بالمدينة المنورة'],
    },

    content: {
        introduction: 'مكافحة صراصير بالمدينة المنورة — خدمة متخصصة تراعي الظروف المناخية والبيئية في المدينة المنورة. فريق محترف مع أدوات حديثة وضمان مكتوب.',
        shortAnswer: 'مكافحة صراصير بالمدينة المنورة: خدمة احترافية بأسعار شفافة. فريق متخصص. ضمان مكتوب.',
        heroSubtitle: 'مكافحة صراصير بالمدينة المنورة. خدمة احترافية. ضمان.',
    },
    ...
    faq: [
        { question: 'كم تكلفة مكافحة صراصير بالمدينة المنورة؟', answer: 'تبدأ الأسعار من 150 ريال وتختلف حسب المساحة ونوع الخدمة. اطلب عرض سعر مجاني.' },
