// ══════════════════════════════════════════════════════════════
// عزل مائي بالمدينة المنورة — Override مخصص (E-E-A-T Grade)
...
export const override: PageOverride = {
    meta: {
        title: 'عزل مائي بالمدينة المنورة — خدمة احترافية معتمدة (2026)',
        description: 'عزل مائي بالمدينة المنورة. خدمة احترافية. فريق متخصص. ضمان مكتوب. أسعار شفافة. خدمة سريعة.',
        h1: 'عزل مائي بالمدينة المنورة — خدمة احترافية معتمدة مع ضمان',
        keywords: ['عزل مائي بالمدينة المنورة', 'عزل مائي المدينة المنورة', 'شركة عزل مائي بالمدينة المنورة', 'أفضل عزل مائي بالمدينة المنورة'],
    },

    content: {
        introduction: 'عزل مائي بالمدينة المنورة — خدمة متخصصة تراعي الظروف المناخية والبيئية في المدينة المنورة. فريق محترف مع أدوات حديثة وضمان مكتوب.',
        shortAnswer: 'عزل مائي بالمدينة المنورة: خدمة احترافية بأسعار شفافة. فريق متخصص. ضمان مكتوب.',
        heroSubtitle: 'عزل مائي بالمدينة المنورة. خدمة احترافية. ضمان.',
    },
    ...
    faq: [
        { question: 'كم تكلفة عزل مائي بالمدينة المنورة؟', answer: 'تبدأ الأسعار من 150 ريال وتختلف حسب المساحة ونوع الخدمة. اطلب عرض سعر مجاني.' },
