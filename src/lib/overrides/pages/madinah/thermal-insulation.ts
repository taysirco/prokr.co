// ══════════════════════════════════════════════════════════════
// عزل حراري بالمدينة المنورة — Override مخصص (E-E-A-T Grade)
// صفحة: /madinah/thermal-insulation
// ══════════════════════════════════════════════════════════════
...
export const override: PageOverride = {
    meta: {
        title: 'عزل حراري بالمدينة المنورة — خدمة احترافية معتمدة (2026)',
        description: 'عزل حراري بالمدينة المنورة. خدمة احترافية. فريق متخصص. ضمان مكتوب. أسعار شفافة. خدمة سريعة.',
        h1: 'عزل حراري بالمدينة المنورة — خدمة احترافية معتمدة مع ضمان',
        keywords: ['عزل حراري بالمدينة المنورة', 'عزل حراري المدينة المنورة', 'شركة عزل حراري بالمدينة المنورة', 'أفضل عزل حراري بالمدينة المنورة'],
    },

    content: {
        introduction: 'عزل حراري بالمدينة المنورة — خدمة متخصصة تراعي الظروف المناخية والبيئية في المدينة المنورة. فريق محترف مع أدوات حديثة وضمان مكتوب.',
        shortAnswer: 'عزل حراري بالمدينة المنورة: خدمة احترافية بأسعار شفافة. فريق متخصص. ضمان مكتوب.',
        heroSubtitle: 'عزل حراري بالمدينة المنورة. خدمة احترافية. ضمان.',
    },
    ...
    faq: [
        { question: 'كم تكلفة عزل حراري بالمدينة المنورة؟', answer: 'تبدأ الأسعار من 150 ريال وتختلف حسب المساحة ونوع الخدمة. اطلب عرض سعر مجاني.' },
