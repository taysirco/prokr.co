...
export const override: PageOverride = {
    meta: {
        title: 'تنظيف بالبخار بالمدينة المنورة — خدمة احترافية معتمدة (2026)',
        description: 'تنظيف بالبخار بالمدينة المنورة. خدمة احترافية. فريق متخصص. ضمان مكتوب. أسعار شفافة. خدمة سريعة.',
        h1: 'تنظيف بالبخار بالمدينة المنورة — خدمة احترافية معتمدة مع ضمان',
        keywords: ['تنظيف بالبخار بالمدينة المنورة', 'تنظيف بالبخار المدينة المنورة', 'شركة تنظيف بالبخار بالمدينة المنورة', 'أفضل تنظيف بالبخار بالمدينة المنورة'],
    },

    content: {
        introduction: 'تنظيف بالبخار بالمدينة المنورة — خدمة متخصصة تراعي الظروف المناخية والبيئية في المدينة المنورة. فريق محترف مع أدوات حديثة وضمان مكتوب.',
        shortAnswer: 'تنظيف بالبخار بالمدينة المنورة: خدمة احترافية بأسعار شفافة. فريق متخصص. ضمان مكتوب.',
        heroSubtitle: 'تنظيف بالبخار بالمدينة المنورة. خدمة احترافية. ضمان.',
    },
    ...
    faq: [
        { question: 'كم تكلفة تنظيف بالبخار بالمدينة المنورة؟', answer: 'تبدأ الأسعار من 150 ريال وتختلف حسب المساحة ونوع الخدمة. اطلب عرض سعر مجاني.' },
