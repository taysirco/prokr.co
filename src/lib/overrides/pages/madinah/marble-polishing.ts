...
export const override: PageOverride = {
    meta: {
        title: 'جلي رخام بالمدينة المنورة — خدمة احترافية معتمدة (2026)',
        description: 'جلي رخام بالمدينة المنورة. خدمة احترافية. فريق متخصص. ضمان مكتوب. أسعار شفافة. خدمة سريعة.',
        h1: 'جلي رخام بالمدينة المنورة — خدمة احترافية معتمدة مع ضمان',
        keywords: ['جلي رخام بالمدينة المنورة', 'جلي رخام المدينة المنورة', 'شركة جلي رخام بالمدينة المنورة', 'أفضل جلي رخام بالمدينة المنورة'],
    },

    content: {
        introduction: 'جلي رخام بالمدينة المنورة — خدمة متخصصة تراعي الظروف المناخية والبيئية في المدينة المنورة. فريق محترف مع أدوات حديثة وضمان مكتوب.',
        shortAnswer: 'جلي رخام بالمدينة المنورة: خدمة احترافية بأسعار شفافة. فريق متخصص. ضمان مكتوب.',
        heroSubtitle: 'جلي رخام بالمدينة المنورة. خدمة احترافية. ضمان.',
    },
    ...
    faq: [
        { question: 'كم تكلفة جلي رخام بالمدينة المنورة؟', answer: 'تبدأ الأسعار من 150 ريال وتختلف حسب المساحة ونوع الخدمة. اطلب عرض سعر مجاني.' },
