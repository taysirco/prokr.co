...
export const override: PageOverride = {
    meta: {
        title: 'تنظيف سجاد بالمدينة المنورة — خدمة احترافية معتمدة (2026)',
        description: 'تنظيف سجاد بالمدينة المنورة. خدمة احترافية. فريق متخصص. ضمان مكتوب. أسعار شفافة. خدمة سريعة.',
        h1: 'تنظيف سجاد بالمدينة المنورة — خدمة احترافية معتمدة مع ضمان',
        keywords: ['تنظيف سجاد بالمدينة المنورة', 'تنظيف سجاد المدينة المنورة', 'شركة تنظيف سجاد بالمدينة المنورة', 'أفضل تنظيف سجاد بالمدينة المنورة'],
    },

    content: {
        introduction: 'تنظيف سجاد بالمدينة المنورة — خدمة متخصصة تراعي الظروف المناخية والبيئية في المدينة المنورة. فريق محترف مع أدوات حديثة وضمان مكتوب.',
        shortAnswer: 'تنظيف سجاد بالمدينة المنورة: خدمة احترافية بأسعار شفافة. فريق متخصص. ضمان مكتوب.',
        heroSubtitle: 'تنظيف سجاد بالمدينة المنورة. خدمة احترافية. ضمان.',
    },
    ...
    faq: [
        { question: 'كم تكلفة تنظيف سجاد بالمدينة المنورة؟', answer: 'تبدأ الأسعار من 150 ريال وتختلف حسب المساحة ونوع الخدمة. اطلب عرض سعر مجاني.' },
