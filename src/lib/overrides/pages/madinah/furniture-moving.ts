...
export const override: PageOverride = {
    meta: {
        title: 'نقل عفش بالمدينة المنورة — خدمة احترافية معتمدة (2026)',
        description: 'نقل عفش بالمدينة المنورة. خدمة احترافية. فريق متخصص. ضمان مكتوب. أسعار شفافة. خدمة سريعة.',
        h1: 'نقل عفش بالمدينة المنورة — خدمة احترافية معتمدة مع ضمان',
        keywords: ['نقل عفش بالمدينة المنورة', 'نقل عفش المدينة المنورة', 'شركة نقل عفش بالمدينة المنورة', 'أفضل نقل عفش بالمدينة المنورة'],
    },

    content: {
        introduction: 'نقل عفش بالمدينة المنورة — خدمة متخصصة تراعي الظروف المناخية والبيئية في المدينة المنورة. فريق محترف مع أدوات حديثة وضمان مكتوب.',
        shortAnswer: 'نقل عفش بالمدينة المنورة: خدمة احترافية بأسعار شفافة. فريق متخصص. ضمان مكتوب.',
        heroSubtitle: 'نقل عفش بالمدينة المنورة. خدمة احترافية. ضمان.',
    },
    ...
    faq: [
        { question: 'كم تكلفة نقل عفش بالمدينة المنورة؟', answer: 'تبدأ الأسعار من 150 ريال وتختلف حسب المساحة ونوع الخدمة. اطلب عرض سعر مجاني.' },
    ...
    relatedServices: [
        { slug: 'madinah-furniture-storage', context: 'تخزين عفش بالمدينة المنورة', priority: 1 },
