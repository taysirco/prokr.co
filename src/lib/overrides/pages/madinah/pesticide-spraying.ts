...
export const override: PageOverride = {
    meta: {
        title: 'رش مبيدات بالمدينة المنورة — خدمة احترافية معتمدة (2026)',
        description: 'رش مبيدات بالمدينة المنورة. خدمة احترافية. فريق متخصص. ضمان مكتوب. أسعار شفافة. خدمة سريعة.',
        h1: 'رش مبيدات بالمدينة المنورة — خدمة احترافية معتمدة مع ضمان',
        keywords: ['رش مبيدات بالمدينة المنورة', 'رش مبيدات المدينة المنورة', 'شركة رش مبيدات بالمدينة المنورة', 'أفضل رش مبيدات بالمدينة المنورة'],
    },

    content: {
        introduction: 'رش مبيدات بالمدينة المنورة — خدمة متخصصة تراعي الظروف المناخية والبيئية في المدينة المنورة. فريق محترف مع أدوات حديثة وضمان مكتوب.',
        shortAnswer: 'رش مبيدات بالمدينة المنورة: خدمة احترافية بأسعار شفافة. فريق متخصص. ضمان مكتوب.',
        heroSubtitle: 'رش مبيدات بالمدينة المنورة. خدمة احترافية. ضمان.',
    },
    ...
    faq: [
        { question: 'كم تكلفة رش مبيدات بالمدينة المنورة؟', answer: 'تبدأ الأسعار من 150 ريال وتختلف حسب المساحة ونوع الخدمة. اطلب عرض سعر مجاني.' },
