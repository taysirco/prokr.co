...
export const override: PageOverride = {
    meta: {
        title: 'تنظيف خزانات بالمدينة المنورة — خدمة احترافية معتمدة (2026)',
        description: 'تنظيف خزانات بالمدينة المنورة. خدمة احترافية. فريق متخصص. ضمان مكتوب. أسعار شفافة. خدمة سريعة.',
        h1: 'تنظيف خزانات بالمدينة المنورة — خدمة احترافية معتمدة مع ضمان',
        keywords: ['تنظيف خزانات بالمدينة المنورة', 'تنظيف خزانات المدينة المنورة', 'شركة تنظيف خزانات بالمدينة المنورة', 'أفضل تنظيف خزانات بالمدينة المنورة'],
    },

    content: {
        introduction: 'تنظيف خزانات بالمدينة المنورة — خدمة متخصصة تراعي الظروف المناخية والبيئية في المدينة المنورة. فريق محترف مع أدوات حديثة وضمان مكتوب.',
        shortAnswer: 'تنظيف خزانات بالمدينة المنورة: خدمة احترافية بأسعار شفافة. فريق متخصص. ضمان مكتوب.',
        heroSubtitle: 'تنظيف خزانات بالمدينة المنورة. خدمة احترافية. ضمان.',
    },
    ...
    faq: [
        { question: 'كم تكلفة تنظيف خزانات بالمدينة المنورة؟', answer: 'تبدأ الأسعار من 150 ريال وتختلف حسب المساحة ونوع الخدمة. اطلب عرض سعر مجاني.' },
