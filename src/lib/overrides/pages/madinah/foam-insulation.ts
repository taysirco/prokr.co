// ══════════════════════════════════════════════════════════════
// عزل فوم بالمدينة المنورة — Override مخصص (E-E-A-T Grade)
...
export const override: PageOverride = {
    meta: {
        title: 'عزل فوم بالمدينة المنورة — خدمة احترافية معتمدة (2026)',
        description: 'عزل فوم بالمدينة المنورة. خدمة احترافية. فريق متخصص. ضمان مكتوب. أسعار شفافة. خدمة سريعة.',
        h1: 'عزل فوم بالمدينة المنورة — خدمة احترافية معتمدة مع ضمان',
        keywords: ['عزل فوم بالمدينة المنورة', 'عزل فوم المدينة المنورة', 'شركة عزل فوم بالمدينة المنورة', 'أفضل عزل فوم بالمدينة المنورة'],
    },

    content: {
        introduction: 'عزل فوم بالمدينة المنورة — خدمة متخصصة تراعي الظروف المناخية والبيئية في المدينة المنورة. فريق محترف مع أدوات حديثة وضمان مكتوب.',
        shortAnswer: 'عزل فوم بالمدينة المنورة: خدمة احترافية بأسعار شفافة. فريق متخصص. ضمان مكتوب.',
        heroSubtitle: 'عزل فوم بالمدينة المنورة. خدمة احترافية. ضمان.',
    },
    ...
    faq: [
        { question: 'كم تكلفة عزل فوم بالمدينة المنورة؟', answer: 'تبدأ الأسعار من 150 ريال وتختلف حسب المساحة ونوع الخدمة. اطلب عرض سعر مجاني.' },
