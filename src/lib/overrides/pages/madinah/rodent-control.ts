// ══════════════════════════════════════════════════════════════
// مكافحة فئران بالمدينة المنورة — Override مخصص (E-E-A-T Grade)
// صفحة: /madinah/rodent-control
// ══════════════════════════════════════════════════════════════
...
export const override: PageOverride = {
    meta: {
        title: 'مكافحة فئران بالمدينة المنورة — خدمة احترافية معتمدة (2026)',
        description: 'مكافحة فئران بالمدينة المنورة. خدمة احترافية. فريق متخصص. ضمان مكتوب. أسعار شفافة. خدمة سريعة.',
        h1: 'مكافحة فئران بالمدينة المنورة — خدمة احترافية معتمدة مع ضمان',
        keywords: ['مكافحة فئران بالمدينة المنورة', 'مكافحة فئران المدينة المنورة', 'شركة مكافحة فئران بالمدينة المنورة', 'أفضل مكافحة فئران بالمدينة المنورة'],
    },

    content: {
        introduction: 'مكافحة فئران بالمدينة المنورة — خدمة متخصصة تراعي الظروف المناخية والبيئية في المدينة المنورة. فريق محترف مع أدوات حديثة وضمان مكتوب.',
        shortAnswer: 'مكافحة فئران بالمدينة المنورة: خدمة احترافية بأسعار شفافة. فريق متخصص. ضمان مكتوب.',
        heroSubtitle: 'مكافحة فئران بالمدينة المنورة. خدمة احترافية. ضمان.',
    },
    ...
    faq: [
        { question: 'كم تكلفة مكافحة فئران بالمدينة المنورة؟', answer: 'تبدأ الأسعار من 150 ريال وتختلف حسب المساحة ونوع الخدمة. اطلب عرض سعر مجاني.' },
