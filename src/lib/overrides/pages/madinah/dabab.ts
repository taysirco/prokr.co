// ══════════════════════════════════════════════════════════════
// دباب نقل بالمدينة المنورة — Override مخصص (E-E-A-T Grade)
// صفحة: /madinah/dabab
// ══════════════════════════════════════════════════════════════
...
export const override: PageOverride = {
    meta: {
        title: 'دباب نقل بالمدينة المنورة — خدمة احترافية معتمدة (2026)',
        description: 'دباب نقل بالمدينة المنورة. خدمة احترافية. فريق متخصص. ضمان مكتوب. أسعار شفافة. خدمة سريعة.',
        h1: 'دباب نقل بالمدينة المنورة — خدمة احترافية معتمدة مع ضمان',
        keywords: ['دباب نقل بالمدينة المنورة', 'دباب نقل المدينة المنورة', 'شركة دباب نقل بالمدينة المنورة', 'أفضل دباب نقل بالمدينة المنورة'],
    },

    content: {
        introduction: 'دباب نقل بالمدينة المنورة — خدمة متخصصة تراعي الظروف المناخية والبيئية في المدينة المنورة. فريق محترف مع أدوات حديثة وضمان مكتوب.',
        shortAnswer: 'دباب نقل بالمدينة المنورة: خدمة احترافية بأسعار شفافة. فريق متخصص. ضمان مكتوب.',
        heroSubtitle: 'دباب نقل بالمدينة المنورة. خدمة احترافية. ضمان.',
    },
    ...
    faq: [
        { question: 'كم تكلفة دباب نقل بالمدينة المنورة؟', answer: 'تبدأ الأسعار من 150 ريال وتختلف حسب المساحة ونوع الخدمة. اطلب عرض سعر مجاني.' },
