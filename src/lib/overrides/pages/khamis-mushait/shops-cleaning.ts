// ══════════════════════════════════════════════════════════════
// تنظيف محلات بخميس مشيط — Override مخصص (E-E-A-T Grade)
// صفحة: /khamis-mushait/shops-cleaning
// ══════════════════════════════════════════════════════════════
...
export const override: PageOverride = {
    meta: {
        title: 'تنظيف محلات بخميس مشيط — خدمة احترافية معتمدة (2026)',
        description: 'تنظيف محلات بخميس مشيط. خدمة احترافية. فريق متخصص. ضمان مكتوب. أسعار شفافة. خدمة سريعة.',
        h1: 'تنظيف محلات بخميس مشيط — خدمة احترافية معتمدة مع ضمان',
        keywords: ['تنظيف محلات بخميس مشيط', 'تنظيف محلات خميس مشيط', 'شركة تنظيف محلات بخميس مشيط', 'أفضل تنظيف محلات بخميس مشيط'],
    },

    content: {
        introduction: 'تنظيف محلات بخميس مشيط — خدمة متخصصة تراعي الظروف المناخية والبيئية في خميس مشيط. فريق محترف مع أدوات حديثة وضمان مكتوب.',
        shortAnswer: 'تنظيف محلات بخميس مشيط: خدمة احترافية بأسعار شفافة. فريق متخصص. ضمان مكتوب.',
        heroSubtitle: 'تنظيف محلات بخميس مشيط. خدمة احترافية. ضمان.',
    },
    ...
    faq: [
        { question: 'كم تكلفة تنظيف محلات بخميس مشيط؟', answer: 'تبدأ الأسعار من 150 ريال وتختلف حسب المساحة ونوع الخدمة. اطلب عرض سعر مجاني.' },
