// ══════════════════════════════════════════════════════════════
// جلي بلاط بخميس مشيط — Override مخصص (E-E-A-T Grade)
// صفحة: /khamis-mushait/floor-polishing
// ══════════════════════════════════════════════════════════════
...
export const override: PageOverride = {
    meta: {
        title: 'جلي بلاط بخميس مشيط — خدمة احترافية معتمدة (2026)',
        description: 'جلي بلاط بخميس مشيط. خدمة احترافية. فريق متخصص. ضمان مكتوب. أسعار شفافة. خدمة سريعة.',
        h1: 'جلي بلاط بخميس مشيط — خدمة احترافية معتمدة مع ضمان',
        keywords: ['جلي بلاط بخميس مشيط', 'جلي بلاط خميس مشيط', 'شركة جلي بلاط بخميس مشيط', 'أفضل جلي بلاط بخميس مشيط'],
    },

    content: {
        introduction: 'جلي بلاط بخميس مشيط — خدمة متخصصة تراعي الظروف المناخية والبيئية في خميس مشيط. فريق محترف مع أدوات حديثة وضمان مكتوب.',
        shortAnswer: 'جلي بلاط بخميس مشيط: خدمة احترافية بأسعار شفافة. فريق متخصص. ضمان مكتوب.',
        heroSubtitle: 'جلي بلاط بخميس مشيط. خدمة احترافية. ضمان.',
    },
    ...
    faq: [
        { question: 'كم تكلفة جلي بلاط بخميس مشيط؟', answer: 'تبدأ الأسعار من 150 ريال وتختلف حسب المساحة ونوع الخدمة. اطلب عرض سعر مجاني.' },
