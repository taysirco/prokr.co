// ══════════════════════════════════════════════════════════════
// تنظيف بالساعة بخميس مشيط — Override مخصص (E-E-A-T Grade)
// صفحة: /khamis-mushait/hourly-cleaning
// ══════════════════════════════════════════════════════════════
...
export const override: PageOverride = {
    meta: {
        title: 'تنظيف بالساعة بخميس مشيط — خدمة احترافية معتمدة (2026)',
        description: 'تنظيف بالساعة بخميس مشيط. خدمة احترافية. فريق متخصص. ضمان مكتوب. أسعار شفافة. خدمة سريعة.',
        h1: 'تنظيف بالساعة بخميس مشيط — خدمة احترافية معتمدة مع ضمان',
        keywords: ['تنظيف بالساعة بخميس مشيط', 'تنظيف بالساعة خميس مشيط', 'شركة تنظيف بالساعة بخميس مشيط', 'أفضل تنظيف بالساعة بخميس مشيط'],
    },

    content: {
        introduction: 'تنظيف بالساعة بخميس مشيط — خدمة متخصصة تراعي الظروف المناخية والبيئية في خميس مشيط. فريق محترف مع أدوات حديثة وضمان مكتوب.',
        shortAnswer: 'تنظيف بالساعة بخميس مشيط: خدمة احترافية بأسعار شفافة. فريق متخصص. ضمان مكتوب.',
        heroSubtitle: 'تنظيف بالساعة بخميس مشيط. خدمة احترافية. ضمان.',
    },
    ...
    faq: [
        { question: 'كم تكلفة تنظيف بالساعة بخميس مشيط؟', answer: 'تبدأ الأسعار من 150 ريال وتختلف حسب المساحة ونوع الخدمة. اطلب عرض سعر مجاني.' },
