// ══════════════════════════════════════════════════════════════
// دباب نقل بخميس مشيط — Override مخصص (E-E-A-T Grade)
// صفحة: /khamis-mushait/dabab
// ══════════════════════════════════════════════════════════════
...
export const override: PageOverride = {
    meta: {
        title: 'دباب نقل بخميس مشيط — خدمة احترافية معتمدة (2026)',
        description: 'دباب نقل بخميس مشيط. خدمة احترافية. فريق متخصص. ضمان مكتوب. أسعار شفافة. خدمة سريعة.',
        h1: 'دباب نقل بخميس مشيط — خدمة احترافية معتمدة مع ضمان',
        keywords: ['دباب نقل بخميس مشيط', 'دباب نقل خميس مشيط', 'شركة دباب نقل بخميس مشيط', 'أفضل دباب نقل بخميس مشيط'],
    },

    content: {
        introduction: 'دباب نقل بخميس مشيط — خدمة متخصصة تراعي الظروف المناخية والبيئية في خميس مشيط. فريق محترف مع أدوات حديثة وضمان مكتوب.',
        shortAnswer: 'دباب نقل بخميس مشيط: خدمة احترافية بأسعار شفافة. فريق متخصص. ضمان مكتوب.',
        heroSubtitle: 'دباب نقل بخميس مشيط. خدمة احترافية. ضمان.',
    },
    ...
    faq: [
        { question: 'كم تكلفة دباب نقل بخميس مشيط؟', answer: 'تبدأ الأسعار من 150 ريال وتختلف حسب المساحة ونوع الخدمة. اطلب عرض سعر مجاني.' },
