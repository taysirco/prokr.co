// ══════════════════════════════════════════════════════════════
// نقل عفش بخميس مشيط — Override مخصص (E-E-A-T Grade)
// صفحة: /khamis-mushait/furniture-moving
// ══════════════════════════════════════════════════════════════
...
export const override: PageOverride = {
    meta: {
        title: 'نقل عفش بخميس مشيط — خدمة احترافية معتمدة (2026)',
        description: 'نقل عفش بخميس مشيط. خدمة احترافية. فريق متخصص. ضمان مكتوب. أسعار شفافة. خدمة سريعة.',
        h1: 'نقل عفش بخميس مشيط — خدمة احترافية معتمدة مع ضمان',
        keywords: ['نقل عفش بخميس مشيط', 'نقل عفش خميس مشيط', 'شركة نقل عفش بخميس مشيط', 'أفضل نقل عفش بخميس مشيط'],
    },

    content: {
        introduction: 'نقل عفش بخميس مشيط — خدمة متخصصة تراعي الظروف المناخية والبيئية في خميس مشيط. فريق محترف مع أدوات حديثة وضمان مكتوب.',
        shortAnswer: 'نقل عفش بخميس مشيط: خدمة احترافية بأسعار شفافة. فريق متخصص. ضمان مكتوب.',
        heroSubtitle: 'نقل عفش بخميس مشيط. خدمة احترافية. ضمان.',
    },
    ...
    faq: [
        { question: 'كم تكلفة نقل عفش بخميس مشيط؟', answer: 'تبدأ الأسعار من 150 ريال وتختلف حسب المساحة ونوع الخدمة. اطلب عرض سعر مجاني.' },
    ...
    relatedServices: [
        { slug: 'khamis-mushait-furniture-storage', context: 'تخزين عفش بخميس مشيط', priority: 1 },
