// ══════════════════════════════════════════════════════════════
// مكافحة حمام بالجبيل — Override مخصص (E-E-A-T Grade)
// صفحة: /jubail/bird-control
// ══════════════════════════════════════════════════════════════
...
export const override: PageOverride = {
    meta: {
        title: 'مكافحة حمام بالجبيل — خدمة احترافية معتمدة (2026)',
        description: 'مكافحة حمام بالجبيل. خدمة احترافية. فريق متخصص. ضمان مكتوب. أسعار شفافة. خدمة سريعة.',
        h1: 'مكافحة حمام بالجبيل — خدمة احترافية معتمدة مع ضمان',
        keywords: ['مكافحة حمام بالجبيل', 'مكافحة حمام الجبيل', 'شركة مكافحة حمام بالجبيل', 'أفضل مكافحة حمام بالجبيل'],
    },

    content: {
        introduction: 'مكافحة حمام بالجبيل — خدمة متخصصة تراعي الظروف المناخية والبيئية في الجبيل. فريق محترف مع أدوات حديثة وضمان مكتوب.',
        shortAnswer: 'مكافحة حمام بالجبيل: خدمة احترافية بأسعار شفافة. فريق متخصص. ضمان مكتوب.',
        heroSubtitle: 'مكافحة حمام بالجبيل. خدمة احترافية. ضمان.',
    },
    ...
    faq: [
        { question: 'كم تكلفة مكافحة حمام بالجبيل؟', answer: 'تبدأ الأسعار من 150 ريال وتختلف حسب المساحة ونوع الخدمة. اطلب عرض سعر مجاني.' },
