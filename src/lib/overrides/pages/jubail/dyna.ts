// ══════════════════════════════════════════════════════════════
// دينا نقل بالجبيل — Override مخصص (E-E-A-T Grade)
// صفحة: /jubail/dyna
// ══════════════════════════════════════════════════════════════
...
export const override: PageOverride = {
    meta: {
        title: 'دينا نقل بالجبيل — خدمة احترافية معتمدة (2026)',
        description: 'دينا نقل بالجبيل. خدمة احترافية. فريق متخصص. ضمان مكتوب. أسعار شفافة. خدمة سريعة.',
        h1: 'دينا نقل بالجبيل — خدمة احترافية معتمدة مع ضمان',
        keywords: ['دينا نقل بالجبيل', 'دينا نقل الجبيل', 'شركة دينا نقل بالجبيل', 'أفضل دينا نقل بالجبيل'],
    },

    content: {
        introduction: 'دينا نقل بالجبيل — خدمة متخصصة تراعي الظروف المناخية والبيئية في الجبيل. فريق محترف مع أدوات حديثة وضمان مكتوب.',
        shortAnswer: 'دينا نقل بالجبيل: خدمة احترافية بأسعار شفافة. فريق متخصص. ضمان مكتوب.',
        heroSubtitle: 'دينا نقل بالجبيل. خدمة احترافية. ضمان.',
    },
    ...
    faq: [
        { question: 'كم تكلفة دينا نقل بالجبيل؟', answer: 'تبدأ الأسعار من 150 ريال وتختلف حسب المساحة ونوع الخدمة. اطلب عرض سعر مجاني.' },
