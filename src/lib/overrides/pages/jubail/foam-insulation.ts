// ══════════════════════════════════════════════════════════════
// عزل فوم بالجبيل — Override مخصص (E-E-A-T Grade)
// صفحة: /jubail/foam-insulation
// ══════════════════════════════════════════════════════════════
...
export const override: PageOverride = {
    meta: {
        title: 'عزل فوم بالجبيل — خدمة احترافية معتمدة (2026)',
        description: 'عزل فوم بالجبيل. خدمة احترافية. فريق متخصص. ضمان مكتوب. أسعار شفافة. خدمة سريعة.',
        h1: 'عزل فوم بالجبيل — خدمة احترافية معتمدة مع ضمان',
        keywords: ['عزل فوم بالجبيل', 'عزل فوم الجبيل', 'شركة عزل فوم بالجبيل', 'أفضل عزل فوم بالجبيل'],
    },

    content: {
        introduction: 'عزل فوم بالجبيل — خدمة متخصصة تراعي الظروف المناخية والبيئية في الجبيل. فريق محترف مع أدوات حديثة وضمان مكتوب.',
        shortAnswer: 'عزل فوم بالجبيل: خدمة احترافية بأسعار شفافة. فريق متخصص. ضمان مكتوب.',
        heroSubtitle: 'عزل فوم بالجبيل. خدمة احترافية. ضمان.',
    },
    ...
    faq: [
        { question: 'كم تكلفة عزل فوم بالجبيل؟', answer: 'تبدأ الأسعار من 150 ريال وتختلف حسب المساحة ونوع الخدمة. اطلب عرض سعر مجاني.' },
