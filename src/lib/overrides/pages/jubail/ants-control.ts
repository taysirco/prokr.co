// ══════════════════════════════════════════════════════════════
// مكافحة نمل بالجبيل — Override مخصص (E-E-A-T Grade)
// صفحة: /jubail/ants-control
// ══════════════════════════════════════════════════════════════
...
export const override: PageOverride = {
    meta: {
        title: 'مكافحة نمل بالجبيل — خدمة احترافية معتمدة (2026)',
        description: 'مكافحة نمل بالجبيل. خدمة احترافية. فريق متخصص. ضمان مكتوب. أسعار شفافة. خدمة سريعة.',
        h1: 'مكافحة نمل بالجبيل — خدمة احترافية معتمدة مع ضمان',
        keywords: ['مكافحة نمل بالجبيل', 'مكافحة نمل الجبيل', 'شركة مكافحة نمل بالجبيل', 'أفضل مكافحة نمل بالجبيل'],
    },

    content: {
        introduction: 'مكافحة نمل بالجبيل — خدمة متخصصة تراعي الظروف المناخية والبيئية في الجبيل. فريق محترف مع أدوات حديثة وضمان مكتوب.',
        shortAnswer: 'مكافحة نمل بالجبيل: خدمة احترافية بأسعار شفافة. فريق متخصص. ضمان مكتوب.',
        heroSubtitle: 'مكافحة نمل بالجبيل. خدمة احترافية. ضمان.',
    },
    ...
    faq: [
        { question: 'كم تكلفة مكافحة نمل بالجبيل؟', answer: 'تبدأ الأسعار من 150 ريال وتختلف حسب المساحة ونوع الخدمة. اطلب عرض سعر مجاني.' },
