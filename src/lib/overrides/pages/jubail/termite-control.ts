// ══════════════════════════════════════════════════════════════
// مكافحة نمل أبيض بالجبيل — Override مخصص (E-E-A-T Grade)
// صفحة: /jubail/termite-control
// ══════════════════════════════════════════════════════════════
...
export const override: PageOverride = {
    meta: {
        title: 'مكافحة نمل أبيض بالجبيل — خدمة احترافية معتمدة (2026)',
        description: 'مكافحة نمل أبيض بالجبيل. خدمة احترافية. فريق متخصص. ضمان مكتوب. أسعار شفافة. خدمة سريعة.',
        h1: 'مكافحة نمل أبيض بالجبيل — خدمة احترافية معتمدة مع ضمان',
        keywords: ['مكافحة نمل أبيض بالجبيل', 'مكافحة نمل أبيض الجبيل', 'شركة مكافحة نمل أبيض بالجبيل', 'أفضل مكافحة نمل أبيض بالجبيل'],
    },

    content: {
        introduction: 'مكافحة نمل أبيض بالجبيل — خدمة متخصصة تراعي الظروف المناخية والبيئية في الجبيل. فريق محترف مع أدوات حديثة وضمان مكتوب.',
        shortAnswer: 'مكافحة نمل أبيض بالجبيل: خدمة احترافية بأسعار شفافة. فريق متخصص. ضمان مكتوب.',
        heroSubtitle: 'مكافحة نمل أبيض بالجبيل. خدمة احترافية. ضمان.',
    },
    ...
    faq: [
        { question: 'كم تكلفة مكافحة نمل أبيض بالجبيل؟', answer: 'تبدأ الأسعار من 150 ريال وتختلف حسب المساحة ونوع الخدمة. اطلب عرض سعر مجاني.' },
