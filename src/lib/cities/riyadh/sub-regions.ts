...
export const SUB_REGIONS_RIYADH: SubRegion[] = [
    {
        ...
        citySlug: 'riyadh',
        services: ['furniture-moving', 'pest-control', 'cleaning', 'tank-insulation', 'sewage-suction']
    },
    {
        slug: 'east',
        name_ar: 'شرق الرياض',
        name_en: 'East Riyadh',
        citySlug: 'riyadh',
        services: ['furniture-moving', 'pest-control', 'sewage-unblocking', 'tanks-cleaning', 'water-leak-detection']
    },
    {
        slug: 'west',
        name_ar: 'غرب الرياض',
