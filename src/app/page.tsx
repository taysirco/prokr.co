...
export default function HomePage() {
  ...
  const homeFaqItems = [
    { question: 'ما هو بروكر؟', answer: 'بروكر الخدمي هو أكبر دليل إلكتروني للخدمات المنزلية في المملكة العربية السعودية. يربط بين أكثر من 500 شركة معتمدة والعملاء في 30 مدينة سعودية، ويوفر خدمات نقل العفش، التنظيف، مكافحة الحشرات، كشف التسربات والمزيد.' },
            ...
            mainEntity: [
              {
                ...
                acceptedAnswer: {
                  '@type': 'Answer',
                  text: 'بروكر الخدمي هو أكبر دليل إلكتروني للخدمات المنزلية في المملكة العربية السعودية. يربط بين أكثر من 500 شركة معتمدة والعملاء في 30 مدينة سعودية، ويوفر خدمات نقل العفش، التنظيف، مكافحة الحشرات، كشف التسربات والمزيد.',
                },
              },
              {
                '@type': 'Question',
