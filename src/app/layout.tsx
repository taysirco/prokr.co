...
export default function RootLayout({
  ...
  var css = [
    ...
    /* ═══ NAVBAR ═══ */
    '.prokr-dark nav{background:#0f172a!important}',
    ...
    /* ═══ GRADIENTS — Service page sections ═══ */
    ...
    /* ═══ TEXT — missing service page colors ═══ */
    ...
    '.prokr-dark footer a{color:#38bdf8!important}',
